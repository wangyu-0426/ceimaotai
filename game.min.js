...
cc.each = function (c, d, e) {
  if (c)
    if (c instanceof Array)
      for (var f = 0, g = c.length; f < g && !1 !== d.call(e, c[f], f); f++);
    else for (f in c) if (!1 === d.call(e, c[f], f)) break;
};
...
cc.AsyncPool = function (c, d, e, f, g) {
  ...
  h._handleItem = function () {
    var c = this;
    if (!(0 === c._pool.length || c._workingSize >= c._limit)) {
      var d = c._pool.shift(),
        e = d.value,
        f = d.index;
      c._workingSize++;
      c._iterator.call(
        ...
        function (d, e) {
          ...
          c.finishedSize === c.size
            ? c._onEnd &&
              c._onEnd.call(
                c._onEndTarget,
                0 === c._errors.length ? null : c._errors,
                c._results
              )
            : c._handleItem();
        }.bind(d),
  ...
  h.flow = function () {
    ...
    else for (var c = 0; c < this._limit; c++) this._handleItem();
  };
};
cc.async = {
  ...
  map: function (c, d, e, f) {
    var g = d;
    "object" === typeof d &&
      ((e = d.cb), (f = d.iteratorTarget), (g = d.iterator));
...
cc.path = {
  normalizeRE: /[^\.\/]+\/\.\.\//,
  join: function () {
    for (var c = arguments.length, d = "", e = 0; e < c; e++)
      d = (d + ("" === d ? "" : "/") + arguments[e]).replace(/(\/|\\\\)$/, "");
    return d;
  },
  extname: function (c) {
  ...
  basename: function (c, d) {
    ...
    e = e[2];
    return d &&
      c.substring(c.length - d.length).toLowerCase() === d.toLowerCase()
      ? e.substring(0, e.length - d.length)
      : e;
  },
  dirname: function (c) {
    return c.replace(/((.*)(\/|\\|\\\\))?(.*?\..*$)?/, "$2");
  ...
  _normalize: function (c) {
    var d = (c = String(c));
    do (d = c), (c = c.replace(this.normalizeRE, ""));
  ...
  return {
    ...
    _getArgs4Js: function (c) {
      var d = c[0],
        ...
        f = c[2],
        g = ["", null, null];
      if (1 === c.length) g[1] = d instanceof Array ? d : [d];
      else if (2 === c.length)
        "function" === typeof e
          ? ((g[1] = d instanceof Array ? d : [d]), (g[2] = e))
          : ((g[0] = d || ""), (g[1] = e instanceof Array ? e : [e]));
      else if (3 === c.length)
        (g[0] = d || ""), (g[1] = e instanceof Array ? e : [e]), (g[2] = f);
    ...
    loadJs: function (d, e, f) {
      var g = this,
        h = g._getArgs4Js(arguments),
        s = h[0],
        u = h[1],
        h = h[2];
      -1 < navigator.userAgent.indexOf("Trident/5")
        ? g._loadJs4Dependency(s, u, 0, h)
        : cc.async.map(
            u,
            function (d, e, f) {
              d = cc.path.join(s, d);
    ...
    loadJsWithImg: function (c, d, e) {
      var f = this._loadJsImg(),
        g = this._getArgs4Js(arguments);
    ...
    _createScript: function (d, e, f) {
      ...
      h.async = e;
      c[d] = !0;
      cc.game.config.noCache && "string" === typeof d
        ? this._noCacheRex.test(d)
          ? (h.src = d + "\x26_t\x3d" + (new Date() - 0))
          : (h.src = d + "?_t\x3d" + (new Date() - 0))
        : (h.src = d);
      h.addEventListener(
        "load",
        function () {
    ...
    _loadJs4Dependency: function (c, d, e, f) {
      if (e >= d.length) f && f();
        ...
        var g = this;
        g._createScript(cc.path.join(c, d[e]), !1, function (h) {
          if (h) return f(h);
    ...
    _loadJsImg: function () {
      ...
      if (!d) {
        ...
        d.style.left =
          c.offsetLeft + (parseFloat(e.width) - d.width) / 2 + "px";
        d.style.top =
          c.offsetTop + (parseFloat(e.height) - d.height) / 2 + "px";
        ...
        /msie/i.test(navigator.userAgent) && !/opera/i.test(navigator.userAgent)
          ? (e.setRequestHeader("Accept-Charset", "utf-8"),
            (e.onreadystatechange = function () {
              4 === e.readyState &&
                (200 === e.status
                  ? d(null, e.responseText)
                  : d({ status: e.status, errorMessage: f }, null));
            }))
          : (e.overrideMimeType &&
              e.overrideMimeType("text/plain; charset\x3dutf-8"),
            (e.onload = function () {
              4 === e.readyState &&
                (200 === e.status
                  ? d(null, e.responseText)
    ...
    loadImg: function (c, d, e) {
      ...
      void 0 !== e
        ? (f.isCrossOrigin =
            void 0 === d.isCrossOrigin ? f.isCrossOrigin : d.isCrossOrigin)
        : void 0 !== d && (e = d);
      var r = this.getRes(c);
      if (r) return e && e(null, r), r;
      if ((d = g[c])) return d.callbacks.push(e), d.img;
      r = new Image();
      f.isCrossOrigin &&
      ...
      var s = function () {
        ...
        t = function () {
          this.removeEventListener("error", t, !1);
          if (r.crossOrigin && "anonymous" === r.crossOrigin.toLowerCase())
            (f.isCrossOrigin = !1), u.release(c), cc.loader.loadImg(c, f, e);
          else {
            var d = g[c];
            if (d) {
    ...
    _loadResIterator: function (c, e, f) {
      var g = this,
        ...
        s = c.type;
      s
        ? ((s = "." + s.toLowerCase()), (r = c.src ? c.src : c.name + s))
        : ((r = c), (s = cc.path.extname(r)));
      ...
      s = r;
      h.test(r) ||
        ((s = e.getBasePath ? e.getBasePath() : g.resPath),
        (s = g.getUrl(s, r)));
      cc.game.config.noCache &&
        "string" === typeof s &&
        (s = g._noCacheRex.test(s)
          ? s + ("\x26_t\x3d" + (new Date() - 0))
          : s + ("?_t\x3d" + (new Date() - 0)));
      e.load(s, r, c, function (c, d) {
        c
          ? (cc.log(c),
            (g.cache[r] = null),
            delete g.cache[r],
            f({ status: 520, errorMessage: c }, null))
          : ((g.cache[r] = d), f(null, d));
      });
    },
    _noCacheRex: /\?/,
    getUrl: function (c, f) {
      ...
      if (f.match(/[\/(\\\\)]lang[\/(\\\\)]/i)) {
        ...
        g = g.extname(f) || "";
        f = e[f] =
          f.substring(0, f.length - g.length) + "_" + cc.sys.language + g;
      }
      return f;
    },
    load: function (c, d, e) {
      ...
      g = new cc.AsyncPool(
        ...
        function (c, e, g, h) {
          f._loadResIterator(c, e, function (c) {
            ...
            d.trigger &&
              d.trigger.call(d.triggerTarget, e[0], h.size, h.finishedSize);
            g(c, e[0]);
          });
        },
        d.cb,
    ...
    loadAliases: function (c, d) {
      var e = this,
        f = e.getRes(c);
      f
        ? e._handleAliases(f.filenames, d)
        : e.load(c, function (c, f) {
...
(function () {
  function c(c) {
    var d = cc.game.CONFIG_KEY,
      e = parseInt(c[d.renderMode]) || 0;
    ...
    0 === e
      ? cc.sys.capabilities.opengl
        ...
        : cc.sys.capabilities.canvas &&
          ((cc._renderType = cc.game.RENDER_TYPE_CANVAS),
          (cc._supportRender = !0))
      : 1 === e && cc.sys.capabilities.canvas
      ? ((cc._renderType = cc.game.RENDER_TYPE_CANVAS),
        (cc._supportRender = !0))
      : 2 === e &&
        cc.sys.capabilities.opengl &&
  ...
  function d(c, e, f) {
    ...
    for (var k = 0, n = h.length; k < n; k++) {
      ...
      if (!m[p]) {
        var y = e.extname(p);
        y
          ? ".js" === y.toLowerCase() && g.push(e.join(f, p))
          : (y = d(c, p, f)) && (g = g.concat(y));
        m[p] = 1;
      }
    }
    return g;
  ...
  function e(c) {
    cc._initDebugSetting &&
      cc._initDebugSetting(c[cc.game.CONFIG_KEY.debugMode]);
    cc._engineLoaded = !0;
    cc.log(cc.ENGINE_VERSION);
    p && p();
  }
  function f(c) {
    var f = c[cc.game.CONFIG_KEY.engineDir],
      g = cc.loader;
    if (cc.Class) e(c);
    else {
      ...
      g.loadJson(h, function (g, h) {
        ...
        var k = c.modules || [],
          m = h.module,
          n = [];
        cc.sys.capabilities.opengl && 0 > k.indexOf("base4webgl")
          ? k.splice(0, 0, "base4webgl")
          : 0 > k.indexOf("core") && k.splice(0, 0, "core");
        for (var p = 0, u = k.length; p < u; p++) {
          var t = d(m, k[p], f);
          t && (n = n.concat(t));
        }
  ...
  (function () {
    ...
    var p = (n = !1),
      ...
      C = 0,
      B =
        /android (\d+(?:\.\d+)+)/i.exec(m) ||
        /android (\d+(?:\.\d+)+)/i.exec(e.platform);
    B && ((n = !0), (y = B[1] || ""), (C = parseInt(y) || 0));
    if ((B = /(iPad|iPhone|iPod).*OS ((\d+_?){2,3})/i.exec(m)))
      (p = !0), (y = B[2] || ""), (C = parseInt(y) || 0);
    B = c.OS_UNKNOWN;
    -1 !== e.appVersion.indexOf("Win")
      ? (B = c.OS_WINDOWS)
      : p
      ? (B = c.OS_IOS)
      : -1 !== e.appVersion.indexOf("Mac")
      ? (B = c.OS_OSX)
      : -1 !== e.appVersion.indexOf("X11") &&
        -1 === e.appVersion.indexOf("Linux")
      ? (B = c.OS_UNIX)
      : n
      ? (B = c.OS_ANDROID)
      : -1 !== e.appVersion.indexOf("Linux") && (B = c.OS_LINUX);
    c.os = B;
    c.osVersion = y;
    c.osMainVersion = C;
    c.browserType = c.BROWSER_TYPE_UNKNOWN;
    (function () {
      var d = /qqbrowser|chrome|safari|firefox|opr|oupeng|opera/i,
        e = /mqqbrowser|sogou|qzone|liebao|micromessenger|ucbrowser|360 aphone|360browser|baiduboxapp|baidubrowser|maxthon|mxbrowser|trident|miuibrowser/i.exec(
          m
        );
      e || (e = d.exec(m));
      d = e ? e[0] : c.BROWSER_TYPE_UNKNOWN;
      "micromessenger" === d
        ? (d = c.BROWSER_TYPE_WECHAT)
        : "safari" === d && m.match(/android.*applewebkit/)
        ? (d = c.BROWSER_TYPE_ANDROID)
        : "trident" === d
        ? (d = c.BROWSER_TYPE_IE)
        : "360 aphone" === d
        ? (d = c.BROWSER_TYPE_360)
        : "mxbrowser" === d
        ? (d = c.BROWSER_TYPE_MAXTHON)
        : "opr" === d && (d = c.BROWSER_TYPE_OPERA);
      c.browserType = d;
    })();
    c.browserVersion = "";
    (function () {
      var d = /(msie |rv:|firefox|chrome|ucbrowser|oupeng|opera|opr|safari|miui)(mobile)?(browser)?\/?([\d.]+)/i,
        e = m.match(
    ...
    c._supportCanvasNewBlendModes = (function () {
      ...
      return 0 === c.getImageData(0, 0, 1, 1).data[0];
    })();
    cc.sys.isMobile &&
    ...
    try {
      var A = (c.localStorage = d.localStorage);
      A.setItem("storage", "");
      ...
      (A = function () {
        ...
        (c.localStorage = { getItem: A, setItem: A, removeItem: A, clear: A });
    }
    A = !!h.getContext("2d");
    n = !1;
    if (d.WebGLRenderingContext) {
      ...
      try {
        if (
          (cc.create3DContext(p, { stencil: !0, preserveDrawingBuffer: !0 }) &&
            (n = !0),
          n && c.os === c.OS_ANDROID)
        ) {
          ...
          switch (c.browserType) {
            ...
            case c.BROWSER_TYPE_ANDROID:
              c.osMainVersion && 5 <= c.osMainVersion && (n = !0);
              break;
    ...
    D = c.capabilities = { canvas: A, opengl: n };
    if (
      void 0 !== g.ontouchstart ||
  ...
  cc.initEngine = function (d, e) {
    if (n) {
      ...
      (p = e),
        ...
        (d = cc.game.config),
        c(d),
        document.body ? f(d) : cc._addEventListener(window, "load", g, !1),
        (n = !0);
  };
})();
cc.game = {
      ...
      : this._prepareCalled ||
        (cc._engineLoaded
          ? ((this._prepareCalled = !0),
            this._initRenderer(e[f.width], e[f.height]),
            ...
            this._runMainLoop(),
            (e = e[f.jsList])
              ? cc.loader.loadJsWithImg(e, function (e) {
                  if (e) throw Error(e);
                  d._prepared = !0;
                  c && c();
                })
      ...
      : (c &&
          ("string" === typeof c
            ? (cc.game.config || this._loadConfig(),
              (cc.game.config[cc.game.CONFIG_KEY.id] = c))
            : (cc.game.config = c)),
        "function" === typeof d && (cc.game.onStart = d));
  ...
  _stTime: function (c) {
    var d = new Date().getTime(),
      e = Math.max(0, cc.game._frameTime - (d - cc.game._lastTime)),
  ...
  _runMainLoop: function () {
    ...
    d = function () {
      c._paused ||
        (e.mainLoop(),
        c._intervalId && window.cancelAnimationFrame(c._intervalId),
        (c._intervalId = window.requestAnimFrame(d)));
    };
  ...
  _initRenderer: function (c, d) {
    if (!this._rendererInitialized) {
      ...
      var e = this.config[cc.game.CONFIG_KEY.id],
        f = window,
        e = cc.$(e) || cc.$("#" + e),
        g,
        h;
      "CANVAS" === e.tagName
        ? ((c = c || e.width),
          (d = d || e.height),
          (this.canvas = cc._canvas = g = e),
          (this.container = cc.container = h = document.createElement("DIV")),
          g.parentNode && g.parentNode.insertBefore(h, g))
        : ("DIV" !== e.tagName &&
            cc.log("Warning: target element is not a DIV or CANVAS"),
          (c = c || e.clientWidth),
          (d = d || e.clientHeight),
          (this.canvas = cc._canvas = g = document.createElement("CANVAS")),
          (this.container = cc.container = h = document.createElement("DIV")),
          e.appendChild(h));
      ...
      this._renderContext
        ? ((cc.renderer = cc.rendererWebGL),
          (f.gl = this._renderContext),
          cc.renderer.init(),
          cc.shaderCache._init(),
          (cc._drawingUtil = new cc.DrawingPrimitiveWebGL(this._renderContext)),
          cc.textureCache._initializingRenderer(),
          (cc.glExt = {}),
          (cc.glExt.instanced_arrays = f.gl.getExtension(
            "ANGLE_instanced_arrays"
          )),
          (cc.glExt.element_uint = f.gl.getExtension("OES_element_index_uint")))
        : ((cc._renderType = cc.game.RENDER_TYPE_CANVAS),
  ...
  _initEvents: function () {
    ...
    d
      ...
      : (c.addEventListener("blur", f, !1), c.addEventListener("focus", g, !1));
    ...
    "onpageshow" in window &&
      ...
      (c.addEventListener("pagehide", f, !1),
      c.addEventListener("pageshow", g, !1));
...
cc.EventHelper.prototype = {
  ...
  addEventListener: function (c, d, e) {
    if ("load" === c && this._textureLoaded)
      ...
      void 0 === f[c] && (f[c] = []);
      this.hasEventListener(c, d, e) ||
        f[c].push({ callback: d, eventTarget: e });
    }
  },
    ...
    if (void 0 !== this._listeners) {
      ...
      if (void 0 !== e)
        for (var f = 0; f < e.length; )
          e[f].eventTarget === d ? e.splice(f, 1) : f++;
    }
  },
...
cc._initDebugSetting = function (c) {
  ...
  if (c !== d.DEBUG_MODE_NONE) {
    var e;
    c > d.DEBUG_MODE_ERROR
      ? ((e = cc._logToWebPage.bind(cc)),
        (cc.error = function () {
        ...
        (cc.assert = function (c, d) {
          if (!c && d) {
            for (var h = 2; h < arguments.length; h++)
              d = d.replace(/(%s)|(%d)/, cc._formatString(arguments[h]));
            e("Assert: " + d);
          }
        }),
        c !== d.DEBUG_MODE_ERROR_FOR_WEB_PAGE &&
          (cc.warn = function () {
            e("WARN :  " + cc.formatStr.apply(cc, arguments));
          }),
        c === d.DEBUG_MODE_INFO_FOR_WEB_PAGE &&
          (cc.log = function () {
            e(cc.formatStr.apply(cc, arguments));
          }))
      : console &&
        console.log.apply &&
          ...
          : function (c, d) {
              if (!c && d) {
                for (var e = 2; e < arguments.length; e++)
                  d = d.replace(/(%s)|(%d)/, cc._formatString(arguments[e]));
                throw Error(d);
              }
            }),
        c !== d.DEBUG_MODE_ERROR &&
...
cc.loader.loadBinary = function (c, d) {
  var e = this,
    f = this.getXMLHttpRequest(),
    g = "load " + c + " failed!";
  f.open("GET", c, !0);
  cc.loader.loadBinary._IEFilter
    ? (f.setRequestHeader("Accept-Charset", "x-user-defined"),
    ...
    : (f.overrideMimeType &&
        f.overrideMimeType("text/plain; charset\x3dx-user-defined"),
      (f.onload = function () {
        4 === f.readyState && 200 === f.status
          ? d(null, e._str2Uint8Array(f.responseText))
          : d(g);
      }));
  f.send(null);
};
...
cc.loader._str2Uint8Array = function (c) {
  if (!c) return null;
  for (var d = new Uint8Array(c.length), e = 0; e < c.length; e++)
    d[e] = c.charCodeAt(e) & 255;
  return d;
};
cc.loader.loadBinarySync = function (c) {
  ...
  if (cc.loader.loadBinary._IEFilter) {
    ...
    (d = cc._convertResponseBodyToText(d.responseBody)) &&
      (c = this._str2Uint8Array(d));
  } else {
    d.overrideMimeType &&
...
if (cc.loader.loadBinary._IEFilter) {
  ...
  cc._convertResponseBodyToText = function (c) {
    for (var d = {}, e = 0; 256 > e; e++)
      for (var f = 0; 256 > f; f++)
        d[String.fromCharCode(e + 256 * f)] =
          String.fromCharCode(e) + String.fromCharCode(f);
    e = IEBinaryToArray_ByteStr(c);
    c = IEBinaryToArray_ByteStr_Last(c);
    return (
      e.replace(/[\s\S]/g, function (c) {
        return d[c];
      }) + c
    );
  };
      ...
      for (p in n) {
        ...
        r && s && u
          ? ((k.value = (function (c, d) {
            ...
            Object.defineProperty(g, p, k))
          : r
          ? ((k.value = n[p]), Object.defineProperty(g, p, k))
          : (g[p] = n[p]);
        if (r) {
          var t, w;
...
cc.defineGetterSetter = function (c, d, e, f, g, h) {
  if (c.__defineGetter__)
    e && c.__defineGetter__(d, e), f && c.__defineSetter__(d, f);
  ...
  if (!g && !h)
    for (
      var k = null != e,
        m = void 0 != f,
        n = Object.getOwnPropertyNames(c),
        p = 0;
      p < n.length;
      p++
    ) {
...
cc.base = function (c, d, e) {
  ...
  if (f.superClass_)
    return (ret = f.superClass_.constructor.apply(
      c,
      Array.prototype.slice.call(arguments, 1)
    ));
  for (
    var g = Array.prototype.slice.call(arguments, 2), h = !1, k = c.constructor;
    k;
    k = k.superClass_ && k.superClass_.constructor
  )
    if (k.prototype[d] === f) h = !0;
    else if (h) return k.prototype[d].apply(c, g);
...
cc.rectContainsPoint = function (c, d) {
  return (
    d.x >= cc.rectGetMinX(c) &&
    d.x <= cc.rectGetMaxX(c) &&
    d.y >= cc.rectGetMinY(c) &&
    d.y <= cc.rectGetMaxY(c)
  );
};
...
cc.rectIntersection = function (c, d) {
  var e = cc.rect(
    Math.max(cc.rectGetMinX(c), cc.rectGetMinX(d)),
    Math.max(cc.rectGetMinY(c), cc.rectGetMinY(d)),
    0,
    0
  );
...
cc.SAXParser = cc.Class.extend({
  ...
  _parseXML: function (c) {
    ...
    this._isSupportDOMParser
      ? (d = this._parser.parseFromString(c, "text/xml"))
...
cc.PlistParser = cc.SAXParser.extend({
  parse: function (c) {
    ...
    for (
      var d = null, e = 0, f = c.childNodes.length;
      e < f && ((d = c.childNodes[e]), 1 !== d.nodeType);
      e++
    );
  ...
  _parseNode: function (c) {
    var d = null,
      e = c.tagName;
    if ("dict" === e) d = this._parseDict(c);
    else if ("array" === e) d = this._parseArray(c);
    else if ("string" === e)
      if (1 === c.childNodes.length) d = c.firstChild.nodeValue;
      else
        for (d = "", e = 0; e < c.childNodes.length; e++)
      ...
      "false" === e
        ...
        ? (d = !0)
        : "real" === e
        ? (d = parseFloat(c.firstChild.nodeValue))
        : "integer" === e && (d = parseInt(c.firstChild.nodeValue, 10));
    return d;
  },
  ...
  _parseDict: function (c) {
    for (var d = {}, e = null, f = 0, g = c.childNodes.length; f < g; f++) {
      ...
      1 === h.nodeType &&
        ("key" === h.tagName
          ? (e = h.firstChild.nodeValue)
          : (d[e] = this._parseNode(h)));
    }
    return d;
  },
});
...
cc._fontLoader = {
  ...
  _loadFont: function (c, d, e) {
    ...
    var m = "",
      m = isNaN(c - 0)
        ? m + ("@font-face { font-family:" + c + "; src:")
        : m + ("@font-face { font-family:'" + c + "'; src:");
    if (d instanceof Array)
      for (var n = 0, p = d.length; n < p; n++)
        (e = g.extname(d[n]).toLowerCase()),
          (m += "url('" + d[n] + "') format('" + h[e] + "')"),
          (m += n === p - 1 ? ";" : ",");
    else
      (e = e.toLowerCase()), (m += "url('" + d + "') format('" + h[e] + "');");
    k.textContent += m + "}";
  ...
  load: function (c, d, e, f) {
    ...
    cc.isString(e)
      ? ((d = cc.path.extname(e)),
        (c = cc.path.basename(e, d)),
        this._loadFont(c, e, d))
      : this._loadFont(c, d);
    document.fonts
      ? document.fonts.load("1em " + c).then(
          function () {
            f(null, !0);
          },
          function (c) {
...
cc.$ = function (c) {
  ...
  if ((c = c instanceof HTMLElement ? c : d.querySelector(c)))
    (c.find = c.find || cc.$),
      (c.hasClass =
        c.hasClass ||
        function (c) {
      ...
      (c.prependTo =
        ...
        function (c) {
          c.childNodes[0]
            ? c.insertBefore(this, c.childNodes[0])
            : c.appendChild(this);
          return this;
        }),
      (c.transforms =
      ...
      (c.position = c.position || { x: 0, y: 0 }),
      (c.rotation = c.rotation || 0),
      (c.scale = c.scale || { x: 1, y: 1 }),
      (c.skew = c.skew || { x: 0, y: 0 }),
      (c.translates = function (c, d) {
        this.position.x = c;
        this.position.y = d;
        this.transforms();
        return this;
...
cc.swap = function (c, d, e) {
  if (!cc.isObject(e) || cc.isUndefined(e.x) || cc.isUndefined(e.y))
...
cc.nodeDrawSetup = function (c) {
  c._shaderProgram &&
    (c._shaderProgram.use(),
    c._shaderProgram.setUniformForModelViewAndProjectionMatrixWithMat4());
};
...
cc.arrayVerifyType = function (c, d) {
  if (c && 0 < c.length)
    for (var e = 0; e < c.length; e++)
      if (!(c[e] instanceof d)) return cc.log("element type is wrong!"), !1;
  return !0;
};
...
cc.game.addEventListener(cc.game.EVENT_RENDERER_INITED, function () {
  if (cc._renderType === cc.game.RENDER_TYPE_WEBGL) {
    cc.color = function (c, e, f, g, h, k) {
      return void 0 === c
        ? new cc.Color(0, 0, 0, 255, h, k)
        : cc.isString(c)
        ? ((c = cc.hexToColor(c)), new cc.Color(c.r, c.g, c.b, c.a))
        : cc.isObject(c)
        ? new cc.Color(c.r, c.g, c.b, c.a, c.arrayBuffer, c.offset)
        : new cc.Color(c, e, f, g, h, k);
    };
    cc.Color = function (c, e, f, g, h, k) {
...
cc._tmp.PrototypeColor = function () {
  ...
  cc.defineGetterSetter(c, "YELLOW", c._getYellow);
...
cc.color = function (c, d, e, f) {
  return void 0 === c
    ...
    ? cc.hexToColor(c)
    : cc.isObject(c)
    ? { r: c.r, g: c.g, b: c.b, a: null == c.a ? 255 : c.a }
...
cc.Quad3 = function (c, d, e, f, g, h) {
  ...
  this.bl = c
    ? new cc.Vertex3F(c.x, c.y, c.z, g, h)
    : new cc.Vertex3F(0, 0, 0, g, h);
  h += k;
  this.br = d
    ? new cc.Vertex3F(d.x, d.y, d.z, g, h)
    : new cc.Vertex3F(0, 0, 0, g, h);
  h += k;
  this.tl = e
    ? new cc.Vertex3F(e.x, e.y, e.z, g, h)
    : new cc.Vertex3F(0, 0, 0, g, h);
  h += k;
  this.tr = f
    ? new cc.Vertex3F(f.x, f.y, f.z, g, h)
    : new cc.Vertex3F(0, 0, 0, g, h);
};
...
cc.V3F_C4B_T2F = function (c, d, e, f, g) {
  ...
  g = this._offset;
  this._vertices = c
    ? new cc.Vertex3F(c.x, c.y, c.z, f, g)
    : new cc.Vertex3F(0, 0, 0, f, g);
  g += cc.Vertex3F.BYTES_PER_ELEMENT;
  this._colors = d
    ? cc.color(d.r, d.g, d.b, d.a, f, g)
    : cc.color(0, 0, 0, 0, f, g);
...
cc.V3F_C4B_T2F_Quad = function (c, d, e, f, g, h) {
  ...
  this._tl = c
    ? new cc.V3F_C4B_T2F(c.vertices, c.colors, c.texCoords, g, h)
    : new cc.V3F_C4B_T2F(null, null, null, g, h);
  h += k;
  this._bl = d
    ? new cc.V3F_C4B_T2F(d.vertices, d.colors, d.texCoords, g, h)
    : new cc.V3F_C4B_T2F(null, null, null, g, h);
  h += k;
  this._tr = e
    ? new cc.V3F_C4B_T2F(e.vertices, e.colors, e.texCoords, g, h)
    : new cc.V3F_C4B_T2F(null, null, null, g, h);
  h += k;
  this._br = f
    ? new cc.V3F_C4B_T2F(f.vertices, f.colors, f.texCoords, g, h)
    : new cc.V3F_C4B_T2F(null, null, null, g, h);
};
...
cc.V3F_C4B_T2F_QuadsCopy = function (c) {
  ...
  for (var d = [], e = 0; e < c.length; e++)
    d.push(cc.V3F_C4B_T2F_QuadCopy(c[e]));
  return d;
};
cc.V2F_C4B_T2F = function (c, d, e, f, g) {
  ...
  g = this._offset;
  this._vertices = c
    ? new cc.Vertex2F(c.x, c.y, f, g)
    : new cc.Vertex2F(0, 0, f, g);
...
cc.V2F_C4B_T2F_Triangle = function (c, d, e, f, g) {
  this._arrayBuffer =
    f || new ArrayBuffer(cc.V2F_C4B_T2F_Triangle.BYTES_PER_ELEMENT);
  this._offset = g || 0;
  f = this._arrayBuffer;
  g = this._offset;
  var h = cc.V2F_C4B_T2F.BYTES_PER_ELEMENT;
  this._a = c
    ? new cc.V2F_C4B_T2F(c.vertices, c.colors, c.texCoords, f, g)
    : new cc.V2F_C4B_T2F(null, null, null, f, g);
  g += h;
  this._b = d
    ? new cc.V2F_C4B_T2F(d.vertices, d.colors, d.texCoords, f, g)
    : new cc.V2F_C4B_T2F(null, null, null, f, g);
  g += h;
  this._c = e
    ? new cc.V2F_C4B_T2F(e.vertices, e.colors, e.texCoords, f, g)
    : new cc.V2F_C4B_T2F(null, null, null, f, g);
};
...
cc._Dictionary = cc.Class.extend({
  ...
  removeObjectsForKeys: function (c) {
    if (null != c)
      for (var d = 0; d < c.length; d++) this.removeObjectForKey(c[d]);
  },
  allKeys: function () {
    var c = [],
      d = this._keyMapTb,
...
cc.FontDefinition = function (c) {
  ...
  if (c && c instanceof Object) for (var d in c) this[d] = c[d];
};
      ...
      if (!c.__resizeWithBrowserSize) {
        var d = function () {
          c.setDesignResolutionSize(
            c._designResolutionSize.width,
            c._designResolutionSize.height,
            c._resolutionPolicy
          );
...
cc.EGLView = cc.Class.extend({
  ...
  ctor: function () {
    var c = document,
      d = cc.ContainerStrategy,
      e = cc.ContentStrategy;
    __BrowserGetter.init(this);
    this._frame =
      cc.container.parentNode === c.body
        ? c.documentElement
  ...
  _resizeEvent: function () {
    ...
    var d = c._frameSize.width,
      e = c._frameSize.height,
      f = c._isRotated;
    c._initFrameSize();
    if (
      c._isRotated !== f ||
      c._frameSize.width !== d ||
      c._frameSize.height !== e
    )
      c._resizeCallback && c._resizeCallback.call(),
        (d = c._originalDesignResolutionSize.width),
        (e = c._originalDesignResolutionSize.height),
  ...
  _initFrameSize: function () {
    var c = this._frameSize,
      d = __BrowserGetter.availWidth(this._frame),
      e = __BrowserGetter.availHeight(this._frame),
      f = d >= e;
    !cc.sys.isMobile ||
    (f && this._orientation & cc.ORIENTATION_LANDSCAPE) ||
    (!f && this._orientation & cc.ORIENTATION_PORTRAIT)
      ? ((c.width = d),
        (c.height = e),
  ...
  _setViewportMeta: function (c, d) {
    ...
    var f = document.getElementsByName("viewport"),
      f = f ? f[0] : null,
      g,
      h,
      k;
    ...
    for (h in c)
      -1 == g.indexOf(h)
        ? (g += "," + h + "\x3d" + c[h])
        : d &&
          ((k = RegExp(h + "s*\x3ds*[^,]+")), g.replace(k, h + "\x3d" + c[h]));
    /^,/.test(g) && (g = g.substr(1));
    e.content = g;
    f && (f.content = g);
  ...
  setResolutionPolicy: function (c) {
    if (c instanceof cc.ResolutionPolicy) this._resolutionPolicy = c;
    else {
  ...
  setDesignResolutionSize: function (c, d, e) {
    if (0 < c || 0 < d)
      if ((this.setResolutionPolicy(e), (e = this._resolutionPolicy))) {
        e.preApply(this);
        ...
        f.scale &&
          2 === f.scale.length &&
          ((this._scaleX = f.scale[0]), (this._scaleY = f.scale[1]));
        f.viewport &&
          ...
          (c.width = f.width),
          (c.height = f.height),
          (d.x = -c.x / this._scaleX),
          (d.y = -c.y / this._scaleY),
          (d.width = cc._canvas.width / this._scaleX),
          (d.height = cc._canvas.height / this._scaleY),
          cc._renderContext.setOffset &&
            cc._renderContext.setOffset(c.x, -c.y));
        c = cc.director;
  ...
  setRealPixelResolution: function (c, d, e) {
    this._setViewportMeta(
      { width: c, "target-densitydpi": cc.DENSITYDPI_DEVICE },
      !0
    );
  ...
  setViewPortInPoints: function (c, d, e, f) {
    ...
    cc._renderContext.viewport(
      c * h * g + this._viewPortRect.x * g,
      d * k * g + this._viewPortRect.y * g,
      e * h * g,
      f * k * g
    );
  },
  ...
  convertToLocationInView: function (c, d, e) {
    ...
    return this._isRotated
      ? { x: this._viewPortRect.width - d, y: c }
      : { x: c, y: d };
  },
  _convertMouseToLocationInView: function (c, d) {
    ...
    c.y =
      (this._devicePixelRatio * (d.top + d.height - c.y) - e.y) / this._scaleY;
  },
...
(function () {
  var c = cc.ContainerStrategy.extend({
    ...
    d = cc.ContainerStrategy.extend({
      apply: function (c, d) {
        var e = c._frameSize.width,
          f = c._frameSize.height,
          ...
          w,
          v;
        u < t ? ((w = e), (v = s * u)) : ((w = r * t), (v = f));
        r = Math.round((e - w) / 2);
        v = Math.round((f - v) / 2);
        this._setupContainer(c, e - 2 * r, f - 2 * v);
        c._isRotated ? (g.marginLeft = f + "px") : (g.margin = "0px");
        g.paddingLeft = r + "px";
        g.paddingRight = r + "px";
        g.paddingTop = v + "px";
        g.paddingBottom = v + "px";
      },
    });
  c.extend({
    preApply: function (c) {
    ...
    d = cc.ContentStrategy.extend({
      apply: function (c, d) {
        ...
        s < u
          ? ((t = s), (w = e), (v = r * t))
          : ((t = u), (w = g * t), (v = f));
        return this._buildResult(e, f, w, v, t, t);
      },
    }),
...
cc.ResolutionPolicy = cc.Class.extend({
  ...
  setContainerStrategy: function (c) {
    c instanceof cc.ContainerStrategy && (this._containerStrategy = c);
  },
    ...
    if (this._supportsFullScreen) {
      ...
      if (d) {
        ...
        this._preOnFullScreenChange &&
          document.removeEventListener(e, this._preOnFullScreenChange);
...
cc.inputManager = {
  ...
  _removeUsedIndexBit: function (c) {
    0 > c ||
      c >= this._maxTouches ||
      ((c = ~(1 << c)), (this._indexBitsUsed &= c));
  },
  _glView: null,
  handleTouchesBegin: function (c) {
    for (
      var d, e, f, g = [], h = this._touchesIntegerDict, k = 0, m = c.length;
      k < m;
      k++
    )
      if (((d = c[k]), (f = d.getID()), (e = h[f]), null == e)) {
        var n = this._getUnUsedIndex();
        -1 === n
          ? cc.log(cc._LogInfos.inputManager_handleTouchesBegin, n)
          : ((e = this._touches[n] = new cc.Touch(
              d._point.x,
              d._point.y,
              d.getID()
            )),
            e._setPrevPoint(d._prevPoint),
            (h[f] = n),
            g.push(e));
      }
    0 < g.length &&
      (this._glView._convertTouchesWithScale(g),
      (c = new cc.EventTouch(g)),
      (c._eventCode = cc.EventTouch.EventCode.BEGAN),
      cc.eventManager.dispatchEvent(c));
  },
  handleTouchesMove: function (c) {
    for (var d, e, f = [], g = this._touches, h = 0, k = c.length; h < k; h++)
      (d = c[h]),
        (e = d.getID()),
        (e = this._touchesIntegerDict[e]),
        null != e &&
          g[e] &&
          (g[e]._setPoint(d._point),
          g[e]._setPrevPoint(d._prevPoint),
          f.push(g[e]));
    0 < f.length &&
      (this._glView._convertTouchesWithScale(f),
      (c = new cc.EventTouch(f)),
      (c._eventCode = cc.EventTouch.EventCode.MOVED),
      cc.eventManager.dispatchEvent(c));
  },
  handleTouchesEnd: function (c) {
    c = this.getSetOfTouchesEndOrCancel(c);
    0 < c.length &&
      (this._glView._convertTouchesWithScale(c),
      (c = new cc.EventTouch(c)),
      (c._eventCode = cc.EventTouch.EventCode.ENDED),
      cc.eventManager.dispatchEvent(c));
  },
  handleTouchesCancel: function (c) {
    ...
    0 < c.length &&
      (this._glView._convertTouchesWithScale(c),
      (c = new cc.EventTouch(c)),
      (c._eventCode = cc.EventTouch.EventCode.CANCELLED),
      cc.eventManager.dispatchEvent(c));
  },
  getSetOfTouchesEndOrCancel: function (c) {
    for (
      ...
      (d = c[m]),
        ...
        null != e &&
          h[e] &&
          (h[e]._setPoint(d._point),
          h[e]._setPrevPoint(d._prevPoint),
          g.push(h[e]),
          this._removeUsedIndexBit(e),
          delete k[f]);
    return g;
  },
  getHTMLElementPosition: function (c) {
    var d = document.documentElement,
      e = window,
      f = null,
      f = cc.isFunction(c.getBoundingClientRect)
  ...
  getPreTouch: function (c) {
    for (
      var d = null, e = this._preTouchPool, f = c.getID(), g = e.length - 1;
      0 <= g;
      g--
    )
      if (e[g].getID() === f) {
  ...
  setPreTouch: function (c) {
    for (
      var d = !1, e = this._preTouchPool, f = c.getID(), g = e.length - 1;
      0 <= g;
      g--
    )
      if (e[g].getID() === f) {
  ...
  getTouchesByEvent: function (c, d) {
    for (
      var e = [],
        ...
        g,
        h,
        k = this._preTouchPoint,
        m = c.changedTouches.length,
        n = 0;
      n < m;
      n++
    )
      if ((g = c.changedTouches[n])) {
        var p;
        p =
          cc.sys.BROWSER_TYPE_FIREFOX === cc.sys.browserType
            ? f.convertToLocationInView(g.pageX, g.pageY, d)
            : f.convertToLocationInView(g.clientX, g.clientY, d);
        null != g.identifier
          ? ((g = new cc.Touch(p.x, p.y, g.identifier)),
            (h = this.getPreTouch(g).getLocation()),
            g._setPrevPoint(h.x, h.y),
            this.setPreTouch(g))
          : ((g = new cc.Touch(p.x, p.y)), g._setPrevPoint(k.x, k.y));
        k.x = p.x;
        k.y = p.y;
        e.push(g);
      }
  ...
  registerSystemEvent: function (c) {
    if (!this._isRegisterEvent) {
      ...
      var d = this,
        e = "mouse" in cc.sys.capabilities,
        f = "touches" in cc.sys.capabilities,
        g = !1;
      cc.sys.isMobile && (g = !0);
      e &&
            ...
            if (!g) {
              ...
              if (f) {
                var f = d.getHTMLElementPosition(c),
                  h = d.getPointByEvent(e, f);
                cc.rectContainsPoint(
                  new cc.Rect(f.left, f.top, f.width, f.height),
                  h
                ) ||
        ...
        c.addEventListener(
          ...
          function (e) {
            var f = d.getHTMLElementPosition(c),
              g = d.getPointByEvent(e, f),
              f = d.getMouseEvent(g, f, cc.EventMouse.SCROLL);
            f.setButton(e.button);
...
_p.setAccelerometerEnabled = function (c) {
  this._accelEnabled !== c &&
    ((this._accelEnabled = c),
    (c = cc.director.getScheduler()),
    (this._accelCurTime = 0),
    c.scheduleUpdate(this));
};
...
_p._registerAccelerometerEvent = function () {
  ...
  var d =
      this._accelDeviceEvent === c.DeviceMotionEvent
        ? "devicemotion"
        : "deviceorientation",
    e = navigator.userAgent;
  if (
    /Android/.test(e) ||
    (/Adr/.test(e) && cc.sys.browserType === cc.BROWSER_TYPE_UC)
  )
    this._minus = -1;
  c.addEventListener(d, this.didAccelerate.bind(this), !1);
};
_p.didAccelerate = function (c) {
  var d = window;
  if (this._accelEnabled) {
    var e = this._acceleration,
      f,
      g,
      h;
    this._accelDeviceEvent === window.DeviceMotionEvent
      ? ((h = c.accelerationIncludingGravity),
        (f = this._accelMinus * h.x * 0.1),
        (g = this._accelMinus * h.y * 0.1),
        (h = 0.1 * h.z))
      : ((f = (c.gamma / 90) * 0.981),
        (g = 0.981 * -(c.beta / 90)),
        (h = (c.alpha / 90) * 0.981));
    ...
    c = e.x;
    d.orientation === cc.UIInterfaceOrientationLandscapeRight
      ? ((e.x = -e.y), (e.y = c))
      : d.orientation === cc.UIInterfaceOrientationLandscapeLeft
      ? ((e.x = e.y), (e.y = -c))
      : d.orientation === cc.UIInterfaceOrientationPortraitUpsideDown &&
        ((e.x = -e.x), (e.y = -e.y));
  }
};
delete _p;
...
cc.sizeApplyAffineTransform = function (c, d) {
  return {
    width: d.a * c.width + d.c * c.height,
    height: d.b * c.width + d.d * c.height,
  };
};
...
cc.rectApplyAffineTransform = function (c, d) {
  var e = cc.rectGetMinY(c),
    f = cc.rectGetMinX(c),
    g = cc.rectGetMaxX(c),
    h = cc.rectGetMaxY(c),
    k = cc.pointApplyAffineTransform(f, e, d),
    e = cc.pointApplyAffineTransform(g, e, d),
    f = cc.pointApplyAffineTransform(f, h, d),
    m = cc.pointApplyAffineTransform(g, h, d),
...
cc.pFuzzyEqual = function (c, d, e) {
  return c.x - e <= d.x && d.x <= c.x + e && c.y - e <= d.y && d.y <= c.y + e
    ? !0
    : !1;
};
...
cc.pAngleSigned = function (c, d) {
  var e = cc.pNormalize(c),
    f = cc.pNormalize(d),
    e = Math.atan2(e.x * f.y - e.y * f.x, cc.pDot(e, f));
...
cc.pSegmentIntersect = function (c, d, e, f) {
  var g = cc.p(0, 0);
  return cc.pLineIntersect(c, d, e, f, g) &&
    0 <= g.x &&
    1 >= g.x &&
    0 <= g.y &&
    1 >= g.y
...
cc.vertexLineToPolygon = function (c, d, e, f, g) {
  ...
  if (!(1 >= g)) {
    ...
    for (var h, k = g - 1, m = f; m < g; m++) {
      h = 2 * m;
      var n = cc.p(c[2 * m], c[2 * m + 1]),
        p;
      if (0 === m)
        p = cc.pPerp(
          cc.pNormalize(cc.pSub(n, cc.p(c[2 * (m + 1)], c[2 * (m + 1) + 1])))
        );
      else if (m === k)
        p = cc.pPerp(
          cc.pNormalize(cc.pSub(cc.p(c[2 * (m - 1)], c[2 * (m - 1) + 1]), n))
        );
      else {
        p = cc.p(c[2 * (m - 1)], c[2 * (m - 1) + 1]);
        var r = cc.p(c[2 * (m + 1)], c[2 * (m + 1) + 1]),
          s = cc.pNormalize(cc.pSub(r, n)),
          u = cc.pNormalize(cc.pSub(p, n)),
          t = Math.acos(cc.pDot(s, u));
        p =
          t < cc.degreesToRadians(70)
            ? cc.pPerp(cc.pNormalize(cc.pMidpoint(s, u)))
            : t < cc.degreesToRadians(170)
            ? cc.pNormalize(cc.pMidpoint(s, u))
            : cc.pPerp(cc.pNormalize(cc.pSub(r, p)));
      }
      p = cc.pMult(p, d);
      e[2 * h] = n.x + p.x;
      e[2 * h + 1] = n.y + p.y;
    ...
    for (m = 0 === f ? 0 : f - 1; m < k; m++)
      (h = 2 * m),
        (c = h + 2),
        (d = cc.vertex2(e[2 * h], e[2 * h + 1])),
        (g = cc.vertex2(e[2 * (h + 1)], e[2 * (h + 1) + 1])),
        (h = cc.vertex2(e[2 * c], e[2 * c])),
        (f = cc.vertex2(e[2 * (c + 1)], e[2 * (c + 1) + 1])),
        (d = !cc.vertexLineIntersect(d.x, d.y, f.x, f.y, g.x, g.y, h.x, h.y)),
        !d.isSuccess && (0 > d.value || 1 < d.value) && (d.isSuccess = !0),
        d.isSuccess &&
          ((e[2 * c] = f.x),
          (e[2 * c + 1] = f.y),
          (e[2 * (c + 1)] = h.x),
...
cc.vertexLineIntersect = function (c, d, e, f, g, h, k, m) {
  ...
  return h === m
    ? { isSuccess: !1, value: 0 }
    : { isSuccess: !0, value: (k + ((g - k) * m) / (m - h)) / c };
};
...
cc.Touch = cc.Class.extend({
  ...
  _setPoint: function (c, d) {
    void 0 === d
      ? ((this._point.x = c.x), (this._point.y = c.y))
      : ((this._point.x = c), (this._point.y = d));
  },
...
cc.EventListener.create = function (c) {
  ...
  delete c.event;
  var e = null;
  d === cc.EventListener.TOUCH_ONE_BY_ONE
    ? (e = new cc._EventListenerTouchOneByOne())
    : d === cc.EventListener.TOUCH_ALL_AT_ONCE
    ? (e = new cc._EventListenerTouchAllAtOnce())
    : d === cc.EventListener.MOUSE
    ? (e = new cc._EventListenerMouse())
    : d === cc.EventListener.CUSTOM
    ? ((e = new cc._EventListenerCustom(c.eventName, c.callback)),
      delete c.eventName,
      delete c.callback)
    : d === cc.EventListener.KEYBOARD
    ? (e = new cc._EventListenerKeyboard())
    : d === cc.EventListener.ACCELERATION
    ? ((e = new cc._EventListenerAcceleration(c.callback)), delete c.callback)
    : d === cc.EventListener.FOCUS && (e = new cc._EventListenerFocus());
    ...
    cc.EventListener.prototype.ctor.call(
      ...
      function (c) {
        if (this.onFocusChanged)
          this.onFocusChanged(c._widgetLoseFocus, c._widgetGetFocus);
      }
    );
  },
});
...
cc._EventListenerVector = cc.Class.extend({
  ...
  push: function (c) {
    0 === c._getFixedPriority()
      ? this._sceneGraphListeners.push(c)
      : this._fixedListeners.push(c);
  },
...
cc.eventManager = {
  ...
  _setDirtyForNode: function (c) {
    ...
    c = c.getChildren();
    for (var d = 0, e = c.length; d < e; d++) this._setDirtyForNode(c[d]);
  },
  pauseTarget: function (c, d) {
    ...
    if (!0 === d)
      for (e = c.getChildren(), f = 0, g = e.length; f < g; f++)
  ...
  _addListener: function (c) {
    0 === this._inDispatch
      ? this._forceAddEventListener(c)
      : this._toAddedListeners.push(c);
  },
  _forceAddEventListener: function (c) {
    var d = c._getListenerID(),
    ...
    0 === c._getFixedPriority()
      ? (this._setDirty(d, this.DIRTY_SCENE_GRAPH_PRIORITY),
        ...
        null === d && cc.log(cc._LogInfos.eventManager__forceAddEventListener),
        this._associateNodeAndEventListener(d, c),
    ...
    if (c)
      for (var d, e = 0; e < c.length; )
        (d = c[e]),
          ...
          0 === this._inDispatch ? cc.arrayRemoveObject(c, d) : ++e;
  },
  _removeListenersForListenerID: function (c) {
    ...
    for (d = 0; d < e.length; )
      (f = e[d]) && f._getListenerID() === c ? cc.arrayRemoveObject(e, f) : ++d;
  },
  _sortEventListeners: function (c) {
    ...
    d !== this.DIRTY_NONE &&
      ((e[c] = this.DIRTY_NONE),
      d & this.DIRTY_FIXED_PRIORITY && this._sortListenersOfFixedPriority(c),
      d & this.DIRTY_SCENE_GRAPH_PRIORITY &&
        ((d = cc.director.getRunningScene())
          ? this._sortListenersOfSceneGraphPriority(c, d)
          : (e[c] = this.DIRTY_SCENE_GRAPH_PRIORITY)));
  },
  _sortListenersOfSceneGraphPriority: function (c, d) {
    var e = this._getListeners(c);
    if (e) {
  ...
  _sortEventListenersOfSceneGraphPriorityDes: function (c, d) {
    ...
    return d && g && e[g.__instanceId]
      ? c && f && e[f.__instanceId]
        ? e[d._getSceneGraphPriority().__instanceId] -
          e[c._getSceneGraphPriority().__instanceId]
        : 1
      : -1;
  },
  ...
  _updateListeners: function (c) {
    ...
    if (!(1 < d)) {
      c.getType() === cc.Event.TOUCH
        ...
        : this._onUpdateListeners(cc.__getListenerID(c));
  ...
  _onTouchEventCallback: function (c, d) {
    ...
    if (k === m.BEGAN)
      c.onTouchBegan &&
        (g = c.onTouchBegan(f, e)) &&
        c._registered &&
        c._claimedTouches.push(f);
    else if (
      0 < c._claimedTouches.length &&
      -1 !== (h = c._claimedTouches.indexOf(f))
    )
      if (((g = !0), k === m.MOVED && c.onTouchMoved)) c.onTouchMoved(f, e);
      else if (k === m.ENDED) {
    ...
    return e.isStopped()
      ? (cc.eventManager._updateListeners(e), !0)
      : g && c._registered && c.swallowTouches
  ...
  _dispatchTouchEvent: function (c) {
    ...
    if (null !== d || null !== e) {
      var f = c.getTouches(),
        g = cc.copyArray(f),
        h = { event: c, needsMutableSet: d && e, touches: g, selTouch: null };
      if (d)
  ...
  _onTouchesEventCallback: function (c, d) {
    ...
    if (h === e.BEGAN && c.onTouchesBegan) c.onTouchesBegan(g, f);
    else if (h === e.MOVED && c.onTouchesMoved) c.onTouchesMoved(g, f);
    else if (h === e.ENDED && c.onTouchesEnded) c.onTouchesEnded(g, f);
    else if (h === e.CANCELLED && c.onTouchesCancelled)
      c.onTouchesCancelled(g, f);
  ...
  _dissociateNodeAndEventListener: function (c, d) {
    ...
    e &&
      ...
      0 === e.length && delete this._nodeListenersMap[c.__instanceId]);
  },
  _dispatchEventToListeners: function (c, d, e) {
    var f = !1,
      g = c.getFixedPriorityListeners(),
      h = c.getSceneGraphPriorityListeners(),
      k = 0,
      m;
    if (g && 0 !== g.length)
      for (; k < c.gt0Index; ++k)
  ...
  _visitTarget: function (c, d) {
    ...
    if (0 < g) {
      ...
      null != k[c.__instanceId] &&
        (h[c.getGlobalZOrder()] || (h[c.getGlobalZOrder()] = []),
        h[c.getGlobalZOrder()].push(c.__instanceId));
  ...
  addCustomListener: function (c, d) {
    var e = new cc._EventListenerCustom(c, d);
  ...
  removeListener: function (c) {
    if (null != c) {
      ...
      for (f in e) {
        ...
        (d = this._removeListenerInVector(d, c))
          ? this._setDirty(c._getListenerID(), this.DIRTY_SCENE_GRAPH_PRIORITY)
          : (d = this._removeListenerInVector(h, c)) &&
            this._setDirty(c._getListenerID(), this.DIRTY_FIXED_PRIORITY);
        g.empty() &&
          (delete this._priorityDirtyFlagMap[c._getListenerID()], delete e[f]);
        if (d) break;
      }
      if (!d)
    ...
    for (var e = 0, f = c.length; e < f; e++) {
      ...
      if (g._onCustomEvent === d || g._onEvent === d)
        return (
          ...
          0 === this._inDispatch && cc.arrayRemoveObject(c, g),
          !0
        );
    }
    return !1;
  },
  _removeListenerInVector: function (c, d) {
    if (null == c) return !1;
    for (var e = 0, f = c.length; e < f; e++) {
      var g = c[e];
      if (g === d)
  ...
  removeListeners: function (c, d) {
    if (c instanceof cc.Node) {
      ...
      if (!0 === d)
        for (f = c.getChildren(), e = 0, g = f.length; e < g; e++)
          this.removeListeners(f[e], !0);
    } else
      c === cc.EventListener.TOUCH_ONE_BY_ONE
        ? this._removeListenersForListenerID(
            cc._EventListenerTouchOneByOne.LISTENER_ID
          )
        : c === cc.EventListener.TOUCH_ALL_AT_ONCE
        ? this._removeListenersForListenerID(
            cc._EventListenerTouchAllAtOnce.LISTENER_ID
          )
        : c === cc.EventListener.MOUSE
        ? this._removeListenersForListenerID(cc._EventListenerMouse.LISTENER_ID)
        : c === cc.EventListener.ACCELERATION
        ? this._removeListenersForListenerID(
            cc._EventListenerAcceleration.LISTENER_ID
          )
        : c === cc.EventListener.KEYBOARD
        ? this._removeListenersForListenerID(
  ...
  setPriority: function (c, d) {
    if (null != c) {
      ...
      for (f in e) {
        ...
        if (g && -1 !== g.indexOf(c)) {
          null != c._getSceneGraphPriority() &&
            cc.log(cc._LogInfos.eventManager_setPriority);
          c._getFixedPriority() !== d &&
            (c._setFixedPriority(d),
            this._setDirty(c._getListenerID(), this.DIRTY_FIXED_PRIORITY));
          break;
        }
  ...
  dispatchEvent: function (c) {
    if (this._isEnabled) {
      ...
      if (c.getType() === cc.Event.TOUCH) this._dispatchTouchEvent(c);
      else {
        var d = cc.__getListenerID(c);
        this._sortEventListeners(d);
        d = this._listenersMap[d];
        null != d &&
          this._dispatchEventToListeners(d, this._onListenerCallback, c);
        this._updateListeners(c);
      }
      this._inDispatch--;
    }
...
cc.rendererCanvas = {
  ...
  transform: function () {
    ...
    for (var d = 0, e = c.length; d < e; d++)
      0 !== c[d]._dirtyFlag && c[d].updateStatus();
    c.length = 0;
  },
...
(function () {
  ...
  c.setGlobalAlpha = function (c) {
    0 < this._saveCount
      ? (this._context.globalAlpha = c)
      : this._currentAlpha !== c &&
        ((this._currentAlpha = c), (this._context.globalAlpha = c));
  };
  c.setCompositeOperation = function (c) {
    0 < this._saveCount
      ? (this._context.globalCompositeOperation = c)
      : this._currentCompositeOperation !== c &&
        ((this._currentCompositeOperation = c),
        (this._context.globalCompositeOperation = c));
  };
  c.setFillStyle = function (c) {
    0 < this._saveCount
      ...
      : this._currentFillStyle !== c &&
        ((this._currentFillStyle = c), (this._context.fillStyle = c));
  };
  c.setStrokeStyle = function (c) {
    0 < this._saveCount
      ? (this._context.strokeStyle = c)
      : this._currentStrokeStyle !== c &&
        ((this._currentStrokeStyle = c), (this._context.strokeStyle = c));
  };
  c.setTransform = function (c, e, f) {
    0 < this._armatureMode
      ? (this.restore(),
        this.save(),
        this._context.transform(c.a, -c.b, -c.c, c.d, c.tx * e, -(c.ty * f)))
      : this._context.setTransform(
          c.a,
          -c.b,
          -c.c,
          c.d,
          this._offsetX + c.tx * e,
          this._realOffsetY - c.ty * f
        );
  };
    ...
    c
      ? (this._armatureMode++,
        this._context.setTransform(
          ...
          e.b,
          e.d,
          this._offsetX + e.tx * f,
          this._realOffsetY - e.ty * g
        ),
        this.save())
  ...
  return {
    ...
    init: function () {
      ...
      if (d) {
        ...
        for (var g = new Uint16Array(12e3), s = 0, u = 0; 12e3 > u; u += 6)
          (g[u] = s + 0),
            (g[u + 1] = s + 1),
            (g[u + 2] = s + 2),
            (g[u + 3] = s + 1),
      ...
      e &&
        ((k = 48e3),
        (h = new ArrayBuffer(4 * k)),
        (m = new Float32Array(h)),
        (n = new Uint32Array(h)),
        c.bindBuffer(c.ARRAY_BUFFER, e),
        c.bufferData(c.ARRAY_BUFFER, m, c.DYNAMIC_DRAW));
      f = 8e3;
    },
    ...
    _turnToCacheMode: function (c) {
      ...
      c = c || 0;
      this._cacheToBufferCmds[c]
        ? (this._cacheToBufferCmds[c].length = 0)
        : (this._cacheToBufferCmds[c] = []);
      -1 === this._cacheInstanceIds.indexOf(c) &&
        this._cacheInstanceIds.push(c);
      this._currentID = c;
    },
    _turnToNormalMode: function () {
    ...
    setDepthTest: function (c) {
      ...
      c
        ? (d.clearDepth(1), d.enable(d.DEPTH_TEST), d.depthFunc(d.LEQUAL))
    ...
    _uploadBufferData: function (d) {
      ...
      var e = d._node._texture,
        h = d._node._blendFunc.src,
        k = d._node._blendFunc.dst,
        t = d._shaderProgram;
      if (
        c.texture !== e ||
        c.blendSrc !== h ||
    ...
    _batchRendering: function () {
      if (0 !== g && c.texture) {
        ...
        g > 0.5 * f
          ? h.bufferData(h.ARRAY_BUFFER, m, h.DYNAMIC_DRAW)
          : ((n = m.subarray(0, 6 * g)),
            h.bufferData(h.ARRAY_BUFFER, n, h.DYNAMIC_DRAW));
        k &&
          (h.enableVertexAttribArray(cc.VERTEX_ATTRIB_POSITION),
          h.enableVertexAttribArray(cc.VERTEX_ATTRIB_COLOR),
          h.enableVertexAttribArray(cc.VERTEX_ATTRIB_TEX_COORDS),
        ...
        h.drawElements(h.TRIANGLES, 6 * u, h.UNSIGNED_SHORT, 0);
        cc.g_NumberOfDraws++;
        g = 0;
      }
    },
    rendering: function (d, e) {
      var f = e || this._renderCmds,
        h,
        k,
        m,
        n = d || cc._renderContext;
      n.bindBuffer(gl.ARRAY_BUFFER, null);
      h = 0;
      for (k = f.length; h < k; ++h)
        (m = f[h]),
          m.uploadData
            ? this._uploadBufferData(m)
            : (0 < g && this._batchRendering(), m.rendering(n));
      this._batchRendering();
      c.texture = null;
    },
  };
...
cc._tmp.PrototypeCCNode = function () {
  ...
  cc.defineGetterSetter(c, "skewY", c.getSkewY, c.setSkewY);
  ...
  cc.defineGetterSetter(c, "scaleY", c.getScaleY, c.setScaleY);
  ...
  cc.defineGetterSetter(
    c,
    "ignoreAnchor",
    c.isIgnoreAnchorPointForPosition,
    c.ignoreAnchorPointForPosition
  );
  cc.defineGetterSetter(
    c,
    "actionManager",
  ...
  cc.defineGetterSetter(c, "scheduler", c.getScheduler, c.setScheduler);
  cc.defineGetterSetter(
    c,
    "shaderProgram",
    c.getShaderProgram,
  ...
  cc.defineGetterSetter(
    c,
    "cascadeOpacity",
    c.isCascadeOpacityEnabled,
    c.setCascadeOpacityEnabled
  );
  cc.defineGetterSetter(c, "color", c.getColor, c.setColor);
  cc.defineGetterSetter(
    c,
    "cascadeColor",
    c.isCascadeColorEnabled,
    c.setCascadeColorEnabled
  );
};
...
cc.Node = cc.Class.extend({
  ...
  _initNode: function () {
    ...
    this._children = [];
    var c = cc.director;
    this._actionManager = c.getActionManager();
  ...
  _arrayMakeObjectsPerformSelector: function (c, d) {
    if (c && 0 !== c.length) {
      ...
      switch (d) {
        case e.onEnter:
          for (e = 0; e < f; e++) if ((g = c[e])) g.onEnter();
          break;
        case e.onExit:
        ...
        case e.onEnterTransitionDidFinish:
          for (e = 0; e < f; e++)
            if ((g = c[e])) g.onEnterTransitionDidFinish();
          break;
        case e.cleanup:
  ...
  setGlobalZOrder: function (c) {
    this._globalZOrder !== c &&
      ((this._globalZOrder = c), cc.eventManager._setDirtyForNode(this));
  },
  ...
  _setAnchorX: function (c) {
    this._anchorPoint.x !== c &&
      ((this._anchorPoint.x = c), this._renderCmd._updateAnchorPointInPoint());
  },
  _getAnchorY: function () {
    return this._anchorPoint.y;
  },
  _setAnchorY: function (c) {
    this._anchorPoint.y !== c &&
      ((this._anchorPoint.y = c), this._renderCmd._updateAnchorPointInPoint());
  },
  ...
  ignoreAnchorPointForPosition: function (c) {
    c !== this._ignoreAnchorPointForPosition &&
      ((this._ignoreAnchorPointForPosition = c),
      this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty));
  },
  getTag: function () {
    return this.tag;
  ...
  setActionManager: function (c) {
    this._actionManager !== c &&
      (this.stopAllActions(), (this._actionManager = c));
  },
  ...
  setScheduler: function (c) {
    this._scheduler !== c &&
      (this.unscheduleAllCallbacks(), (this._scheduler = c));
  },
  ...
  getChildByName: function (c) {
    ...
    for (var d = this._children, e = 0, f = d.length; e < f; e++)
      if (d[e]._name === c) return d[e];
    return null;
  },
  ...
  _addChildHelper: function (c, d, e, f, g) {
    ...
    if (this._running && (c.onEnter(), this._isTransitionFinished))
  ...
  removeFromParent: function (c) {
    this._parent &&
      (void 0 === c && (c = !0), this._parent.removeChild(this, c));
  },
  ...
  removeChild: function (c, d) {
    0 !== this._children.length &&
      (void 0 === d && (d = !0),
      -1 < this._children.indexOf(c) && this._detachChild(c, d),
      (cc.renderer.childrenOrderDirty = !0));
  },
  removeChildByTag: function (c, d) {
    ...
    e
      ? this.removeChild(e, d)
      : cc.log(cc._LogInfos.Node_removeChildByTag_2, c);
  },
  ...
  sortAllChildren: function () {
    if (this._reorderChildDirty) {
      ...
      for (e = 1; e < d; e++) {
        g = c[e];
        for (f = e - 1; 0 <= f; ) {
          if (g._localZOrder < c[f]._localZOrder) c[f + 1] = c[f];
          else if (
            g._localZOrder === c[f]._localZOrder &&
            g.arrivalOrder < c[f].arrivalOrder
          )
            c[f + 1] = c[f];
          else break;
          f--;
  ...
  stopActionByTag: function (c) {
    c === cc.ACTION_TAG_INVALID
      ...
      : this.actionManager.removeActionByTag(c, this);
  },
  getActionByTag: function (c) {
    return c === cc.ACTION_TAG_INVALID
      ? (cc.log(cc._LogInfos.Node_getActionByTag), null)
      : this.actionManager.getActionByTag(c, this);
  },
  ...
  schedule: function (c, d, e, f, g) {
    ...
    "function" === typeof c
      ? 1 === h
        ? ((d = 0), (e = cc.REPEAT_FOREVER), (f = 0), (g = this.__instanceId))
        : 2 === h
        ? "number" === typeof d
          ? ((e = cc.REPEAT_FOREVER), (f = 0), (g = this.__instanceId))
          : ((g = d), (d = 0), (e = cc.REPEAT_FOREVER), (f = 0))
        : 3 === h
        ? ("string" === typeof e
            ? ((g = e), (e = cc.REPEAT_FOREVER))
            : (g = this.__instanceId),
          (f = 0))
        : 4 === h && (g = this.__instanceId)
      : 1 === h
      ? ((d = 0), (e = cc.REPEAT_FOREVER), (f = 0))
      : 2 === h && ((e = cc.REPEAT_FOREVER), (f = 0));
  ...
  setAdditionalTransform: function (c) {
    if (void 0 === c) return (this._additionalTransformDirty = !1);
  ...
  getNodeToWorldTransform: function () {
    for (
      var c = this.getNodeToParentTransform(), d = this._parent;
      null !== d;
      d = d.parent
    )
      c = cc.affineTransformConcat(c, d.getNodeToParentTransform());
    return c;
  },
  ...
  update: function (c) {
    this._componentContainer &&
      ...
      this._componentContainer.visit(c);
  },
  ...
  getComponent: function (c) {
    return this._componentContainer
      ? this._componentContainer.getComponent(c)
      : null;
  },
  ...
  removeComponent: function (c) {
    return this._componentContainer ? this._componentContainer.remove(c) : !1;
  },
  ...
  getNodeToParentTransform: function (c) {
    ...
    if (c)
      for (
        var d = { a: d.a, b: d.b, c: d.c, d: d.d, tx: d.tx, ty: d.ty },
          e = this._parent;
        null != e && e != c;
        e = e.getParent()
      )
        cc.affineTransformConcatIn(d, e.getNodeToParentTransform());
    return d;
  },
  ...
  getBoundingBoxToWorld: function () {
    var c = cc.rect(0, 0, this._contentSize.width, this._contentSize.height),
      d = this.getNodeToWorldTransform(),
      c = cc.rectApplyAffineTransform(c, d);
    if (!this._children) return c;
    for (var e = this._children, f = 0; f < e.length; f++) {
      var g = e[f];
      g &&
        g._visible &&
        (g = g._getBoundingBoxToCurrentNode(d)) &&
        (c = cc.rectUnion(c, g));
    }
    return c;
  },
  _getBoundingBoxToCurrentNode: function (c) {
    ...
    c =
      void 0 === c
        ...
        : cc.affineTransformConcat(this.getNodeToParentTransform(), c);
    ...
    for (var e = this._children, f = 0; f < e.length; f++) {
      ...
      g &&
        g._visible &&
        (g = g._getBoundingBoxToCurrentNode(c)) &&
        (d = cc.rectUnion(d, g));
    }
    return d;
  },
  ...
  doEnumerateRecursive: function (c, d, e) {
    if (!c.doEnumerate(d, e))
      for (
        var f = c.getChildren(), g = f.length, h = 0;
        h < g && ((c = f[h]), !this.doEnumerateRecursive(c, d, e));
        h++
      );
  },
  doEnumerate: function (c, d) {
    ...
    for (var e = !1, h, k = this._children, m = k.length, n = 0; n < m; n++)
      if (((h = k[n]), -1 !== h._name.indexOf(f)))
        if (g) {
...
cc.Node.RenderCmd.prototype = {
  ...
  _updateAnchorPointInPoint: function () {
    var c = this._anchorPointInPoints,
      d = this._node._contentSize,
      e = this._node._anchorPoint;
    c.x = d.width * e.x;
    c.y = d.height * e.y;
    this.setDirtyFlag(cc.Node._dirtyFlags.transformDirty);
  },
  setDirtyFlag: function (c) {
    0 === this._dirtyFlag && 0 !== c && cc.renderer.pushDirtyNode(this);
    this._dirtyFlag |= c;
  },
  ...
  transform: function (c, d) {
    ...
    var m = e._rotationX || e._rotationY,
      n = e._skewX || e._skewY,
      p = e._scaleX,
      r = e._scaleY,
    ...
    if (m || n) {
      ...
      g.ty = e._position.y;
      m &&
        ((u = 0.017453292519943295 * e._rotationX),
        (w = Math.sin(u)),
        (v = Math.cos(u)),
        e._rotationY === e._rotationX
          ? ((u = v), (t = -w))
          : ((t = 0.017453292519943295 * e._rotationY),
            (u = Math.cos(t)),
            (t = -Math.sin(t))));
      g.a = u *= p;
      g.b = t *= p;
      ...
      g.d = v *= r;
      n &&
        ((n = Math.tan((e._skewX * Math.PI) / 180)),
        (p = Math.tan((e._skewY * Math.PI) / 180)),
      ...
      if (k || s)
        (g.tx -= g.a * k + g.c * s),
          (g.ty -= g.b * k + g.d * s),
          e._ignoreAnchorPointForPosition && ((g.tx += k), (g.ty += s));
      f
        ? ((h.a = g.a * f.a + g.b * f.c),
          (h.b = g.a * f.b + g.b * f.d),
          (h.c = g.c * f.a + g.d * f.c),
          (h.d = g.c * f.b + g.d * f.d),
          (h.tx = f.a * g.tx + f.c * g.ty + f.tx),
          (h.ty = f.d * g.ty + f.ty + f.b * g.tx))
        : ((h.a = g.a),
          (h.b = g.b),
          (h.c = g.c),
          (h.d = g.d),
    ...
    e._additionalTransformDirty &&
      (this._transform = cc.affineTransformConcat(g, e._additionalTransform));
    if (d) {
  ...
  visit: function (c) {
    var d = this._node,
      e = cc.renderer;
    if (d._visible) {
      if ((c = c || this.getParentRenderCmd()))
        this._curLevel = c._curLevel + 1;
      isNaN(d._customZ) &&
  ...
  _updateDisplayColor: function (c) {
    ...
    if (this._cascadeColorEnabledDirty && !d._cascadeColorEnabled) {
      ...
      for (f = c.length; d < f; d++)
        (g = c[d]) && g._renderCmd && g._renderCmd._updateDisplayColor(e);
      this._cascadeColorEnabledDirty = !1;
    } else if (
      (void 0 === c &&
        (c =
          (c = d._parent) && c._cascadeColorEnabled
            ? c.getDisplayedColor()
            : cc.color.WHITE),
      (e.r = 0 | ((f.r * c.r) / 255)),
      (e.g = 0 | ((f.g * c.g) / 255)),
      ...
      for (c = d._children, d = 0, f = c.length; d < f; d++)
        (g = c[d]) &&
          g._renderCmd &&
          (g._renderCmd._updateDisplayColor(e), g._renderCmd._updateColor());
  ...
  _updateDisplayOpacity: function (c) {
    ...
    if (this._cascadeOpacityEnabledDirty && !d._cascadeOpacityEnabled) {
      ...
      for (d = e.length; c < d; c++)
        (f = e[c]) && f._renderCmd && f._renderCmd._updateDisplayOpacity(255);
      ...
      (this._displayedOpacity = (d._realOpacity * c) / 255),
      d._cascadeOpacityEnabled)
    )
      for (e = d._children, c = 0, d = e.length; c < d; c++)
        (f = e[c]) &&
          f._renderCmd &&
          (f._renderCmd._updateDisplayOpacity(this._displayedOpacity),
  ...
  updateStatus: function () {
    ...
    d & c.transformDirty &&
      ...
      (this._dirtyFlag ^= this._dirtyFlag & c.transformDirty));
  ...
  _syncStatus: function (c) {
    ...
    c
      ? ((f = c._node),
        (this._savedDirtyFlag = this._savedDirtyFlag || c._savedDirtyFlag || e))
      : (this._savedDirtyFlag = this._savedDirtyFlag || e);
    f &&
      f._cascadeColorEnabled &&
      c._dirtyFlag & d.colorDirty &&
      (e |= d.colorDirty);
    f &&
      f._cascadeOpacityEnabled &&
      c._dirtyFlag & d.opacityDirty &&
      (e |= d.opacityDirty);
    ...
    e & d.transformDirty && this.transform(c);
...
(function () {
  ...
  var c = (cc.Node.CanvasRenderCmd.prototype = Object.create(
    cc.Node.RenderCmd.prototype
  ));
  ...
  c._setCachedParent = function (c) {
    if (this._cachedParent !== c) {
      ...
      for (var e = this._node._children, f = 0, g = e.length; f < g; f++)
        e[f]._renderCmd._setCachedParent(c);
    }
  };
  c.detachFromParent = function () {
    this._cachedParent = null;
    for (var c = this._node._children, e, f = 0, g = c.length; f < g; f++)
      (e = c[f]) && e._renderCmd && e._renderCmd.detachFromParent();
  };
  c.setShaderProgram = function (c) {};
  c.getShaderProgram = function () {
    return null;
  };
  cc.Node.CanvasRenderCmd._getCompositeOperationByBlendFunc = function (c) {
    return c
      ? (c.src === cc.SRC_ALPHA && c.dst === cc.ONE) ||
        (c.src === cc.ONE && c.dst === cc.ONE)
        ? "lighter"
        : c.src === cc.ZERO && c.dst === cc.SRC_ALPHA
        ? "destination-in"
        : c.src === cc.ZERO && c.dst === cc.ONE_MINUS_SRC_ALPHA
        ? "destination-out"
        : "source-over"
      : "source-over";
  };
...
(function () {
  ...
  var c = (cc.Node.WebGLRenderCmd.prototype = Object.create(
    cc.Node.RenderCmd.prototype
  ));
...
cc.AtlasNode = cc.Node.extend({
  ...
  initWithTexture: function (c, d, e, f) {
    return this._renderCmd.initWithTexture(c, d, e, f);
  },
  setColor: function (c) {
...
(function () {
  ...
  var c = (cc.AtlasNode.CanvasRenderCmd.prototype = Object.create(
  ...
  c.setColor = function (c) {
    ...
    if (e.r !== c.r || e.g !== c.g || e.b !== c.b)
      (this._colorUnmodified = c), this._changeTextureColor();
  };
  c._changeTextureColor = function () {
    var c = this._node._texture,
      e = this._colorUnmodified,
      f = c.getHtmlElementObj(),
      f = cc.rect(0, 0, f.width, f.height);
    c === this._textureToRender
      ? (this._textureToRender = c._generateColorTexture(e.r, e.g, e.b, f))
      : c._generateColorTexture(
          e.r,
          e.g,
          e.b,
          f,
...
(function () {
  ...
  var c = (cc.AtlasNode.WebGLRenderCmd.prototype = Object.create(
  ...
  c._updateBlendFunc = function () {
    ...
    this._textureAtlas.texture.hasPremultipliedAlpha() ||
      ((c._blendFunc.src = cc.SRC_ALPHA),
      (c._blendFunc.dst = cc.ONE_MINUS_SRC_ALPHA));
  };
  ...
  c.rendering = function (c) {
    ...
    this._uniformColor &&
      this._colorF32Array &&
      (c.uniform4fv(this._uniformColor, this._colorF32Array),
  ...
  cc.Texture2D = cc.Class.extend({
    ...
    initWithData: function (c, d, e, f, g) {
      var h = cc.Texture2D,
        ...
        m = k.RGBA,
        n = k.UNSIGNED_BYTE,
        p = (e * cc.Texture2D._B[d]) / 8;
      0 === p % 8
        ? k.pixelStorei(k.UNPACK_ALIGNMENT, 8)
        : 0 === p % 4
        ? k.pixelStorei(k.UNPACK_ALIGNMENT, 4)
        : 0 === p % 2
        ? k.pixelStorei(k.UNPACK_ALIGNMENT, 2)
    ...
    drawAtPoint: function (c) {
      var d = [0, this.maxT, this.maxS, this.maxT, 0, 0, this.maxS, 0],
        e = cc._renderContext,
        f = this._pixelsWide * this.maxS,
        g = this._pixelsHigh * this.maxT;
      ...
      e.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION, 2, e.FLOAT, !1, 0, c);
    ...
    initWithImage: function (c) {
      ...
      var d = c.getWidth(),
        e = c.getHeight(),
        f = cc.configuration.getMaxTextureSize();
      if (d > f || e > f)
        return cc.log(cc._LogInfos.Texture2D_initWithImage_2, d, e, f, f), !1;
    ...
    handleLoadedTexture: function (c) {
      ...
      if (cc.game._rendererInitialized) {
        ...
        this._htmlElementObj.width &&
          ...
          ((d = cc._renderContext),
          cc.glBindTexture2D(this),
          d.pixelStorei(d.UNPACK_ALIGNMENT, 4),
          c && d.pixelStorei(d.UNPACK_PREMULTIPLY_ALPHA_WEBGL, 1),
          d.texImage2D(
            d.TEXTURE_2D,
            0,
            d.RGBA,
          ...
          c && d.pixelStorei(d.UNPACK_PREMULTIPLY_ALPHA_WEBGL, 0),
          (d = this._htmlElementObj.height),
          (this._pixelsWide = this._contentSize.width = this._htmlElementObj.width),
          (this._pixelsHigh = this._contentSize.height = d),
          (this._pixelFormat = cc.Texture2D.PIXEL_FORMAT_RGBA8888),
          (this.maxT = this.maxS = 1),
          (this._hasPremultipliedAlpha = c),
          (this._hasMipmaps = !1),
    ...
    setTexParameters: function (c, d, e, f) {
      ...
      cc.assert(
        (this._pixelsWide === cc.NextPOT(this._pixelsWide) &&
          ...
          (c.wrapS === g.CLAMP_TO_EDGE && c.wrapT === g.CLAMP_TO_EDGE),
        "WebGLRenderingContext.CLAMP_TO_EDGE should be used in NPOT textures"
      );
      cc.glBindTexture2D(this);
      g.texParameteri(g.TEXTURE_2D, g.TEXTURE_MIN_FILTER, c.minFilter);
    ...
    _initPremultipliedATextureWithImage: function (c, d, e) {
      var f = cc.Texture2D,
        ...
        h = null,
        k = c.hasAlpha(),
        m = cc.size(c.getWidth(), c.getHeight()),
        n = f.defaultPixelFormat,
        p = c.getBitsPerComponent();
      k ||
        (8 <= p
          ? (n = f.PIXEL_FORMAT_RGB888)
          : (cc.log(cc._LogInfos.Texture2D__initPremultipliedATextureWithImage),
            (n = f.PIXEL_FORMAT_RGB565)));
      var r = d * e;
      if (n === f.PIXEL_FORMAT_RGB565)
        if (k)
          for (g = new Uint16Array(d * e), h = c.getData(), p = 0; p < r; ++p)
            g[p] =
              ((((h[p] >> 0) & 255) >> 3) << 11) |
              ((((h[p] >> 8) & 255) >> 2) << 5) |
              ((((h[p] >> 16) & 255) >> 3) << 0);
          ...
          for (g = new Uint16Array(d * e), h = c.getData(), p = 0; p < r; ++p)
            g[p] =
              ...
              (((h[p] & 255) >> 2) << 5) |
              (((h[p] & 255) >> 3) << 0);
      else if (n === f.PIXEL_FORMAT_RGBA4444)
        for (g = new Uint16Array(d * e), h = c.getData(), p = 0; p < r; ++p)
          g[p] =
            ((((h[p] >> 0) & 255) >> 4) << 12) |
            ((((h[p] >> 8) & 255) >> 4) << 8) |
            ((((h[p] >> 16) & 255) >> 4) << 4) |
            ((((h[p] >> 24) & 255) >> 4) << 0);
      else if (n === f.PIXEL_FORMAT_RGB5A1)
        for (g = new Uint16Array(d * e), h = c.getData(), p = 0; p < r; ++p)
          g[p] =
            ((((h[p] >> 0) & 255) >> 3) << 11) |
            ((((h[p] >> 8) & 255) >> 3) << 6) |
            ((((h[p] >> 16) & 255) >> 3) << 1) |
            ((((h[p] >> 24) & 255) >> 7) << 0);
      else if (n === f.PIXEL_FORMAT_A8)
        for (g = new Uint8Array(d * e), h = c.getData(), p = 0; p < r; ++p)
          g[p] = (h >> 24) & 255;
      if (k && n === f.PIXEL_FORMAT_RGB888)
        for (h = c.getData(), g = new Uint8Array(d * e * 3), p = 0; p < r; ++p)
          (g[3 * p] = (h >> 0) & 255),
            (g[3 * p + 1] = (h >> 8) & 255),
            (g[3 * p + 2] = (h >> 16) & 255);
      this.initWithData(g, n, d, e, m);
      c.getData();
...
cc._tmp.WebGLTextureAtlas = function () {
  ...
  c.drawNumberOfQuads = function (c, e) {
    ...
    if (0 !== c && this.texture && this.texture.isLoaded()) {
      ...
      this.dirty &&
        (f.bufferData(f.ARRAY_BUFFER, this._quadsArrayBuffer, f.DYNAMIC_DRAW),
        (this.dirty = !1));
      ...
      cc.TEXTURE_ATLAS_USE_TRIANGLE_STRIP
        ? f.drawElements(
            ...
            6 * c,
            f.UNSIGNED_SHORT,
            6 * e * this._indices.BYTES_PER_ELEMENT
          )
        : f.drawElements(
            f.TRIANGLES,
            6 * c,
...
cc._tmp.PrototypeTexture2D = function () {
  ...
  d[c.PIXEL_FORMAT_RGBA8888] = "RGBA8888";
  ...
  if (cc._renderType === cc.game.RENDER_TYPE_CANVAS) {
    var c = {
      ...
      setTexParameters: function (c, e, f, g) {
        void 0 !== e &&
          (c = { minFilter: c, magFilter: e, wrapS: f, wrapT: g });
        this._pattern =
          c.wrapS === cc.REPEAT && c.wrapT === cc.REPEAT
            ? "repeat"
            : c.wrapS === cc.REPEAT
            ? "repeat-x"
            : c.wrapT === cc.REPEAT
      ...
      _generateTextureCacheForColor: function () {
        ...
        for (var h = h.getImageData(0, 0, f, g).data, k, m = 0; 4 > m; m++) {
          k = c[m].getContext("2d");
          for (
            var n = k.getImageData(0, 0, f, g), p = n.data, r = 0;
            r < h.length;
            r += 4
          )
            (p[r] = 0 === m ? h[r] : 0),
    ...
    c._generateColorTexture = cc.sys._supportCanvasNewBlendModes
      ? function (c, e, f, g, h) {
          var k = !1;
      ...
      : function (c, e, f, g, h) {
          ...
          if (p && g) {
            ...
            0 < c &&
              ((r.globalAlpha = c / 255),
              r.drawImage(s[0], m, n, p, g, 0, 0, p, g));
            0 < e &&
              ((r.globalAlpha = e / 255),
              r.drawImage(s[1], m, n, p, g, 0, 0, p, g));
            0 < f &&
              ((r.globalAlpha = f / 255),
              r.drawImage(s[2], m, n, p, g, 0, 0, p, g));
            if (k) return h;
            c = new cc.Texture2D();
            c.initWithElement(h);
            c.handleLoadedTexture();
    ...
    cc.Texture2D._generateGrayTexture = function (c, e, f) {
      ...
      e = c.data;
      for (var h = 0, k = e.length; h < k; h += 4)
        e[h] = e[h + 1] = e[h + 2] =
          0.34 * e[h] + 0.5 * e[h + 1] + 0.16 * e[h + 2];
...
cc.textureCache = {
  ...
  getTextureColors: function (c) {
    var d = c._htmlElementObj,
      e = this.getKeyByTexture(d);
    e ||
      (e =
        d instanceof HTMLImageElement
          ? d.src
          : this._generalTextureKey(c.__instanceId));
    this._textureColorsCache[e] ||
      (this._textureColorsCache[e] = c._generateTextureCacheForColor());
  ...
  removeTextureForKey: function (c) {
    null != c && this._textures[c] && delete this._textures[c];
  },
  cacheImage: function (c, d) {
    if (d instanceof cc.Texture2D) this._textures[c] = d;
    else {
  ...
  dumpCachedTextureInfo: function () {
    ...
    for (f in e) {
      var g = e[f];
      c++;
      g.getHtmlElementObj() instanceof HTMLImageElement
        ? cc.log(
            cc._LogInfos.textureCache_dumpCachedTextureInfo,
            f,
            g.getHtmlElementObj().src,
            g.pixelsWidth,
            g.pixelsHeight
          )
        : cc.log(
...
cc.game.addEventListener(cc.game.EVENT_RENDERER_INITED, function () {
  if (cc._renderType === cc.game.RENDER_TYPE_CANVAS) {
    ...
    c.addImage = function (c, e, f) {
      ...
      var g = this._textures,
        h = g[c] || g[cc.loader._getAliase(c)];
      if (h)
        return (
          h.isLoaded()
            ? e && e.call(f, h)
...
cc.TextureAtlas = cc.Class.extend({
  ...
  ctor: function (c, d) {
    this._buffersVBO = [];
    cc.isString(c)
      ? this.initWithFile(c, d)
      : c instanceof cc.Texture2D && this.initWithTexture(c, d);
  },
  ...
  _setQuadToArray: function (c, d) {
    var e = this._quads;
    e[d]
      ? ((e[d].bl = c.bl), (e[d].br = c.br), (e[d].tl = c.tl), (e[d].tr = c.tr))
      : (e[d] = new cc.V3F_C4B_T2F_Quad(
          c.tl,
          c.bl,
          c.tr,
          c.br,
          this._quadsArrayBuffer,
          d * cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT
        ));
  },
  description: function () {
  ...
  _setupIndices: function () {
    if (0 !== this._capacity)
      for (var c = this._indices, d = this._capacity, e = 0; e < d; e++)
        cc.TEXTURE_ATLAS_USE_TRIANGLE_STRIP
          ? ((c[6 * e + 0] = 4 * e + 0),
            (c[6 * e + 1] = 4 * e + 0),
            (c[6 * e + 2] = 4 * e + 2),
  ...
  initWithTexture: function (c, d) {
    cc.assert(c, cc._LogInfos.TextureAtlas_initWithTexture);
    this._capacity = d |= 0;
    this._totalQuads = 0;
    this.texture = c;
    this._quads = [];
    ...
    for (var f = this._quads, g = 0; g < d; g++)
      f[g] = new cc.V3F_C4B_T2F_Quad(
        null,
        null,
        null,
        null,
  ...
  insertQuads: function (c, d, e) {
    ...
    if (this._totalQuads > this._capacity)
      ...
      var g = d * f,
        h = (this._totalQuads - 1 - d - e) * f,
        k = this._totalQuads - 1 - e,
        m;
      for (m = 0; m < e; m++)
        this._quads[k + m] = new cc.V3F_C4B_T2F_Quad(
          null,
          null,
          null,
          null,
          this._quadsArrayBuffer,
          (this._totalQuads - 1) * f
        );
  ...
  insertQuadFromIndex: function (c, d) {
    if (c !== d) {
      ...
      c > d
        ? ((h = d * e),
          f.set(f.subarray(h, h + (c - d) * e), h + e),
          f.set(g, h))
        : ((h = (c + 1) * e),
          f.set(f.subarray(h, h + (d - c) * e), h - e),
          f.set(g, d * e));
      this.dirty = !0;
    }
  },
  removeQuadAtIndex: function (c) {
    ...
    if (c !== this._totalQuads) {
      ...
      this._quadsReader.set(
        this._quadsReader.subarray(e, e + (this._totalQuads - c) * d),
        e - d
      );
    }
    this.dirty = !0;
  ...
  removeQuadsAtIndex: function (c, d) {
    ...
    if (c !== this._totalQuads) {
      var e = cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT,
        ...
        g = c * e;
      this._quadsReader.set(
        this._quadsReader.subarray(f, f + (this._totalQuads - c) * e),
        g
      );
    }
    this.dirty = !0;
  ...
  resizeCapacity: function (c) {
    ...
    var f = (this._capacity = 0 | c),
      g = this._totalQuads;
    if (null === this._quads)
      for (
        this._quads = [],
          this._quadsArrayBuffer = new ArrayBuffer(d * f),
          this._quadsReader = new Uint8Array(this._quadsArrayBuffer),
          c = 0;
        c < f;
        c++
      ...
      if (f > e) {
        ...
        for (
          g = Math.max(g, f), h = [], k = new ArrayBuffer(d * f), c = 0;
          c < g;
          c++
        )
          h[c] = new cc.V3F_C4B_T2F_Quad(
    ...
    null === this._indices
      ...
      : f > e
      ? ((d = new Uint16Array(6 * f)),
        d.set(this._indices, 0),
        (this._indices = d))
      : (this._indices = this._indices.subarray(0, 6 * f));
    this._setupIndices();
    this._mapBuffers();
    return (this.dirty = !0);
  },
  ...
  moveQuadsFromIndex: function (c, d, e) {
    if (void 0 === e) {
      if (
        ((e = d),
        (d = this._totalQuads - c),
        cc.assert(
          e + (this._totalQuads - c) <= this._capacity,
    ...
    var f = cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT,
      ...
      n = e * f;
    e < c
      ? ((d = e * f), k.set(k.subarray(d, d + (c - e) * f), d + h))
      : ((d = (c + d) * f), k.set(k.subarray(d, d + (e - c) * f), g));
    k.set(m, n);
    this.dirty = !0;
  },
  fillWithEmptyQuadsFromIndex: function (c, d) {
    for (
      var e = d * cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT,
        f = new Uint8Array(
          this._quadsArrayBuffer,
          c * cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT,
          e
        ),
        g = 0;
      g < e;
  ...
  _releaseBuffer: function () {
    var c = cc._renderContext;
    this._buffersVBO &&
      (this._buffersVBO[0] && c.deleteBuffer(this._buffersVBO[0]),
...
cc.LoaderScene = cc.Scene.extend({
  ...
  init: function () {
    var c = 101,
      d = (this._bgLayer = new cc.LayerColor(cc.color(255, 255, 255, 255)));
    this.addChild(d, 0);
    ...
    cc._loaderImage &&
      ...
      (e = 30),
      (f = -c / 2 - 20));
    e = this._label = new cc.LabelTTF("Loading... 0%", "Arial", e + 5);
    e.setPosition(cc.pAdd(cc.visibleRect.center, cc.p(0, f + 20)));
    e.setColor(cc.color("#f99f0a"));
  ...
  _startLoading: function () {
    ...
    cc.loader.load(
      ...
      function () {
        c.cb &&
          (c._label.setString("Loading... 100%"),
...
cc.LayerGradient = cc.LayerColor.extend({
  ...
  ctor: function (c, d, e, f) {
    ...
    f && f instanceof Array
      ? ((this._colorStops = f),
        f.splice(0, 0, { p: 0, color: c || cc.color.BLACK }),
        f.push({ p: 1, color: d || cc.color.BLACK }))
      : (this._colorStops = [
          { p: 0, color: c || cc.color.BLACK },
  ...
  setStartColor: function (c) {
    ...
    d &&
      0 < d.length &&
      ((d = d[0].color), (d.r = c.r), (d.g = c.g), (d.b = c.b));
  },
  setEndColor: function (c) {
    ...
    (d = this._colorStops) &&
      0 < d.length &&
      ((d = d[d.length - 1].color), (d.r = c.r), (d.g = c.g), (d.b = c.b));
    this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.colorDirty);
  },
...
cc.LayerMultiplex = cc.Layer.extend({
  ...
  ctor: function (c) {
    cc.Layer.prototype.ctor.call(this);
    c instanceof Array
      ? cc.LayerMultiplex.prototype.initWithLayers.call(this, c)
  ...
  switchTo: function (c) {
    c >= this._layers.length
      ...
      : (this.removeChild(this._layers[this._enabledLayer], !0),
        (this._enabledLayer = c),
        this.addChild(this._layers[c]));
  },
  ...
  addLayer: function (c) {
    c ? this._layers.push(c) : cc.log(cc._LogInfos.LayerMultiplex_addLayer);
  },
});
...
(function () {
  ...
  var c = (cc.Layer.CanvasRenderCmd.prototype = Object.create(
    cc.Node.CanvasRenderCmd.prototype
  ));
  ...
  c.updateStatus = function () {
    ...
    e & c.orderDirty &&
      ...
      (this._dirtyFlag = (e & c.orderDirty) ^ e));
  ...
  c.bake = function () {
    if (!this._isBaked) {
      ...
      0 === this._updateCache && (this._updateCache = 2);
      for (var c = this._node._children, e = 0, f = c.length; e < f; e++)
        c[e]._renderCmd._setCachedParent(this);
      this._bakeSprite ||
  ...
  c.unbake = function () {
    if (this._isBaked) {
      ...
      0 === this._updateCache && (this._updateCache = 2);
      for (var c = this._node._children, e = 0, f = c.length; e < f; e++)
        c[e]._renderCmd._setCachedParent(null);
    }
  };
  c.isBaked = function () {
  ...
  c._getBoundingBoxForBake = function () {
    ...
    for (
      var f = e.getNodeToWorldTransform(), e = e._children, g = 0, h = e.length;
      g < h;
      g++
    ) {
      var k = e[g];
      k &&
        k._visible &&
        (c
          ? (k = k._getBoundingBoxToCurrentNode(f)) && (c = cc.rectUnion(c, k))
          : (c = k._getBoundingBoxToCurrentNode(f)));
    }
    return c;
  };
})();
(function () {
  ...
  var c = (cc.LayerColor.CanvasRenderCmd.prototype = Object.create(
  ...
  c.rendering = function (c, e, f) {
    ...
    var g = c.getContext(),
      ...
      n = h._contentSize.width,
      h = h._contentSize.height;
    0 !== m &&
      (c.setCompositeOperation(this._blendFuncStr),
      c.setGlobalAlpha(m),
      c.setFillStyle(
        "rgba(" + (0 | k.r) + "," + (0 | k.g) + "," + (0 | k.b) + ", 1)"
      ),
      c.setTransform(this._worldTransform, e, f),
      g.fillRect(0, 0, n * e, -h * f),
      cc.g_NumberOfDraws++);
  };
  ...
  c._updateSquareVertices = c._updateSquareVerticesWidth = c._updateSquareVerticesHeight = function () {};
    ...
    if (this._cacheDirty) {
      ...
      if (0 < this._updateCache) {
        ...
        if (0 < g) {
          c.sortAllChildren();
          for (c = 0; c < g; c++)
            if (((h = f[c]), 0 > h._localZOrder)) h._renderCmd.visit(this);
            else break;
          for (cc.renderer.pushRenderCommand(this); c < g; c++)
            f[c]._renderCmd.visit(this);
  ...
  c._getBoundingBoxForBake = function () {
    var c = this._node,
      e = cc.rect(0, 0, c._contentSize.width, c._contentSize.height),
      f = c.getNodeToWorldTransform(),
      e = cc.rectApplyAffineTransform(e, c.getNodeToWorldTransform());
    if (!c._children || 0 === c._children.length) return e;
    for (var c = c._children, g = 0; g < c.length; g++) {
      var h = c[g];
      h &&
        h._visible &&
        ((h = h._getBoundingBoxToCurrentNode(f)), (e = cc.rectUnion(e, h)));
    }
    return e;
  };
})();
(function () {
  ...
  var c = (cc.LayerGradient.CanvasRenderCmd.prototype = Object.create(
  ...
  c.rendering = function (c, e, f) {
    ...
    if (0 !== k) {
      ...
      c.setCompositeOperation(this._blendFuncStr);
      c.setGlobalAlpha(k);
      k = g.createLinearGradient(
        this._startPoint.x * e,
        this._startPoint.y * f,
        this._endPoint.x * e,
        this._endPoint.y * f
      );
      if (h._colorStops)
        for (var p = 0; p < h._colorStops.length; p++)
          k.addColorStop(h._colorStops[p].p, this._colorStopsStr[p]);
      else
  ...
  c.updateStatus = function () {
    ...
    e & c.gradientDirty &&
      ...
      (this._dirtyFlag = (e & c.gradientDirty) ^ e));
    cc.Node.RenderCmd.prototype.updateStatus.call(this);
  };
  c._syncStatus = function (c) {
    var e = cc.Node._dirtyFlags,
    ...
    f & e.gradientDirty &&
      ...
      (this._dirtyFlag = (f & e.gradientDirty) ^ f));
    cc.Node.RenderCmd.prototype._syncStatus.call(this, c);
  };
  c._updateColor = function () {
    var c = this._node,
      ...
      f = 0.5 * e.width,
      e = 0.5 * e.height,
      g = cc.pAngleSigned(cc.p(0, -1), c._alongVector),
      g = cc.pRotateByAngle(cc.p(0, -1), cc.p(0, 0), g),
      h = Math.min(Math.abs(1 / g.x), Math.abs(1 / g.y));
    ...
    if (c._colorStops)
      for (
        this._endOpacity = this._startOpacity = 0,
          this._colorStopsStr = [],
          f = 0;
        f < c._colorStops.length;
        f++
      )
        (e = c._colorStops[f].color),
          (g = null == e.a ? 1 : e.a / 255),
...
(function () {
  ...
  var c = (cc.Layer.WebGLRenderCmd.prototype = Object.create(
    cc.Node.WebGLRenderCmd.prototype
  ));
...
(function () {
  cc.LayerColor.WebGLRenderCmd = function (c) {
    ...
    this._squareVertices = [
      new cc.Vertex3F(0, 0, 0, c, 0),
      new cc.Vertex3F(0, 0, 0, c, f),
      new cc.Vertex3F(0, 0, 0, c, 2 * f),
      new cc.Vertex3F(0, 0, 0, c, 3 * f),
    ];
    this._squareColors = [
      cc.color(0, 0, 0, 255, e, 0),
      cc.color(0, 0, 0, 255, e, g),
      cc.color(0, 0, 0, 255, e, 2 * g),
      cc.color(0, 0, 0, 255, e, 3 * g),
    ];
  ...
  var c = (cc.LayerColor.WebGLRenderCmd.prototype = Object.create(
  ...
  c.transform = function (c, e) {
    ...
    var f = this._node,
      g = f._contentSize.width,
      h = f._contentSize.height,
      k = this._squareVertices;
    k[1].x = g;
    k[2].y = h;
    k[3].x = g;
    k[3].y = h;
  ...
  c._updateColor = function () {
    for (
      ...
      (f[g].r = c.r), (f[g].g = c.g), (f[g].b = c.b), (f[g].a = e);
...
(function () {
  ...
  var c = (cc.LayerGradient.WebGLRenderCmd.prototype = Object.create(
  ...
  c._updateVertex = function () {
    ...
    if (e && !(2 > e.length)) {
      ...
      var f = e.length,
        ...
        h,
        k = c._contentSize,
        m = this._squareVertices;
      if (m.length < g) {
        this._squareVerticesAB = new ArrayBuffer(12 * g);
        m.length = 0;
        var n = this._squareVerticesAB,
          p = cc.Vertex3F.BYTES_PER_ELEMENT;
        for (h = 0; h < g; h++) m.push(new cc.Vertex3F(0, 0, 0, n, p * h));
      }
      var r = Math.PI + cc.pAngleSigned(cc.p(0, -1), c._alongVector),
        g = cc.p(k.width / 2, k.height / 2);
      h = Math.round(cc.radiansToDegrees(r));
      var n = cc.affineTransformMake(1, 0, 0, 1, g.x, g.y),
        n = cc.affineTransformRotate(n, r),
        s;
      90 > h
        ? ((s = cc.p(-g.x, g.y)), (h = cc.p(g.x, g.y)))
        : 180 > h
        ? ((s = cc.p(g.x, g.y)), (h = cc.p(g.x, -g.y)))
        : 270 > h
        ? ((s = cc.p(g.x, -g.y)), (h = cc.p(-g.x, -g.y)))
      ...
      for (h = 0; h < f; h++)
        (p = e[h].p * k.height),
          (r = cc.pointApplyAffineTransform(-g.x, p - g.y, n)),
          (m[2 * h].x = r.x),
          (m[2 * h].y = r.y),
          (m[2 * h].z = c._vertexZ),
          (p = cc.pointApplyAffineTransform(k.width - g.x, p - g.y, n)),
          (m[2 * h + 1].x = p.x),
          (m[2 * h + 1].y = p.y),
          (m[2 * h + 1].z = c._vertexZ);
      this._bindLayerVerticesBufferData();
    }
  };
  c._updateColor = function () {
  ...
  c.rendering = function (c) {
    c = c || cc._renderContext;
    var e = this._node,
      f = this._getClippingRect();
    c.enable(c.SCISSOR_TEST);
    cc.view.setScissorInPoints(f.x, f.y, f.width, f.height);
    f = this._worldTransform;
    this._matrix.mat[0] = f.a;
    this._matrix.mat[4] = f.c;
    this._matrix.mat[12] = f.tx;
...
cc._tmp.PrototypeSprite = function () {
  ...
  cc.defineGetterSetter(
    c,
    "opacityModifyRGB",
    c.isOpacityModifyRGB,
    c.setOpacityModifyRGB
  );
  cc.defineGetterSetter(c, "opacity", c.getOpacity, c.setOpacity);
  cc.defineGetterSetter(c, "color", c.getColor, c.setColor);
...
cc.Sprite = cc.Node.extend({
  ...
  initWithSpriteFrame: function (c) {
    ...
    var d = cc._renderType === cc.game.RENDER_TYPE_CANVAS ? !1 : c._rotated,
      d = this.initWithTexture(c.getTexture(), c.getRect(), d);
  ...
  reorderChild: function (c, d) {
    ...
    -1 === this._children.indexOf(c)
      ...
      : d !== c.zIndex &&
        ...
        cc.Node.prototype.reorderChild.call(this, c, d));
  },
  removeChild: function (c, d) {
  ...
  removeAllChildren: function (c) {
    var d = this._children,
      e = this._batchNode;
    if (e && null != d)
      for (var f = 0, g = d.length; f < g; f++) e.removeSpriteFromAtlas(d[f]);
  ...
  ignoreAnchorPointForPosition: function (c) {
    this._batchNode
      ...
      : cc.Node.prototype.ignoreAnchorPointForPosition.call(this, c);
  },
  ...
  setOpacityModifyRGB: function (c) {
    this._opacityModifyRGB !== c &&
      ((this._opacityModifyRGB = c), this._renderCmd._setColorDirty());
  },
  isOpacityModifyRGB: function () {
    return this._opacityModifyRGB;
  },
  ...
  _setReorderChildDirtyRecursively: function () {
    if (!this._reorderChildDirty) {
      ...
      for (var c = this._parent; c && c !== this._batchNode; )
        c._setReorderChildDirtyRecursively(), (c = c.parent);
    }
  },
  getTexture: function () {
    return this._texture;
  ...
  _softInit: function (c, d, e) {
    if (void 0 === c) cc.Sprite.prototype.init.call(this);
    else if (cc.isString(c))
      "#" === c[0]
        ? ((d = c.substr(1, c.length - 1)),
          (d = cc.spriteFrameCache.getSpriteFrame(d))
            ? this.initWithSpriteFrame(d)
            : cc.log("%s does not exist", c))
        : cc.Sprite.prototype.init.call(this, c, d);
    else if ("object" === typeof c)
      if (c instanceof cc.Texture2D) this.initWithTexture(c, d, e);
      else if (c instanceof cc.SpriteFrame) this.initWithSpriteFrame(c);
      else if (c instanceof HTMLImageElement || c instanceof HTMLCanvasElement)
        (d = new cc.Texture2D()),
          d.initWithElement(c),
          d.handleLoadedTexture(),
          this.initWithTexture(d);
  },
  getQuad: function () {
    return null;
  },
  ...
  initWithFile: function (c, d) {
    ...
    return this.initWithTexture(
      e,
      d || cc.rect(0, 0, e._contentSize.width, e._contentSize.height)
    );
  },
  initWithTexture: function (c, d, e, f) {
    cc.assert(
    ...
    if (!g)
      return (
        ...
        d &&
          ((this._rect.x = d.x),
          (this._rect.y = d.y),
          (this._rect.width = d.width),
          (this._rect.height = d.height)),
  ...
  setTextureRect: function (c, d, e, f) {
    ...
    this._renderCmd._setTextureCoords(c, f);
  ...
  addChild: function (c, d, e) {
    ...
    null == e && (e = c.tag);
    this._renderCmd._setBatchNodeForAddChild(c) &&
      (cc.Node.prototype.addChild.call(this, c, d, e),
      (this._hasChildren = !0));
  },
  setSpriteFrame: function (c) {
    ...
    cc.isString(c) &&
      ...
      cc.assert(c, cc._LogInfos.Sprite_setSpriteFrame));
    this.setNodeDirty(!0);
    var e = c.getOffset();
    ...
    c.textureLoaded()
      ? ((d._textureLoaded = !0),
        e !== d._texture && (d._setTexture(e), d.setColor(d._realColor)),
...
(function () {
  ...
  var c = (cc.Sprite.CanvasRenderCmd.prototype = Object.create(
    cc.Node.CanvasRenderCmd.prototype
  ));
  ...
  c._setTexture = function (c) {
    var e = this._node;
    e._texture !== c &&
      ((e._textureLoaded = c ? c._textureLoaded : !1),
      (e._texture = c),
      this._updateColor());
  };
  ...
  c.isFrameDisplayed = function (c) {
    var e = this._node;
    return c.getTexture() !== e._texture
      ? !1
      : cc.rectEqualToRect(c.getRect(), e._rect);
  };
  c.updateBlendFunc = function (c) {
    this._blendFuncStr = cc.Node.CanvasRenderCmd._getCompositeOperationByBlendFunc(
      c
  ...
  c._handleTextureForRotatedTexture = function (c, e, f, g) {
    f &&
      c.isLoaded() &&
      ((c = c.getHtmlElementObj()),
      (c = cc.Sprite.CanvasRenderCmd._cutRotateImageToCanvas(c, e, g)),
      (g = new cc.Texture2D()),
      g.initWithElement(c),
  ...
  c._checkTextureBoundary = function (c, e, f) {
    c &&
      c.url &&
      ((f = e.y + e.height),
      e.x + e.width > c.width && cc.error(cc._LogInfos.RectWidth, c.url),
      f > c.height && cc.error(cc._LogInfos.RectHeight, c.url));
  };
  c.rendering = function (c, e, f) {
    var g = this._node,
      h = this._textureCoord,
      k = this._displayedOpacity / 255,
      m = this._textureToRender || g._texture;
    if (
      (!m || (0 !== h.width && 0 !== h.height && m._textureLoaded)) &&
      0 !== k
    ) {
      c = c || cc._renderContext;
      var n = c.getContext(),
        p = g._offsetPosition.x,
        r = g._rect.height,
        s = g._rect.width,
        u = -g._offsetPosition.y - r;
      c.setTransform(this._worldTransform, e, f);
      c.setCompositeOperation(this._blendFuncStr);
      c.setGlobalAlpha(k);
      (g._flippedX || g._flippedY) && c.save();
      g._flippedX && ((p = -p - s), n.scale(-1, 1));
      g._flippedY && ((u = g._offsetPosition.y), n.scale(1, -1));
      var t, w, v;
      this._colorized ? (t = k = 0) : ((k = h.renderX), (t = h.renderY));
      w = h.width;
      v = h.height;
      p *= e;
      u *= f;
      ...
      m && m._htmlElementObj
        ? ((e = m._htmlElementObj),
          "" !== m._pattern
            ? (c.setFillStyle(n.createPattern(e, m._pattern)),
              n.fillRect(p, u, s, r))
            : n.drawImage(e, k, t, w, v, p, u, s, r))
        : ((m = g._contentSize),
          h.validRect &&
            ((h = this._displayedColor),
            c.setFillStyle("rgba(" + h.r + "," + h.g + "," + h.b + ",1)"),
            n.fillRect(p, u, m.width * e, m.height * f)));
  ...
  c._updateColor = function () {
    var c = this._node._texture,
      ...
      f = this._displayedColor;
    c &&
      (255 !== f.r || 255 !== f.g || 255 !== f.b
        ? ((this._textureToRender = c._generateColorTexture(f.r, f.g, f.b, e)),
          (this._colorized = !0))
        : c && ((this._textureToRender = c), (this._colorized = !1)));
  };
  ...
  c._spriteFrameLoadedCallback = function (c) {
    this.setTextureRect(c.getRect(), c.isRotated(), c.getOriginalSize());
  ...
  c._textureLoadedCallback = function (c) {
    if (!this._textureLoaded) {
      ...
      var e = this._rect,
        f = this._renderCmd;
      e
        ? cc._rectEqualToZero(e) && ((e.width = c.width), (e.height = c.height))
  ...
  c._setTextureCoords = function (c, e) {
    void 0 === e && (e = !0);
    var f = this._textureCoord,
      g = e ? cc.contentScaleFactor() : 1;
...
(function () {
  ...
  var c = (cc.Sprite.WebGLRenderCmd.prototype = Object.create(
    cc.Node.WebGLRenderCmd.prototype
  ));
  ...
  c.setDirtyRecursively = function (c) {
    ...
    for (
      var e = this._node._children, f, g = e ? e.length : 0, h = 0;
      h < g;
      h++
    )
      (f = e[h]), f instanceof cc.Sprite && f._renderCmd.setDirtyRecursively(c);
  };
  c._setBatchNodeForAddChild = function (c) {
    var e = this._node;
    if (e._batchNode) {
  ...
  c.isFrameDisplayed = function (c) {
    ...
    return (
      cc.rectEqualToRect(c.getRect(), e._rect) &&
      c.getTexture().getName() === e._texture.getName() &&
      cc.pointEqualToPoint(c.getOffset(), e._unflippedOffsetPositionFromCenter)
    );
  };
  ...
  c._setTextureCoords = function (c, e) {
    ...
    var f = this._node,
      g = f._batchNode ? f.textureAtlas.texture : f._texture,
      h = this._vertices;
    if (g) {
      var k = g.pixelsWidth,
        m = g.pixelsHeight,
      ...
      f._rectRotated
        ? (cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL
            ...
            : ((g = c.x / k),
              ...
              (n = c.y / m),
              (m = (c.y + c.width) / m)),
          f._flippedX && ((p = n), (n = m), (m = p)),
          f._flippedY && ((p = g), (g = k), (k = p)),
          (h[0].u = k),
          (h[0].v = n),
          (h[1].u = g),
          (h[1].v = n),
        ...
        : (cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL
            ? ((g = (2 * c.x + 1) / (2 * k)),
              (k = g + (2 * c.width - 2) / (2 * k)),
              (n = (2 * c.y + 1) / (2 * m)),
              (m = n + (2 * c.height - 2) / (2 * m)))
            : ((g = c.x / k),
              (k = (c.x + c.width) / k),
              (n = c.y / m),
              (m = (c.y + c.height) / m)),
          f._flippedX && ((p = g), (g = k), (k = p)),
          f._flippedY && ((p = n), (n = m), (m = p)),
          (h[0].u = g),
          (h[0].v = n),
          (h[1].u = g),
          (h[1].v = m),
  ...
  c._updateBlendFunc = function () {
    if (this._batchNode) cc.log(cc._LogInfos.Sprite__updateBlendFunc);
      ...
      var c = this._node,
        e = c._blendFunc;
      c._texture && c._texture.hasPremultipliedAlpha()
        ? (e.src === cc.SRC_ALPHA && e.dst === cc.BLEND_DST && (e.src = cc.ONE),
          (c.opacityModifyRGB = !0))
        : (e.src === cc.ONE && e.dst === cc.BLEND_DST && (e.src = cc.SRC_ALPHA),
          (c.opacityModifyRGB = !1));
    }
  };
  c._setTexture = function (c) {
    var e = this._node;
    e._batchNode
      ? e._batchNode.texture !== c && cc.log(cc._LogInfos.Sprite_setTexture)
      : e._texture !== c &&
        ((e._textureLoaded = c ? c._textureLoaded : !1),
        (e._texture = c),
        this._updateBlendFunc(),
  ...
  c._checkTextureBoundary = function (c, e, f) {
    c &&
      c.url &&
      (f
        ? ((f = e.x + e.height), (e = e.y + e.width))
        : ((f = e.x + e.width), (e = e.y + e.height)),
      f > c.width && cc.error(cc._LogInfos.RectWidth, c.url),
      e > c.height && cc.error(cc._LogInfos.RectHeight, c.url));
  };
  c.transform = function (c, e) {
    this.originTransform(c, e);
    var f = this._node,
      g = f._offsetPosition.x,
      h = g + f._rect.width,
      k = f._offsetPosition.y,
      f = k + f._rect.height,
...
cc.SpriteBatchNode = cc.Node.extend({
  ...
  ctor: function (c) {
    ...
    var d;
    cc.isString(c)
      ? (d = cc.textureCache.getTextureForKey(c)) ||
        (d = cc.textureCache.addImage(c))
      : c instanceof cc.Texture2D && (d = c);
  ...
  highestAtlasIndexInChild: function (c) {
    var d = c.children;
    return d && 0 !== d.length
      ? this.highestAtlasIndexInChild(d[d.length - 1])
      : c.zIndex;
  },
  lowestAtlasIndexInChild: function (c) {
    var d = c.children;
    return d && 0 !== d.length
      ? this.lowestAtlasIndexInChild(d[d.length - 1])
      : c.zIndex;
  },
  ...
  updateQuadFromSprite: function (c, d) {
    cc.assert(c, cc._LogInfos.CCSpriteBatchNode_updateQuadFromSprite_2);
    c instanceof cc.Sprite
      ? ((c.dirty = !0), c._renderCmd.transform(this._renderCmd, !0))
  ...
  addChild: function (c, d, e) {
    ...
    this._isValidChild(c) &&
      ((d = void 0 === d ? c.zIndex : d),
      (e = void 0 === e ? c.tag : e),
      cc.Node.prototype.addChild.call(this, c, d, e),
      this._renderCmd._shaderProgram &&
        (c.shaderProgram = this._renderCmd._shaderProgram));
  },
  _isValidChild: function (c) {
    return c instanceof cc.Sprite
      ? c.texture !== this._texture
...
cc.AnimationFrame = cc.Class.extend({
  ...
  initWithSpriteFrame: function (c, d, e) {
    this._spriteFrame = c;
...
cc.Animation = cc.Class.extend({
  ...
  ctor: function (c, d, e) {
    this._frames = [];
    if (void 0 === c) this.initWithSpriteFrames(null, 0);
    else {
      var f = c[0];
      f &&
        (f instanceof cc.SpriteFrame
          ? this.initWithSpriteFrames(c, d, e)
          : f instanceof cc.AnimationFrame &&
            this.initWithAnimationFrames(c, d, e));
    }
  },
  getFrames: function () {
    return this._frames;
  ...
  addSpriteFrame: function (c) {
    ...
    d.initWithSpriteFrame(c, 1, null);
    this._frames.push(d);
  ...
  _copyFrames: function () {
    for (var c = [], d = 0; d < this._frames.length; d++)
      c.push(this._frames[d].clone());
    return c;
  },
  copy: function (c) {
...
cc.animationCache = {
  ...
  _addAnimationsWithDictionary: function (c, d) {
    ...
    if (e) {
      ...
      if (g)
        for (
          var f = null != g.format ? parseInt(g.format) : f,
            g = g.spritesheets,
            h = cc.spriteFrameCache,
            k = cc.path,
            m = 0;
          m < g.length;
          m++
        )
          h.addSpriteFrames(k.changeBasename(d, g[m]));
      switch (f) {
        case 1:
  ...
  _parseVersion1: function (c) {
    ...
    for (e in c) {
      ...
      if (g) {
        ...
        0 === h.length
          ? cc.log(cc._LogInfos.animationCache__parseVersion1_3, e)
          : (h.length !== g.length &&
              cc.log(cc._LogInfos.animationCache__parseVersion1_4, e),
            (h = new cc.Animation(h, f, 1)),
            cc.animationCache.addAnimation(h, e));
  ...
  _parseVersion2: function (c) {
    ...
    for (e in c) {
      var f = c[e],
        g = f.loop,
        h = parseInt(f.loops),
        g = g ? cc.REPEAT_FOREVER : isNaN(h) ? 1 : h,
      ...
      if (k) {
        ...
        k = new cc.Animation();
        k.initWithAnimationFrames(m, f, g);
...
cc.SpriteFrame = cc.Class.extend({
  ...
  ctor: function (c, d, e, f, g) {
    ...
    void 0 !== c &&
      void 0 !== d &&
      (void 0 === e || void 0 === f || void 0 === g
        ? this.initWithTexture(c, d)
        : this.initWithTexture(c, d, e, f, g));
  },
  textureLoaded: function () {
    return this._textureLoaded;
  },
  ...
  getTexture: function () {
    ...
    if ("" !== this._textureFilename) {
      var c = cc.textureCache.addImage(this._textureFilename);
          ...
          function (c) {
            ...
            if (
              ...
              var d = c.getHtmlElementObj(),
                d = cc.Sprite.CanvasRenderCmd._cutRotateImageToCanvas(
                  d,
                  this.getRect()
                ),
                g = new cc.Texture2D();
            ...
            0 === d.width &&
              ...
              (this._originalSize.width = d),
              (this._originalSize.height = c));
            this.dispatchEvent("load");
          },
          this
        );
  ...
  initWithTexture: function (c, d, e, f, g) {
    2 === arguments.length && (d = cc.rectPointsToPixels(d));
    f = f || cc.p(0, 0);
    g = g || d;
    e = e || !1;
    cc.isString(c)
      ? ((this._texture = null), (this._textureFilename = c))
      : c instanceof cc.Texture2D && this.setTexture(c);
    c = this.getTexture();
...
cc.spriteFrameCache = {
  ...
  _rectFromString: function (c) {
    return (c = this._CCNS_REG2.exec(c))
      ? cc.rect(
          parseFloat(c[1]),
          parseFloat(c[2]),
          parseFloat(c[3]),
  ...
  _pointFromString: function (c) {
    return (c = this._CCNS_REG1.exec(c))
      ? cc.p(parseFloat(c[1]), parseFloat(c[2]))
      : cc.p(0, 0);
  },
  _sizeFromString: function (c) {
    return (c = this._CCNS_REG1.exec(c))
      ? cc.size(parseFloat(c[1]), parseFloat(c[2]))
      : cc.size(0, 0);
  },
  ...
  _parseFrameConfig: function (c) {
    ...
    e &&
      ((g = e.format),
      (g = 1 >= g.length ? parseInt(g) : g),
      (f.image = e.textureFileName || e.textureFileName || e.image));
    for (var h in d) {
      var k = d[h];
      if (k) {
        e = {};
        if (0 == g) {
          ...
          (e.rect = this._rectFromString(k.frame)),
            (e.rotated = k.rotated || !1),
            (e.offset = this._pointFromString(k.offset)),
            (e.size = this._sizeFromString(k.sourceSize));
        else if (3 == g) {
          ...
          (m = k.frame),
            (n = k.sourceSize),
            (h = k.filename || h),
            (e.rect = cc.rect(m.x, m.y, m.w, m.h)),
            (e.rotated = k.rotated || !1),
            (e.offset = cc.p(0, 0)),
            (e.size = cc.size(n.w, n.h));
        c[h] = e;
      }
    }
  ...
  _addSpriteFramesByObject: function (c, d, e) {
    ...
    d &&
      d.frames &&
      ((d =
        this._frameConfigCache[c] || this._getFrameConfigByJsonObject(c, d)),
      this._createSpriteFrames(c, d, e));
  },
  _createSpriteFrames: function (c, d, e) {
    ...
    e
      ...
      : ((e = cc.path.changeBasename(c, d.image || ".png")),
        (e = cc.textureCache.addImage(e)));
    ...
    for (var g in f) {
      ...
      if (!k) {
        ...
        cc._renderType === cc.game.RENDER_TYPE_CANVAS &&
          k.isRotated() &&
          k.getTexture().isLoaded() &&
          ((h = k.getTexture().getHtmlElementObj()),
          (h = cc.Sprite.CanvasRenderCmd._cutRotateImageToCanvas(
            h,
            k.getRectInPixels()
          )),
          (m = new cc.Texture2D()),
          ...
          k.setTexture(m),
          (h = k._rect),
          k.setRect(cc.rect(0, 0, h.width, h.height)));
        d[g] = k;
      }
    }
  },
  addSpriteFrames: function (c, d) {
    ...
    e &&
      e.frames &&
      ((e = this._frameConfigCache[c] || this._getFrameConfig(c)),
      this._createSpriteFrames(c, e, d));
  },
  _checkConflict: function (c) {
    c = c.frames;
    for (var d in c)
      this._spriteFrames[d] &&
        cc.log(cc._LogInfos.spriteFrameCache__checkConflict, d);
  },
  ...
  removeSpriteFrameByName: function (c) {
    c &&
      (this._spriteFramesAliases[c] && delete this._spriteFramesAliases[c],
      this._spriteFrames[c] && delete this._spriteFrames[c]);
  },
  removeSpriteFramesFromFile: function (c) {
    var d = this._spriteFrames,
      e = this._spriteFramesAliases;
  ...
  getSpriteFrame: function (c) {
    ...
    if (!d) {
      ...
      e &&
        ((d = this._spriteFrames[e.toString()]) ||
          delete this._spriteFramesAliases[c]);
    }
    return d;
  },
  _clear: function () {
...
cc.configuration = {
  ...
  gatherGPUInfo: function () {
    if (cc._renderType !== cc.game.RENDER_TYPE_CANVAS) {
      ...
      this._GlExtensions = "";
      for (var e = c.getSupportedExtensions(), f = 0; f < e.length; f++)
        this._GlExtensions += e[f] + " ";
      this._maxTextureSize = c.getParameter(c.MAX_TEXTURE_SIZE);
      d["gl.max_texture_size"] = this._maxTextureSize;
      this._maxTextureUnits = c.getParameter(
  ...
  loadConfigFile: function (c) {
    ...
    if ((d = d.data)) for (var e in d) this._valueDict[e] = d[e];
    else cc.log(cc._LogInfos.configuration_loadConfigFile, c);
  },
};
...
cc.Director = cc.Class.extend({
  ...
  calculateDeltaTime: function () {
    ...
    this._nextDeltaTimeZero
      ...
      : (this._deltaTime = (c - this._lastUpdate) / 1e3);
  ...
  convertToUI: function (c) {
    ...
    d = { x: 0, y: 0 };
    e._isRotated
      ? ((d.x = f.left + c.y / e._devicePixelRatio),
        (d.y =
          f.top +
          f.height -
          (e._viewPortRect.width - c.x) / e._devicePixelRatio))
      : ((d.x = f.left + c.x / e._devicePixelRatio),
        (d.y = f.top + f.height - c.y / e._devicePixelRatio));
    return d;
  },
  drawScene: function () {
    var c = cc.renderer;
  ...
  runScene: function (c) {
    ...
    if (this._runningScene) {
      ...
      0 === d
        ? ((this._sendCleanupToScene = !0), (this._scenesStack[d] = c))
        : ((this._sendCleanupToScene = !0), (this._scenesStack[d - 1] = c));
      this._nextScene = c;
...
cc.game.addEventListener(cc.game.EVENT_RENDERER_INITED, function () {
  if (cc._renderType === cc.game.RENDER_TYPE_WEBGL) {
    ...
    cc.eventManager.addCustomListener(
      cc.Director.EVENT_PROJECTION_CHANGED,
      function () {
        for (var c = cc.director._scenesStack, f = 0; f < c.length; f++)
          d(c[f]);
      }
    );
    c.setProjection = function (c) {
      ...
      this.setViewport();
      var g = this._openGLView,
        h = g._viewPortRect.x / g._scaleX,
        k = g._viewPortRect.y / g._scaleY;
      switch (c) {
        case cc.Director.PROJECTION_2D:
          cc.kmGLMatrixMode(cc.KM_GL_PROJECTION);
          cc.kmGLLoadIdentity();
          g = cc.math.Matrix4.createOrthographicProjection(
            0,
            d.width,
            0,
            d.height,
        ...
        case cc.Director.PROJECTION_3D:
          ...
          cc.kmGLMatrixMode(cc.KM_GL_PROJECTION);
          cc.kmGLLoadIdentity();
          n = cc.math.Matrix4.createPerspectiveProjection(
            60,
            d.width / d.height,
            0.1,
            2 * m
    ...
    c.setViewport = function () {
      ...
      if (c) {
        var d = this._winSizeInPoints;
        c.setViewPortInPoints(
          -c._viewPortRect.x / c._scaleX,
          -c._viewPortRect.y / c._scaleY,
          d.width,
          d.height
        );
      }
...
cc.Scheduler = cc.Class.extend({
  ...
  _schedulePerFrame: function (c, d, e, f) {
    var g = this._hashForUpdates[d.__instanceId];
    if (g && g.entry)
      if (g.entry.priority !== e) {
    ...
    0 === e
      ? this._appendIn(this._updates0List, c, d, f)
      : 0 > e
      ? this._priorityIn(this._updatesNegList, c, d, e, f)
      : this._priorityIn(this._updatesPosList, c, d, e, f);
  },
  ...
  _removeUpdateFromHash: function (c) {
    if ((c = this._hashForUpdates[c.target.__instanceId]))
      cc.arrayRemoveObject(c.list, c.entry),
        delete this._hashForUpdates[c.target.__instanceId],
        (c.entry = null),
        (c.target = null);
  },
  _priorityIn: function (c, d, e, f, g) {
    ...
    this._hashForUpdates[e.__instanceId] = new cc.HashUpdateEntry(
      c,
      d,
      e,
      null
  ...
  update: function (c) {
    ...
    for (f = e.length; d < f; d++)
      (g = e[d]), g.paused || g.markedForDeletion || g.callback(c);
    d = 0;
    ...
    for (d = 0; d < f.length; d++) {
      ...
      if (!e.paused)
        for (e.timerIndex = 0; e.timerIndex < e.timers.length; ++e.timerIndex)
          (e.currentTimer = e.timers[e.timerIndex]),
            (e.currentTimerSalvaged = !1),
            e.currentTimer.update(c),
            (e.currentTimer = null);
    ...
    d = 0;
    for (e = this._updatesNegList; d < e.length; )
      (g = e[d]), g.markedForDeletion ? this._removeUpdateFromHash(g) : d++;
    d = 0;
    for (e = this._updates0List; d < e.length; )
      (g = e[d]), g.markedForDeletion ? this._removeUpdateFromHash(g) : d++;
    d = 0;
    for (e = this._updatesPosList; d < e.length; )
      (g = e[d]), g.markedForDeletion ? this._removeUpdateFromHash(g) : d++;
  ...
  schedule: function (c, d, e, f, g, h, k) {
    ...
    if (!1 === m) {
      if (4 === arguments.length || 5 === arguments.length)
        (k = g), (h = f), (g = 0), (f = cc.REPEAT_FOREVER);
    } else
      4 === arguments.length && ((h = f), (f = cc.REPEAT_FOREVER), (g = 0));
    ...
    p
      ? cc.assert(p.paused === h, "")
      : ((p = new cc.HashTimerEntry(null, d, 0, null, null, h, null)),
        this._arrayForTimers.push(p),
        (this._hashForTimers[d.__instanceId] = p));
    var r, s;
    if (null == p.timers) p.timers = [];
    else if (!1 === m)
      for (s = 0; s < p.timers.length; s++) {
        if (((r = p.timers[s]), c === r._callback)) {
          cc.log(
            cc._LogInfos.Scheduler_scheduleCallbackForTarget,
            r.getInterval().toFixed(4),
            e.toFixed(4)
          );
          r._interval = e;
          return;
    ...
    !1 === m
      ? ((r = new cc.TimerTargetCallback()),
        r.initWithCallback(this, c, d, k, e, f, g))
      : ((r = new cc.TimerTargetSelector()),
        r.initWithSelector(this, n, d, e, f, g));
    p.timers.push(r);
  },
  ...
  unschedule: function (c, d) {
    if (d && c) {
      ...
      if (e)
        for (var f = e.timers, g = 0, h = f.length; g < h; g++) {
          var k = f[g];
          if (this._getUnscheduleMark(c, k)) {
            k !== e.currentTimer ||
  ...
  unscheduleUpdate: function (c) {
    null != c &&
      (c = this._hashForUpdates[c.__instanceId]) &&
      (this._updateHashLocked
        ? (c.entry.markedForDeletion = !0)
  ...
  unscheduleAllForTarget: function (c) {
    if (null != c) {
      ...
      d &&
        (-1 < d.timers.indexOf(d.currentTimer) &&
  ...
  unscheduleAllWithMinPriority: function (c) {
    ...
    for (d = f.length - 1; 0 <= d; d--)
      (e = f[d]), this.unscheduleAllForTarget(e.target);
    f = 0;
    if (0 > c)
      for (d = 0; d < this._updatesNegList.length; )
        (f = this._updatesNegList.length),
          (e = this._updatesNegList[d]) &&
            e.priority >= c &&
            this.unscheduleUpdate(e.target),
          f == this._updatesNegList.length && d++;
    if (0 >= c)
      for (d = 0; d < this._updates0List.length; )
        (f = this._updates0List.length),
          (e = this._updates0List[d]) && this.unscheduleUpdate(e.target),
          f == this._updates0List.length && d++;
    for (d = 0; d < this._updatesPosList.length; )
      (f = this._updatesPosList.length),
        (e = this._updatesPosList[d]) &&
          e.priority >= c &&
          this.unscheduleUpdate(e.target),
        f == this._updatesPosList.length && d++;
  },
  isScheduled: function (c, d) {
    ...
    if (!e) return !1;
    if (null != e.timers)
      for (var e = e.timers, f = 0; f < e.length; ++f)
        if (c === e[f].getKey()) return !0;
    return !1;
  },
  ...
  pauseAllTargetsWithMinPriority: function (c) {
    ...
    if (0 > c)
      for (g = 0; g < this._updatesNegList.length; g++)
        (e = this._updatesNegList[g]) &&
          e.priority >= c &&
          ((e.paused = !0), d.push(e.target));
    if (0 >= c)
      for (g = 0; g < this._updates0List.length; g++)
        if ((e = this._updates0List[g])) (e.paused = !0), d.push(e.target);
    for (g = 0; g < this._updatesPosList.length; g++)
      (e = this._updatesPosList[g]) &&
        e.priority >= c &&
        ((e.paused = !0), d.push(e.target));
    return d;
  },
  ...
  scheduleUpdateForTarget: function (c, d, e) {
...
cc.DrawingPrimitiveCanvas = cc.Class.extend({
  ...
  drawPoints: function (c, d, e) {
    if (null != c) {
      ...
      for (var h = 0, k = c.length; h < k; h++)
        d.arc(c[h].x * f, -c[h].y * g, e * f, 0, 2 * Math.PI, !1);
      d.closePath();
      d.fill();
    }
  },
  drawLine: function (c, d) {
    var e = this._renderContext.getContext(),
      f = cc.view.getScaleX(),
      g = cc.view.getScaleY();
    e.beginPath();
  ...
  drawPoly: function (c, d, e, f) {
    ...
    if (null != c) {
      ...
      var g = c[0];
      d = this._renderContext.getContext();
      var h = cc.view.getScaleX(),
        k = cc.view.getScaleY();
      d.beginPath();
      d.moveTo(g.x * h, -g.y * k);
      for (var g = 1, m = c.length; g < m; g++)
        d.lineTo(c[g].x * h, -c[g].y * k);
      e && d.closePath();
      f ? d.fill() : d.stroke();
    }
  },
  ...
  drawQuadBezier: function (c, d, e, f) {
    for (var g = this._cacheArray, h = (g.length = 0), k = 0; k < f; k++) {
      var m = Math.pow(1 - h, 2) * c.x + 2 * (1 - h) * h * d.x + h * h * e.x,
        n = Math.pow(1 - h, 2) * c.y + 2 * (1 - h) * h * d.y + h * h * e.y;
      g.push(cc.p(m, n));
      h += 1 / f;
    }
    g.push(cc.p(e.x, e.y));
  ...
  drawCubicBezier: function (c, d, e, f, g) {
    for (var h = this._cacheArray, k = (h.length = 0), m = 0; m < g; m++) {
      var n =
          Math.pow(1 - k, 3) * c.x +
          3 * Math.pow(1 - k, 2) * k * d.x +
          3 * (1 - k) * k * k * e.x +
          k * k * k * f.x,
        p =
          Math.pow(1 - k, 3) * c.y +
          3 * Math.pow(1 - k, 2) * k * d.y +
          3 * (1 - k) * k * k * e.y +
          k * k * k * f.y;
      h.push(cc.p(n, p));
      k += 1 / g;
  ...
  drawCardinalSpline: function (c, d, e) {
    ...
    f.length = 0;
    for (var g, h, k = 1 / c.length, m = 0; m < e + 1; m++)
      (h = m / e),
        1 === h
          ? ((g = c.length - 1), (h = 1))
          : ((g = 0 | (h / k)), (h = (h - k * g) / k)),
        (g = cc.CardinalSplineAt(
          cc.getControlPointAt(c, g - 1),
          cc.getControlPointAt(c, g - 0),
          cc.getControlPointAt(c, g + 1),
          cc.getControlPointAt(c, g + 2),
          d,
          h
        )),
        f.push(g);
...
cc.DrawingPrimitiveWebGL = cc.Class.extend({
  ...
  _pointsToTypeArray: function (c) {
    for (var d = new Float32Array(2 * c.length), e = 0; e < c.length; e++)
      (d[2 * e] = c[e].x), (d[2 * e + 1] = c[e].y);
    return d;
  },
  drawLine: function (c, d) {
    this.lazy_init();
  ...
  drawPoly: function (c, d, e) {
    ...
    d.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION, 2, d.FLOAT, !1, 0, 0);
    e
      ? d.drawArrays(d.LINE_LOOP, 0, c.length)
      : d.drawArrays(d.LINE_STRIP, 0, c.length);
    d.deleteBuffer(f);
    cc.incrementGLDraws(1);
  },
  drawSolidPoly: function (c, d, e) {
    this.lazy_init();
    e && this.setDrawColor(e.r, e.g, e.b, e.a);
    d = this._renderContext;
    this._shader.use();
    this._shader.setUniformForModelViewAndProjectionMatrixWithMat4();
    d.enableVertexAttribArray(cc.VERTEX_ATTRIB_POSITION);
  ...
  drawCircle: function (c, d, e, f, g) {
    ...
    if ((g = new Float32Array(2 * (f + 2)))) {
      for (var m = 0; m <= f; m++) {
        var n = m * k,
          p = d * Math.cos(n + e) + c.x,
          n = d * Math.sin(n + e) + c.y;
        g[2 * m] = p;
        g[2 * m + 1] = n;
      }
      g[2 * (f + 1)] = c.x;
  ...
  drawQuadBezier: function (c, d, e, f) {
    ...
    for (var g = new Float32Array(2 * (f + 1)), h = 0, k = 0; k < f; k++)
      (g[2 * k] =
        Math.pow(1 - h, 2) * c.x + 2 * (1 - h) * h * d.x + h * h * e.x),
        (g[2 * k + 1] =
          Math.pow(1 - h, 2) * c.y + 2 * (1 - h) * h * d.y + h * h * e.y),
        (h += 1 / f);
    g[2 * f] = e.x;
    g[2 * f + 1] = e.y;
    c = this._renderContext;
  ...
  drawCubicBezier: function (c, d, e, f, g) {
    this.lazy_init();
    for (var h = new Float32Array(2 * (g + 1)), k = 0, m = 0; m < g; m++)
      (h[2 * m] =
        Math.pow(1 - k, 3) * c.x +
        3 * Math.pow(1 - k, 2) * k * d.x +
        3 * (1 - k) * k * k * e.x +
  ...
  drawCardinalSpline: function (c, d, e) {
    this.lazy_init();
    for (
      var f = new Float32Array(2 * (e + 1)), g, h, k = 1 / c.length, m = 0;
      m < e + 1;
      m++
    )
      (h = m / e),
...
cc._tmp.PrototypeLabelTTF = function () {
  ...
  cc.defineGetterSetter(c, "fontName", c.getFontName, c.setFontName);
  ...
  cc.defineGetterSetter(
    c,
    "boundingHeight",
    c._getBoundingHeight,
    c._setBoundingHeight
  );
...
cc.LabelTTF = cc.Sprite.extend({
  ...
  ctor: function (c, d, e, f, g, h) {
    ...
    this._renderCmd._setColorsString();
    this._textureLoaded = !0;
    d && d instanceof cc.FontDefinition
      ? this.initWithStringAndTextDefinition(c, d)
      : cc.LabelTTF.prototype.initWithString.call(this, c, d, e, f, g, h);
  },
  init: function () {
  ...
  enableShadow: function (c, d, e, f) {
    null != c.r && null != c.g && null != c.b && null != c.a
      ? this._enableShadow(c, d, e)
      : this._enableShadowNoneColor(c, d, e, f);
  },
  ...
  _setShadowOffsetX: function (c) {
    !1 === this._shadowEnabled && (this._shadowEnabled = !0);
    this._shadowOffset.x !== c &&
      ((this._shadowOffset.x = c), this._setUpdateTextureDirty());
  },
  ...
  _setShadowOffsetY: function (c) {
    !1 === this._shadowEnabled && (this._shadowEnabled = !0);
    this._shadowOffset._y !== c &&
      ((this._shadowOffset._y = c), this._setUpdateTextureDirty());
  },
  ...
  _setShadowOffset: function (c) {
    !1 === this._shadowEnabled && (this._shadowEnabled = !0);
    if (this._shadowOffset.x !== c.x || this._shadowOffset.y !== c.y)
      (this._shadowOffset.x = c.x),
        (this._shadowOffset.y = c.y),
        this._setUpdateTextureDirty();
  },
  ...
  _setShadowBlur: function (c) {
    !1 === this._shadowEnabled && (this._shadowEnabled = !0);
    this._shadowBlur !== c &&
      ((this._shadowBlur = c), this._setUpdateTextureDirty());
  },
  ...
  enableStroke: function (c, d) {
    ...
    if (e.r !== c.r || e.g !== c.g || e.b !== c.b)
      (e.r = c.r), (e.g = c.g), (e.b = c.b), this._renderCmd._setColorsString();
  ...
  _setLineWidth: function (c) {
    !1 === this._strokeEnabled && (this._strokeEnabled = !0);
    this._strokeSize !== c &&
      ((this._strokeSize = c || 0), this._setUpdateTextureDirty());
  },
  ...
  _updateWithTextDefinition: function (c, d) {
    c.fontDimensions
      ? ((this._dimensions.width = c.boundingWidth),
        (this._dimensions.height = c.boundingHeight))
  ...
  _prepareTextDefinition: function (c) {
    ...
    c
      ? ((d.fontSize = this._fontSize),
        (d.boundingWidth = cc.contentScaleFactor() * this._dimensions.width),
        (d.boundingHeight = cc.contentScaleFactor() * this._dimensions.height))
      : ((d.fontSize = this._fontSize),
        (d.boundingWidth = this._dimensions.width),
        (d.boundingHeight = this._dimensions.height));
    ...
    if (this._strokeEnabled) {
      d.strokeEnabled = !0;
      var e = this._strokeColor;
      d.strokeStyle = cc.color(e.r, e.g, e.b);
      d.lineWidth = this._strokeSize;
    } else d.strokeEnabled = !1;
    this._shadowEnabled
      ? ((d.shadowEnabled = !0),
        (d.shadowBlur = this._shadowBlur),
        (d.shadowOpacity = this._shadowOpacity),
        (d.shadowOffsetX =
          (c ? cc.contentScaleFactor() : 1) * this._shadowOffset.x),
        (d.shadowOffsetY =
          (c ? cc.contentScaleFactor() : 1) * this._shadowOffset.y))
      : (d._shadowEnabled = !1);
  ...
  setScaleY: function (c) {
    this._scaleY = c / cc.view.getDevicePixelRatio();
    this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty);
  },
  setString: function (c) {
    c = String(c);
    this._originalText !== c &&
      ((this._originalText = c + ""),
      this._updateString(),
      this._setUpdateTextureDirty(),
      this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty));
  ...
  setVerticalAlignment: function (c) {
    c !== this._vAlignment &&
      ((this._vAlignment = c), this._setUpdateTextureDirty());
  },
  setDimensions: function (c, d) {
    var e;
    void 0 === d ? ((e = c.width), (d = c.height)) : (e = c);
    if (e !== this._dimensions.width || d !== this._dimensions.height)
      (this._dimensions.width = e),
        (this._dimensions.height = d),
        this._updateString(),
        this._setUpdateTextureDirty();
  },
  ...
  _setFont: function (c) {
    if ((c = cc.LabelTTF._fontStyleRE.exec(c)))
      (this._fontSize = parseInt(c[1])),
        (this._fontName = c[2]),
        this._renderCmd._setFontStyle(
          this._fontName,
          this._fontSize,
...
cc.LabelTTF.__getFontHeightByDiv = function (c, d) {
  var e,
    f = cc.LabelTTF.__labelHeightDiv;
...
(function () {
  ...
  c._setFontStyle = function (c, e, f, g) {
    if (c instanceof cc.FontDefinition)
      (this._fontStyleStr = c._getCanvasFontStr()),
        (this._fontClientHeight = cc.LabelTTF.__getFontHeightByDiv(c));
    else {
  ...
  c._setColorsString = function () {
    var c = this._displayedColor,
      e = this._node,
      f = e._shadowColor || this._displayedColor,
      g = e._strokeColor,
      h = e._textFillColor,
      k = c.r / 255,
      m = c.g / 255,
  ...
  c._updateTTF = function () {
    ...
    if (0 !== f)
      ...
      for (
        ...
        k.push(this._measure(this._strings[g]));
      ...
      0 === f
        ? this._isMultiLine
          ? cc.size(
              ...
              Math.ceil(this._fontClientHeight * e * this._strings.length + h)
            )
          : cc.size(
              Math.ceil(this._measure(c._string) + g),
              Math.ceil(this._fontClientHeight * e + h)
            )
        : 0 === c._dimensions.height
        ? this._isMultiLine
          ? cc.size(
              Math.ceil(f + g),
              Math.ceil(c.getLineHeight() * e * this._strings.length + h)
            )
          : cc.size(Math.ceil(f + g), Math.ceil(c.getLineHeight() * e + h))
        : cc.size(Math.ceil(f + g), Math.ceil(c._dimensions.height * e + h));
    "normal" !== c._getFontStyle() &&
      (f.width = Math.ceil(f.width + 0.3 * c._fontSize));
    0 === this._strings.length
      ? ((this._texRect.width = 1), (this._texRect.height = f.height || 1))
      : ((this._texRect.width = f.width), (this._texRect.height = f.height));
  ...
  c._saveStatus = function () {
    var c = this._node,
      e = cc.view.getDevicePixelRatio(),
      f = c._strokeShadowOffsetX,
      g = c._strokeShadowOffsetY,
      h = c._contentSize.height * e - g,
      k = c._vAlignment,
      m = c._hAlignment,
      n = 0.5 * f,
      g = h + 0.5 * g,
      ...
      r = 0,
      s = [],
      f = c._contentSize.width * e - f,
      c = c.getLineHeight() * e,
      e = (c - this._fontClientHeight * e) / 2,
      p =
  ...
  c.updateStatus = function () {
    ...
    cc.Node.RenderCmd.prototype.updateStatus.call(this);
    this._dirtyFlag & c.transformDirty &&
      (this.transform(this.getParentRenderCmd(), !0),
      (this._dirtyFlag ^=
        this._dirtyFlag & cc.Node._dirtyFlags.transformDirty));
  };
  c._syncStatus = function (c) {
    ...
    cc.Node.RenderCmd.prototype._syncStatus.call(this, c);
    (cc._renderType === cc.game.RENDER_TYPE_WEBGL || f & e.transformDirty) &&
      this.transform(c);
  };
...
(function () {
  ...
  var c = (cc.LabelTTF.CacheCanvasRenderCmd.prototype = Object.create(
  ...
  c.rendering = function (c) {
    ...
    if (g) {
      ...
      if (!(0 >= this._status.length)) {
        ...
        var n = h._offsetPosition.x,
          k = -h._offsetPosition.y - h._rect.height,
        ...
        for (p = 0; p < n; p++)
          h.push(m.OffsetYArray[p] + m.contextTransform.y + k * f);
...
(function () {
  ...
  var c = (cc.LabelTTF.WebGLRenderCmd.prototype = Object.create(
...
cc.ActionManager = cc.Class.extend({
  ...
  addAction: function (c, d, e) {
    ...
    f ||
      ((f = new cc.HashElement()),
      (f.paused = e),
      (f.target = d),
      (this._hashTargets[d.__instanceId] = f),
      this._arrayTargets.push(f));
  ...
  removeAllActionsFromTarget: function (c, d) {
    if (null != c) {
      ...
      e &&
        (-1 === e.actions.indexOf(e.currentAction) ||
          e.currentActionSalvaged ||
          (e.currentActionSalvaged = !0),
        (e.actions.length = 0),
        this._currentTarget !== e || d
  ...
  removeAction: function (c) {
    if (null != c) {
      ...
      if ((d = this._hashTargets[d.__instanceId]))
  ...
  removeActionByTag: function (c, d) {
    ...
    if (e)
      for (var f = e.actions.length, g = 0; g < f; ++g) {
        var h = e.actions[g];
  ...
  getActionByTag: function (c, d) {
    ...
    if (e) {
      if (null != e.actions)
        for (var f = 0; f < e.actions.length; ++f) {
          var g = e.actions[f];
          if (g && g.getTag() === c) return g;
        }
      cc.log(cc._LogInfos.ActionManager_getActionByTag_2, c);
    }
    return null;
  },
  numberOfRunningActionsInTarget: function (c) {
    return (c = this._hashTargets[c.__instanceId])
      ? c.actions
        ? c.actions.length
        : 0
      : 0;
  ...
  resumeTargets: function (c) {
    if (c) for (var d = 0; d < c.length; d++) c[d] && this.resumeTarget(c[d]);
  },
  purgeSharedManager: function () {
    cc.director.getScheduler().unscheduleUpdate(this);
  },
  _removeActionAtIndex: function (c, d) {
    d.actions[c] !== d.currentAction ||
      d.currentActionSalvaged ||
      (d.currentActionSalvaged = !0);
    d.actions.splice(c, 1);
    d.actionIndex >= c && d.actionIndex--;
    0 === d.actions.length &&
      (this._currentTarget === d
        ? (this._currentTargetSalvaged = !0)
        : this._deleteHashElement(d));
  },
  _deleteHashElement: function (c) {
    var d = !1;
    c &&
      (this._hashTargets[c.target.__instanceId] &&
        (delete this._hashTargets[c.target.__instanceId],
        cc.arrayRemoveObject(this._arrayTargets, c),
        (d = !0)),
      (c.actions = null),
      (c.target = null));
    return d;
        ...
        for (
          ...
          if (((e.currentAction = e.actions[e.actionIndex]), e.currentAction)) {
            ...
            e.currentAction.step(
              c * (e.currentAction._speedMethod ? e.currentAction._speed : 1)
            );
            if (e.currentActionSalvaged) e.currentAction = null;
...
cc.profiler = (function () {
  ...
  r.style.width = "45px";
  r.style.height = "60px";
  for (var z = [p, n, m], y = 0; 3 > y; ++y) {
    var C = z[y].style;
    C.color = "rgb(0, 255, 255)";
    C.font = "bold 12px Helvetica, Arial";
    C.lineHeight = "20px";
    C.width = "100%";
    r.appendChild(z[y]);
  }
      ...
      if (h > cc.DIRECTOR_FPS_INTERVAL) {
        ...
        if (A.onFrameRateChange) {
          ...
          if (v >= s) {
            y = x / s;
            for (r = k; 0 < r; r--)
              if (((d = t[r] / s), 0.6 <= d && y >= u[r])) {
                r != w &&
                  ((w = r),
                  A.onFrameRateChange && A.onFrameRateChange(y.toFixed(2)));
                break;
              }
            x = v = _changeCount = 0;
            for (r = k; 0 < r; r--) t[r] = 0;
        ...
        c &&
          ((n.innerText = g.toFixed(3)),
          (m.innerText = f.toFixed(1)),
          (p.innerText = (0 | cc.g_NumberOfDraws).toString()));
      }
    },
    A = {
      ...
      init: function () {
        d ||
          ((k = cc.eventManager.addCustomListener(
...
(function (c) {
  ...
  d.equals = function (d) {
    return (
      this.x < d.x + c.math.EPSILON &&
      this.x > d.x - c.math.EPSILON &&
      this.y < d.y + c.math.EPSILON &&
      this.y > d.y - c.math.EPSILON
    );
  };
})(cc);
(function (c) {
  c.math.Vec3 = c.kmVec3 = function (c, d, g) {
    c && void 0 === d
      ...
      : ((this.x = c || 0), (this.y = d || 0), (this.z = g || 0));
  };
  ...
  d.fill = function (c, d, g) {
    c && void 0 === d
      ? ((this.x = c.x), (this.y = c.y), (this.z = c.z))
      : ((this.x = c), (this.y = d), (this.z = g));
    return this;
  };
  d.length = function () {
    return Math.sqrt(
      c.math.square(this.x) + c.math.square(this.y) + c.math.square(this.z)
    );
  };
  d.lengthSq = function () {
    return (
...
(function (c) {
  ...
  d.fill = function (c, d, g, h) {
    c && void 0 === d
      ? ((this.x = c.x), (this.y = c.y), (this.z = c.z), (this.w = c.w))
      : ((this.x = c), (this.y = d), (this.z = g), (this.w = h));
  };
  d.add = function (c) {
    if (!c) return this;
    this.x += c.x;
  ...
  d.length = function () {
    return Math.sqrt(
      c.math.square(this.x) +
        c.math.square(this.y) +
        c.math.square(this.z) +
        c.math.square(this.w)
    );
  };
  d.lengthSq = function () {
    return (
...
(function (c) {
  ...
  c.math.Ray2.prototype.intersectLineSegment = function (d, f, g) {
    var h = this.start.x,
      ...
      u = f.y,
      t = (u - r) * (m - h) - (s - p) * (n - k);
    if (t > -c.math.EPSILON && t < c.math.EPSILON) return !1;
    r = ((s - p) * (k - r) - (u - r) * (h - p)) / t;
    p = h + r * (m - h);
    r = k + r * (n - k);
    if (
      p < Math.min(d.x, f.x) - c.math.EPSILON ||
      p > Math.max(d.x, f.x) + c.math.EPSILON ||
      r < Math.min(d.y, f.y) - c.math.EPSILON ||
      r > Math.max(d.y, f.y) + c.math.EPSILON ||
      p < Math.min(h, m) - c.math.EPSILON ||
      p > Math.max(h, m) + c.math.EPSILON ||
      r < Math.min(k, n) - c.math.EPSILON ||
      r > Math.max(k, n) + c.math.EPSILON
    )
      return !1;
    g.x = p;
    g.y = r;
  ...
  c.math.Ray2.prototype.intersectTriangle = function (e, f, g, h, k) {
    var m = new c.math.Vec2(),
      n = new c.math.Vec2(),
      p = new c.math.Vec2(),
      r = 1e4,
      s = !1,
      u;
    this.intersectLineSegment(e, f, m) &&
      ((s = !0),
      (u = m.subtract(this.start).length()),
      u < r && ((n.x = m.x), (n.y = m.y), (r = u), d(e, f, p)));
    this.intersectLineSegment(f, g, m) &&
      ((s = !0),
      (u = m.subtract(this.start).length()),
      u < r && ((n.x = m.x), (n.y = m.y), (r = u), d(f, g, p)));
    this.intersectLineSegment(g, e, m) &&
      ((s = !0),
      (u = m.subtract(this.start).length()),
      u < r && ((n.x = m.x), (n.y = m.y), d(g, e, p)));
...
(function (c) {
  ...
  d.determinant = function () {
    var c = this.mat,
      d = c[0] * c[4] * c[8] + c[1] * c[5] * c[6] + c[2] * c[3] * c[7];
  ...
  d.assignFrom = function (d) {
    if (this === d)
      return (
        c.log("cc.math.Matrix3.assign(): current matrix equals matIn"), this
      );
    var e = this.mat;
    d = d.mat;
    e[0] = d[0];
...
(function (c) {
  ...
  c.math.Matrix4._gaussj = function (c, d) {
    ...
    for (p = 3; 0 <= p; p--)
      if (w[p] !== t[p]) for (r = 0; 4 > r; r++) c.swap(r, w[p], r, t[p]);
    return !0;
  };
  var e = new c.math.Matrix4().identity();
  c.kmMat4Inverse = function (d, f) {
    var k = new c.math.Matrix4(f),
      m = new c.math.Matrix4(e);
    if (!1 === c.math.Matrix4._gaussj(k, m)) return null;
    d.assignFrom(k);
    return d;
  };
  d.inverse = function () {
    var d = new c.math.Matrix4(this),
      f = new c.math.Matrix4(e);
  ...
  c.kmMat4Multiply = function (c, d, e) {
    ...
    f[8] = M * e + N * u + O * x + P * B;
    f[9] = M * d + N * t + O * z + P * A;
    f[10] = M * r + N * w + O * y + P * E;
    f[11] = M * s + N * v + O * C + P * n;
    f[12] = Q * e + R * u + S * x + p * B;
    f[13] = Q * d + R * t + S * z + p * A;
    f[14] = Q * r + R * w + S * y + p * E;
    f[15] = Q * s + R * v + S * C + p * n;
    return c;
  };
  d.multiply = function (c) {
    var d = this.mat,
    ...
    d[8] = L * c + M * r + N * w + O * y;
    d[9] = L * f + M * s + N * v + O * C;
    d[10] = L * n + M * u + N * x + O * B;
    d[11] = L * p + M * t + N * z + O * A;
    d[12] = P * c + Q * r + R * w + e * y;
    d[13] = P * f + Q * s + R * v + e * C;
    d[14] = P * n + Q * u + R * x + e * B;
    d[15] = P * p + Q * t + R * z + e * A;
    return this;
  };
  c.getMat4MultiplyValue = function (c, d) {
    ...
    n[0] = e[0] * f[0] + e[4] * f[1] + e[8] * f[2] + e[12] * f[3];
    ...
    n[11] = e[3] * f[8] + e[7] * f[9] + e[11] * f[10] + e[15] * f[11];
  ...
  d.assignFrom = function (d) {
    if (this === d)
      return (
        c.log("cc.mat.Matrix4.assignFrom(): mat4 equals current matrix"), this
      );
    var e = this.mat;
    d = d.mat;
    e[0] = d[0];
  ...
  d.equals = function (d) {
    ...
    var e = this.mat;
    d = d.mat;
    for (var f = c.math.EPSILON, m = 0; 16 > m; m++)
  ...
  c.math.Matrix4.createByRotationTranslation = function (d, e, f) {
  ...
  c.kmMat4Translation = function (c, d, e, f) {
    ...
    c.mat[1] = c.mat[2] = c.mat[3] = c.mat[4] = c.mat[6] = c.mat[7] = c.mat[8] = c.mat[9] = c.mat[11] = 0;
    c.mat[12] = d;
    c.mat[13] = e;
    c.mat[14] = f;
    return c;
  ...
  d.getForwardVec3 = function () {
    var d = this.mat;
    return new c.math.Vec3(d[8], d[9], d[10]).normalize();
  };
...
(function (c) {
  c.math.Plane = function (c, d, g, h) {
    c && void 0 === d
      ? ((this.a = c.a), (this.b = c.b), (this.c = c.c), (this.d = c.d))
      : ((this.a = c || 0),
        (this.b = d || 0),
        (this.c = g || 0),
        (this.d = h || 0));
  ...
  d.normalize = function () {
    var d = new c.math.Vec3(this.a, this.b, this.c),
      f = 1 / d.length();
    d.normalize();
    this.a = d.x;
    this.b = d.y;
  ...
  d.classifyPoint = function (d) {
    ...
    return 0.001 < d
      ? c.math.Plane.POINT_INFRONT_OF_PLANE
      : -0.001 > d
      ? c.math.Plane.POINT_BEHIND_PLANE
      : c.math.Plane.POINT_ON_PLANE;
  };
})(cc);
(function (c) {
  ...
  d.multiply = function (c) {
    ...
    this.y = k * c.y + g * c.w + h * c.x - d * c.z;
  ...
  c.math.Quaternion.rotationMatrix = function (d) {
    ...
    d > c.math.EPSILON
      ? ((d = 2 * Math.sqrt(d)),
        ...
        (d *= 0.25))
      : k[0] > k[5] && k[0] > k[10]
      ? ((d = 2 * Math.sqrt(1 + k[0] - k[5] - k[10])),
        (f = 0.25 * d),
        (g = (k[4] + k[1]) / d),
        (h = (k[2] + k[8]) / d),
        (d = (k[9] - k[6]) / d))
      : k[5] > k[10]
      ? ((d = 2 * Math.sqrt(1 + k[5] - k[0] - k[10])),
        (f = (k[4] + k[1]) / d),
        (g = 0.25 * d),
        (h = (k[9] + k[6]) / d),
        (d = (k[2] - k[8]) / d))
      : ((d = 2 * Math.sqrt(1 + k[10] - k[0] - k[5])),
        (f = (k[2] + k[8]) / d),
        (g = (k[9] + k[6]) / d),
        (h = 0.25 * d),
        (d = (k[4] - k[1]) / d));
  ...
  c.math.Quaternion.rotationYawPitchRoll = function (d, f, g) {
    var h, k, m, n, p;
  ...
  d.slerp = function (d, f) {
    if (this.x === d.x && this.y === d.y && this.z === d.z && this.w === d.w)
      return this;
    var g = this.dot(d),
      h = Math.acos(g),
      k = Math.sqrt(1 - c.math.square(g)),
      g = Math.sin(f * h) / k,
      h = Math.sin((1 - f) * h) / k,
      k = new c.math.Quaternion(d);
    this.scale(h);
    k.scale(g);
    this.add(k);
    return this;
  ...
  d.toAxisAndAngle = function () {
    ...
    (f > -c.math.EPSILON && f < c.math.EPSILON) ||
    (f < 2 * Math.PI + c.math.EPSILON && f > 2 * Math.PI - c.math.EPSILON)
      ? ((d = 0), (g.x = 0), (g.y = 0), (g.z = 1))
      : ((d *= 2),
        (g.x = this.x / f),
        (g.y = this.y / f),
        (g.z = this.z / f),
  ...
  c.math.Quaternion.rotationBetweenVec3 = function (d, f, g) {
    ...
    -0.999999 > m
      ? Math.abs(g.lengthSq()) < c.math.EPSILON
        ? f.rotationAxis(g, Math.PI)
        : ((h = new c.math.Vec3(1, 0, 0)),
          h.cross(d),
          Math.abs(h.lengthSq()) < c.math.EPSILON &&
            (h.fill(0, 1, 0), h.cross(d)),
          h.normalize(),
          f.rotationAxis(h, Math.PI))
      : ((d = Math.sqrt(2 * (1 + m))),
        (g = 1 / d),
        h.cross(k),
        (f.x = h.x * g),
  ...
  d.multiplyVec3 = function (d) {
    var f = this.x,
      ...
      h = this.z,
      k = new c.math.Vec3(d),
      m = new c.math.Vec3(f, g, h),
      f = new c.math.Vec3(f, g, h);
    m.cross(d);
    f.cross(m);
    m.scale(2 * q.w);
    f.scale(2);
...
cc.shaderCache = {
  ...
  loadDefaultShaders: function () {
    ...
    this._programs.ShaderPositionTextureColor = c;
    c = new cc.GLProgram();
    ...
    this._programs[cc.SHADER_SPRITE_POSITION_TEXTURECOLORALPHATEST] = c;
    ...
    this._programs[cc.SHADER_POSITION_UCOLOR] = c;
...
cc.GLProgram = cc.Class.extend({
  ...
  _updateUniformLocation: function (c) {
    if (!c) return !1;
    var d,
      e = this._hashForUniforms[c];
    if (e) {
      d = !1;
      for (var f = arguments.length - 1, g = 0; g < f; ++g)
        arguments[g + 1] !== e[g] && ((e[g] = arguments[g + 1]), (d = !0));
    } else
      (e = [arguments[1], arguments[2], arguments[3], arguments[4]]),
        (this._hashForUniforms[c] = e),
        (d = !0);
    return d;
  },
    ...
    e ||
      (cc.log(
        "cocos2d: ERROR: Failed to compile shader:\n" +
          this._glContext.getShaderSource(c)
      ),
      d === this._glContext.VERTEX_SHADER
  ...
  initWithVertexShaderByteArray: function (c, d) {
    ...
    c &&
      ...
      this._compileShader(this._vertShader, e.VERTEX_SHADER, c) ||
        cc.log("cocos2d: ERROR: Failed to compile vertex shader"));
    d &&
      ((this._fragShader = e.createShader(e.FRAGMENT_SHADER)),
      this._compileShader(this._fragShader, e.FRAGMENT_SHADER, d) ||
  ...
  initWithVertexShaderFilename: function (c, d) {
    ...
    if (!e) throw Error("Please load the resource firset : " + c);
  ...
  getUniformLocationForName: function (c) {
    ...
    return (
      this._uniforms[c] ||
      this._glContext.getUniformLocation(this._programObj, c)
    );
  },
  ...
  setUniformLocationWith2i: function (c, d, e) {
    ...
    "string" === typeof c
      ? this._updateUniformLocation(c, d, e) &&
        ((c = this.getUniformLocationForName(c)), f.uniform2i(c, d, e))
      : f.uniform2i(c, d, e);
  },
  setUniformLocationWith3i: function (c, d, e, f) {
    var g = this._glContext;
    "string" === typeof c
      ? this._updateUniformLocation(c, d, e, f) &&
        ((c = this.getUniformLocationForName(c)), g.uniform3i(c, d, e, f))
      : g.uniform3i(c, d, e, f);
  },
  setUniformLocationWith4i: function (c, d, e, f, g) {
    var h = this._glContext;
    "string" === typeof c
      ? this._updateUniformLocation(c, d, e, f, g) &&
        ((c = this.getUniformLocationForName(c)), h.uniform4i(c, d, e, f, g))
      : h.uniform4i(c, d, e, f, g);
  },
  setUniformLocationWith2iv: function (c, d) {
    var e = "string" === typeof c ? this.getUniformLocationForName(c) : c;
    this._glContext.uniform2iv(e, d);
  },
  ...
  setUniformLocationWith2f: function (c, d, e) {
    ...
    "string" === typeof c
      ? this._updateUniformLocation(c, d, e) &&
        ((c = this.getUniformLocationForName(c)), f.uniform2f(c, d, e))
      : f.uniform2f(c, d, e);
  },
  setUniformLocationWith3f: function (c, d, e, f) {
    ...
    "string" === typeof c
      ? this._updateUniformLocation(c, d, e, f) &&
        ((c = this.getUniformLocationForName(c)), g.uniform3f(c, d, e, f))
      : g.uniform3f(c, d, e, f);
  },
  setUniformLocationWith4f: function (c, d, e, f, g) {
    ...
    "string" === typeof c
      ? this._updateUniformLocation(c, d, e, f, g) &&
        ((c = this.getUniformLocationForName(c)), h.uniform4f(c, d, e, f, g))
      : h.uniform4f(c, d, e, f, g);
  },
  ...
  setUniformsForBuiltins: function () {
    ...
    this._usesTime &&
      ((c = cc.director),
      (c = c.getTotalFrames() * c.getAnimationInterval()),
      this.setUniformLocationWith4f(
  ...
  reset: function () {
    ...
    this._glContext.deleteProgram(this._programObj);
    this._programObj = null;
    for (var c in this._hashForUniforms)
      (this._hashForUniforms[c].length = 0), delete this._hashForUniforms[c];
  },
  getProgram: function () {
...
cc.GLProgram._isHighpSupported = function () {
  if (null == cc.GLProgram._highpSupported) {
    var c = cc._renderContext,
      c = c.getShaderPrecisionFormat(c.FRAGMENT_SHADER, c.HIGH_FLOAT);
...
if (cc.ENABLE_GL_STATE_CACHE) {
  ...
  WebGLRenderingContext.prototype.bindBuffer = function (c, d) {
    return _currBuffers[c] !== d
      ? (this.glBindBuffer(c, d), (_currBuffers[c] = d), !1)
      : !0;
  };
  ...
  WebGLRenderingContext.prototype.enableVertexAttribArray = function (c) {
    c === cc.VERTEX_ATTRIB_FLAG_POSITION
      ? this._vertexAttribPosition ||
        (this.glEnableVertexAttribArray(c), (this._vertexAttribPosition = !0))
      : c === cc.VERTEX_ATTRIB_FLAG_COLOR
      ? this._vertexAttribColor ||
        (this.glEnableVertexAttribArray(c), (this._vertexAttribColor = !0))
      : c === cc.VERTEX_ATTRIB_FLAG_TEX_COORDS
      ? this._vertexAttribTexCoords ||
        (this.glEnableVertexAttribArray(c), (this._vertexAttribTexCoords = !0))
      : this.glEnableVertexAttribArray(c);
  };
  ...
  WebGLRenderingContext.prototype.disableVertexAttribArray = function (c) {
    c === cc.VERTEX_ATTRIB_FLAG_COLOR
      ? this._vertexAttribColor &&
        (this.glDisableVertexAttribArray(c), (this._vertexAttribColor = !1))
      : c === cc.VERTEX_ATTRIB_FLAG_TEX_COORDS
      ? this._vertexAttribTexCoords &&
        (this.glDisableVertexAttribArray(c), (this._vertexAttribTexCoords = !1))
      : 0 !== c && this.glDisableVertexAttribArray(c);
  };
}
cc.glInvalidateStateCache = function () {
  ...
  if (cc.ENABLE_GL_STATE_CACHE) {
    cc._currentShaderProgram = -1;
    for (var c = 0; c < cc.MAX_ACTIVETEXTURE; c++)
      cc._currentBoundTexture[c] = -1;
    cc._blendingSource = -1;
    cc._blendingDest = -1;
    cc._GLServerState = 0;
  }
...
cc.glUseProgram = cc.ENABLE_GL_STATE_CACHE
  ? function (c) {
      c !== cc._currentShaderProgram &&
        ((cc._currentShaderProgram = c), cc._renderContext.useProgram(c));
    }
  : function (c) {
...
cc.setBlending = function (c, d) {
  ...
  c === e.ONE && d === e.ZERO
    ? e.disable(e.BLEND)
    : (e.enable(e.BLEND), cc._renderContext.blendFunc(c, d));
};
cc.glBlendFunc = cc.ENABLE_GL_STATE_CACHE
  ? function (c, d) {
      if (c !== cc._blendingSource || d !== cc._blendingDest)
        (cc._blendingSource = c), (cc._blendingDest = d), cc.setBlending(c, d);
    }
  : cc.setBlending;
cc.glBlendFuncForParticle = function (c, d) {
  if (c !== cc._blendingSource || d !== cc._blendingDest) {
    ...
    c === e.ONE && d === e.ZERO
      ? e.disable(e.BLEND)
      : (e.enable(e.BLEND), e.blendFuncSeparate(e.SRC_ALPHA, d, c, d));
  }
};
cc.glBlendResetToCache = function () {
  ...
  cc.ENABLE_GL_STATE_CACHE
    ...
    : cc.setBlending(c.BLEND_SRC, c.BLEND_DST);
};
...
cc.glBindTexture2DN = cc.ENABLE_GL_STATE_CACHE
  ? function (c, d) {
      if (cc._currentBoundTexture[c] !== d) {
        ...
        d
          ? e.bindTexture(e.TEXTURE_2D, d._webTextureObj)
...
cc.LabelAtlas = cc.AtlasNode.extend({
  ...
  initWithString: function (c, d, e, f, g) {
    ...
    var n = null,
      n = d instanceof cc.Texture2D ? d : cc.textureCache.addImage(d);
    ...
    return this.initWithTexture(n, k, m, h.length)
      ? ((this._mapStartChar = e), (this.string = h), !0)
      : !1;
  },
  setColor: function (c) {
...
(function () {
  ...
  var c = (cc.LabelAtlas.CanvasRenderCmd.prototype = Object.create(
  ...
  c.updateAtlasValues = function () {
    for (
      ...
      var p = e.charCodeAt(m) - c._mapStartChar.charCodeAt(0),
        r = parseInt(p % c._itemsPerRow, 10),
        p = parseInt(p / c._itemsPerRow, 10);
      if (
        !(
          0 > r ||
          0 > p ||
          ((r = cc.rect(r * h, p * k, h, k)),
          (p = g._contentSize),
          0 > r.x ||
            0 > r.y ||
            r.x + r.width > p.width ||
        ...
        s
          ? 32 === p
            ? (s.init(),
              s.setTextureRect(cc.rect(0, 0, 10, 10), !1, cc.size(0, 0)))
            : (s.initWithTexture(g, r), (s.visible = !0))
          : ((s = new cc.Sprite()),
            32 === p
              ? (s.init(),
                s.setTextureRect(cc.rect(0, 0, 10, 10), !1, cc.size(0, 0)))
              : s.initWithTexture(g, r),
            cc.Node.prototype.addChild.call(c, s, 0, m));
  ...
  c.updateContentSize = function (c, e) {
    var f = this._node,
      g = f._contentSize;
    c !== e &&
      c * f._itemWidth === g.width &&
      f._itemHeight === g.height &&
      f.setContentSize(e * f._itemWidth, f._itemHeight);
  };
...
(function () {
  ...
  var c = (cc.LabelAtlas.WebGLRenderCmd.prototype = Object.create(
  ...
  c._updateColor = function () {
    if (this._colorF32Array) {
      ...
      this._node._opacityModifyRGB
        ? ((this._colorF32Array[0] = (c.r * e) / 255),
          (this._colorF32Array[1] = (c.g * e) / 255),
          (this._colorF32Array[2] = (c.b * e) / 255))
        : ((this._colorF32Array[0] = c.r / 255),
          (this._colorF32Array[1] = c.g / 255),
          (this._colorF32Array[2] = c.b / 255));
  ...
  c.updateAtlasValues = function () {
    var c = this._node,
      e = c._string,
      f = e.length,
      g = this._textureAtlas,
      h = g.texture,
      k = h.pixelsWidth,
      h = h.pixelsHeight,
      m = c._itemWidth,
      n = c._itemHeight;
    c._ignoreContentScaleFactor ||
      ((m = c._itemWidth * cc.contentScaleFactor()),
      (n = c._itemHeight * cc.contentScaleFactor()));
    f > g.getCapacity() &&
      cc.log("cc.LabelAtlas._updateAtlasValues(): Invalid String length");
    for (
      var p = g.quads, r = c._itemWidth, s = c._itemHeight, u = 0, t = -1;
      u < f;
      u++
    ) {
      var w = e.charCodeAt(u) - c._mapStartChar.charCodeAt(0),
        v = w % c._itemsPerRow,
        x = 0 | (w / c._itemsPerRow);
      if (!(0 > v || 0 > x || v * r + r > k || x * s + s > h)) {
        t++;
        var z;
        cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL
          ? ((v = (2 * v * m + 1) / (2 * k)),
        ...
        y.vertices.z = 0;
        C.vertices.x = t * r;
        C.vertices.y = c._itemHeight;
        C.vertices.z = 0;
        B.vertices.x = t * r + r;
        B.vertices.y = c._itemHeight;
        B.vertices.z = 0;
      }
    }
    this._updateColor();
    this.updateContentSize(u, t + 1);
    0 < f &&
      ((g.dirty = !0),
      (c = g.totalQuads),
      f > c && g.increaseTotalQuadsWith(f - c));
  };
  c.updateContentSize = function (c, e) {
    var f = this._node,
      g = f._contentSize;
...
cc.LabelBMFont = cc.SpriteBatchNode.extend({
  ...
  initWithString: function (c, d, e, f, g) {
    ...
    if (d) {
      ...
      (this._textureLoaded = h = d.isLoaded()) ||
        d.addEventListener(
          "load",
          function (c) {
            this._textureLoaded = !0;
      ...
      (d = new cc.Texture2D()),
        ...
        d.initWithElement(h),
        (this._textureLoaded = !1);
    return this.initWithTexture(d, c.length)
      ? ((this._alignment = f || cc.TEXT_ALIGNMENT_LEFT),
        (this._imageOffset = g || cc.p(0, 0)),
        (this._width = void 0 === e ? -1 : e),
        (this._realOpacity = 255),
        (this._realColor = cc.color(255, 255, 255, 255)),
  ...
  createFontChars: function () {
    ...
    if (0 !== m) {
      ...
      var t = s * h,
        ...
        v;
      for (n = 0; n < m; n++)
        if (((s = k.charCodeAt(n)), 0 !== s))
          if (10 === s) (e = 0), (h -= p.commonHeight);
          else {
            w = r[(w << 16) | (s & 65535)] || 0;
            v = u[s];
            v ||
              (cc.log("cocos2d: LabelBMFont: character not found " + k[n]),
              (v = {
            ...
            var x = cc.rect(v.rect.x, v.rect.y, v.rect.width, v.rect.height),
              x = cc.rectPixelsToPoints(x);
            x.x += this._imageOffset.x;
            x.y += this._imageOffset.y;
            var z = this.getChildByTag(n);
            z
              ? c._updateCharTexture(z, x, s)
              : ((z = new cc.Sprite()),
                z.initWithTexture(d, x, !1),
                (z._newTextureWhenChangeColor = !0),
                this.addChild(z, 0, n));
            z.opacityModifyRGB = this._opacityModifyRGB;
            c._updateCharColorAndOpacity(z);
            x = cc.p(
              e + v.xOffset + 0.5 * v.rect.width + w,
              h +
                (p.commonHeight - v.yOffset) -
                0.5 * x.height * cc.contentScaleFactor()
            );
            z.setPosition(cc.pointPixelsToPoints(x));
            e += v.xAdvance + w;
            w = s;
            g < e && (g = e);
          }
      f.width =
        v && v.xAdvance < v.rect.width ? g - v.xAdvance + v.rect.width : g;
      f.height = t;
  ...
  _getCharsWidth: function (c, d) {
    if (0 >= d) return 0;
    var e = this.getChildByTag(c),
      f = this.getChildByTag(c + d);
    return this._getLetterPosXLeft(f) - this._getLetterPosXLeft(e);
  },
  _checkWarp: function (c, d, e, f) {
    for (var g = c[d], h = 0, k = 0; k < d; k++) h += c[k].length;
    var h = h + d - f,
      m = this._getCharsWidth(h, c[d].length - 1);
    if (m > e && 1 < g.length) {
      f = ((e / m) * g.length) | 0;
      for (
        var k = g.substr(f),
          n = m - this._getCharsWidth(h + f, k.length - 1),
          p,
          r = 0,
          s = 0;
        n > e && 100 > s++;
      ...
      for (s = 0; n < e && 100 > s++; )
        k &&
          ((r = (p = cc.LabelTTF._wordRex.exec(k)) ? p[0].length : 1), (p = k)),
      ...
      e = g.substr(0, f);
      cc.LabelTTF.wrapInspection &&
        cc.LabelTTF._symbolRex.test(p || k) &&
        ((r = (h = cc.LabelTTF._lastWordRex.exec(e)) ? h[0].length : 0),
        this._lineBreakWithoutSpaces && (r = 0),
        (f -= r),
        (p = g.substr(f)),
        (e = g.substr(0, f)));
      cc.LabelTTF._firsrEnglish.test(p) &&
        (h = cc.LabelTTF._lastEnglish.exec(e)) &&
        e !== h[0] &&
        ((r = h[0].length),
        this._lineBreakWithoutSpaces && (r = 0),
        (f -= r),
  ...
  updateLabel: function () {
    ...
    if (0 < this._width) {
      ...
      for (c = 0; c < f.length; c++)
        (k = f.length),
          this._checkWarp(f, c, this._width * this._scaleX, h),
          k < f.length && h++,
          0 < c && (g += "\n"),
          (g += f[c]);
    ...
    if (this._alignment !== cc.TEXT_ALIGNMENT_LEFT)
      for (f = c = 0, g = this._string.length, h = [], k = 0; k < g; k++)
        if (
          10 === this._string[k].charCodeAt(0) ||
          0 === this._string[k].charCodeAt(0)
        ) {
          d = 0;
          var m = h.length;
          if (0 === m) f++;
          else if (((e = c + m - 1 + f), !(0 > e))) {
            ...
            if (null != n) {
              ...
              if (0 !== n)
                for (d = 0; d < m; d++)
                  (e = c + d + f),
                    0 > e || ((e = this.getChildByTag(e)) && (e.x += n));
              c += m;
              f++;
              h.length = 0;
            }
  ...
  setFntFile: function (c) {
    if (null != c && c !== this._fntFile) {
      ...
      d
        ? ((this._fntFile = c),
          (this._config = d),
          (c = cc.textureCache.addImage(d.atlasName)),
          (this._textureLoaded = d = c.isLoaded())
            ? (this.setTexture(c), this.createFontChars())
            : c.addEventListener(
                "load",
                function (c) {
                  this._textureLoaded = !0;
  ...
  _setAnchorX: function (c) {
    cc.Node.prototype._setAnchorX.call(this, c);
    this.updateLabel();
  },
  _setAnchorY: function (c) {
  ...
  _kerningAmountForFirst: function (c, d) {
    ...
    if (this._configuration.kerningDictionary) {
      var f = this._configuration.kerningDictionary[
        ((c << 16) | (d & 65535)).toString()
      ];
      f && (e = f.amount);
    }
    return e;
  ...
  _utf8_trim_ws: function (c) {
    ...
    if (!(0 >= d) && ((d -= 1), this._isspace_unicode(c[d]))) {
      for (var e = d - 1; 0 <= e; --e)
        if (this._isspace_unicode(c[e])) d = e;
        else break;
    ...
    if (c)
      for (var e = 0, f = c.length; e < f; e++) {
        var g = c[e],
          ...
          k = g.substring(0, h),
          g = g.substring(h + 1);
        g.match(this.INT_EXP)
          ? (g = parseInt(g))
          : '"' === g[0] && (g = g.substring(1, g.length - 1));
        d[k] = g;
      }
    return d;
  },
  parseFnt: function (c, d) {
    var e = {},
      f = this._parseStrToObj(c.match(this.INFO_EXP)[0]).padding.split(",");
    parseInt(f[0]);
    parseInt(f[1]);
    parseInt(f[2]);
    parseInt(f[3]);
    ...
    for (
      var h = c.match(this.CHAR_EXP),
        k = (e.fontDefDictionary = {}),
        f = 0,
        g = h.length;
      f < g;
      f++
    ...
    h = e.kerningDict = {};
    if ((k = c.match(this.KERNING_EXP)))
      for (f = 0, g = k.length; f < g; f++)
        (m = this._parseStrToObj(k[f])),
...
(function () {
  ...
  var c = (cc.LabelBMFont.CanvasRenderCmd.prototype = Object.create(
    cc.Node.CanvasRenderCmd.prototype
  ));
  c.constructor = cc.LabelBMFont.CanvasRenderCmd;
  c._updateCharTexture = function (c, e, f) {
    32 === f
      ? c.setTextureRect(e, !1, cc.size(0, 0))
      : (c.setTextureRect(e, !1), (c.visible = !0));
  };
  c._updateCharColorAndOpacity = function (c) {
    c._displayedColor = this._displayedColor;
    c._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.colorDirty);
    c._displayedOpacity = this._displayedOpacity;
    c._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.opacityDirty);
  };
  c.setTexture = function (c) {
    for (
      var e = this._node, f = e._children, g = this._displayedColor, h = 0;
      h < f.length;
      h++
    ) {
      var k = f[h],
        ...
        n = m._displayedColor;
      if (
        e._texture === m._texture ||
        (n.r === g.r && n.g === g.g && n.b === g.b)
      )
        k.texture = c;
    }
    e._texture = c;
  ...
  c._changeTextureColor = function () {
    var c = this._node,
      ...
      f = e.getContentSize(),
      g = c._texture,
      h = g.getHtmlElementObj(),
      k = this._displayedColor,
      m = cc.rect(0, 0, h.width, h.height);
    e &&
      0 < f.width &&
      h &&
      ((e = g._generateColorTexture(k.r, k.g, k.b, m)), c.setTexture(e));
  };
...
(function () {
  ...
  var c = (cc.LabelBMFont.WebGLRenderCmd.prototype = Object.create(
    cc.Node.WebGLRenderCmd.prototype
  ));
...
cc.DrawNode = cc.Node.extend({
  ...
  setBlendFunc: function (c, d) {
    void 0 === d
      ? ((this._blendFunc.src = c.src), (this._blendFunc.dst = c.dst))
      : ((this._blendFunc.src = c), (this._blendFunc.dst = d));
  },
  setLineWidth: function (c) {
    this._lineWidth = c;
  },
...
cc.game.addEventListener(cc.game.EVENT_RENDERER_INITED, function () {
  cc._renderType === cc.game.RENDER_TYPE_CANVAS
    ? ((cc._DrawNodeElement = function (c, d, e, f, g, h, k, m, n) {
        this.type = c;
        this.verts = d || null;
      ...
      cc.extend(cc.DrawNode.prototype, {
        ...
        ctor: function () {
          ...
          c._blendFunc = this._blendFunc = new cc.BlendFunc(
            cc.SRC_ALPHA,
        ...
        drawCircle: function (c, d, e, f, g, h, k) {
          ...
          for (var m = (2 * Math.PI) / f, n = [], p = 0; p <= f; p++) {
            var r = p * m,
              s = d * Math.cos(r + e) + c.x,
              r = d * Math.sin(r + e) + c.y;
            n.push(cc.p(s, r));
          }
        ...
        drawQuadBezier: function (c, d, e, f, g, h) {
          ...
          for (var k = [], m = 0, n = 0; n < f; n++) {
            var p =
                Math.pow(1 - m, 2) * c.x + 2 * (1 - m) * m * d.x + m * m * e.x,
              r =
                Math.pow(1 - m, 2) * c.y + 2 * (1 - m) * m * d.y + m * m * e.y;
            k.push(cc.p(p, r));
            m += 1 / f;
          }
          k.push(cc.p(e.x, e.y));
        ...
        drawCubicBezier: function (c, d, e, f, g, h, k) {
          ...
          for (var m = [], n = 0, p = 0; p < g; p++) {
            var r =
                Math.pow(1 - n, 3) * c.x +
                3 * Math.pow(1 - n, 2) * n * d.x +
                3 * (1 - n) * n * n * e.x +
                n * n * n * f.x,
              s =
                Math.pow(1 - n, 3) * c.y +
                3 * Math.pow(1 - n, 2) * n * d.y +
                3 * (1 - n) * n * n * e.y +
                n * n * n * f.y;
            m.push(cc.p(r, s));
            n += 1 / g;
        ...
        drawCardinalSpline: function (c, d, e, f, g) {
          ...
          g = g || this.getDrawColor();
          null == g.a && (g.a = 255);
          for (var h = [], k, m, n = 1 / c.length, p = 0; p < e + 1; p++)
            (m = p / e),
              1 === m
                ? ((k = c.length - 1), (m = 1))
                : ((k = 0 | (m / n)), (m = (m - n * k) / n)),
              (k = cc.cardinalSplineAt(
                cc.getControlPointAt(c, k - 1),
                cc.getControlPointAt(c, k - 0),
                cc.getControlPointAt(c, k + 1),
                cc.getControlPointAt(c, k + 2),
                d,
                m
              )),
              h.push(k);
    ...
    : cc._renderType === cc.game.RENDER_TYPE_WEBGL &&
      cc.extend(cc.DrawNode.prototype, {
        ...
        drawRect: function (c, d, e, f, g) {
          ...
          c = [c, cc.p(d.x, c.y), d, cc.p(c.x, d.y)];
          null == e
            ? this._drawSegments(c, f, g, !0)
            : this.drawPoly(c, e, f, g);
        },
        drawCircle: function (c, d, e, f, g, h, k) {
          h = h || this._lineWidth;
          k = k || this.getDrawColor();
          ...
          h *= 0.5;
          p = 0;
          for (c = n.length; p < c - 1; p++)
            this.drawSegment(n[p], n[p + 1], h, k);
        },
        drawQuadBezier: function (c, d, e, f, g, h) {
          g = g || this._lineWidth;
          h = h || this.getDrawColor();
        ...
        drawCardinalSpline: function (c, d, e, f, g) {
          ...
          f *= 0.5;
          c = 0;
          for (d = h.length; c < d - 1; c++)
            this.drawSegment(h[c], h[c + 1], f, g);
        },
        _render: function () {
          var c = cc._renderContext;
        ...
        _ensureCapacity: function (c) {
          ...
          if (d.length + c > this._bufferCapacity) {
            ...
            if (null == d || 0 === d.length)
              ...
              c = [];
              for (
                var f = new ArrayBuffer(e * this._bufferCapacity), g = 0;
                g < d.length;
                g++
              )
                c[g] = new cc.V2F_C4B_T2F_Triangle(
                  d[g].a,
                  d[g].b,
                  d[g].c,
                  f,
        ...
        drawSegment: function (c, d, e, f) {
          ...
          c = cc.v2fperp(d);
          var k = cc.v2fmult(d, e),
            m = cc.v2fmult(c, e);
          e = cc.v2fsub(h, cc.v2fadd(k, m));
          var n = cc.v2fadd(h, cc.v2fsub(k, m)),
            p = cc.v2fsub(h, k),
            h = cc.v2fadd(h, k),
            r = cc.v2fsub(g, k),
            s = cc.v2fadd(g, k),
            u = cc.v2fsub(g, cc.v2fsub(k, m)),
            g = cc.v2fadd(g, cc.v2fadd(k, m)),
          ...
          t.push(
            new cc.V2F_C4B_T2F_Triangle(
              ...
              { vertices: p, colors: f, texCoords: cc.__t(cc.v2fneg(d)) },
              m,
              t.length * k
            )
          );
          t.push(
            new cc.V2F_C4B_T2F_Triangle(
              { vertices: h, colors: f, texCoords: cc.__t(d) },
              { vertices: n, colors: f, texCoords: cc.__t(cc.v2fsub(d, c)) },
              { vertices: p, colors: f, texCoords: cc.__t(cc.v2fneg(d)) },
              m,
              t.length * k
          ...
          t.push(
            new cc.V2F_C4B_T2F_Triangle(
              { vertices: h, colors: f, texCoords: cc.__t(d) },
              { vertices: r, colors: f, texCoords: cc.__t(cc.v2fneg(d)) },
              { vertices: s, colors: f, texCoords: cc.__t(d) },
              m,
              t.length * k
            )
          );
          t.push(
            new cc.V2F_C4B_T2F_Triangle(
              { vertices: u, colors: f, texCoords: cc.__t(cc.v2fsub(c, d)) },
              { vertices: r, colors: f, texCoords: cc.__t(cc.v2fneg(d)) },
              { vertices: s, colors: f, texCoords: cc.__t(d) },
              m,
              t.length * k
        ...
        drawPoly: function (c, d, e, f) {
          if (null == d) this._drawSegments(c, e, f, !0);
          else {
            null == d.a && (d.a = 255);
            null == f.a && (f.a = 255);
            e = null == e ? this._lineWidth : e;
            ...
            var s = cc.V2F_C4B_T2F_Triangle.BYTES_PER_ELEMENT,
              ...
              w = !1 == r ? 0.5 : 0;
            for (h = 0; h < p - 2; h++)
              (k = cc.v2fsub(cc.__v2f(c[0]), cc.v2fmult(g[0].offset, w))),
                (m = cc.v2fsub(
                  cc.__v2f(c[h + 1]),
                  cc.v2fmult(g[h + 1].offset, w)
                )),
                (n = cc.v2fsub(
                  cc.__v2f(c[h + 2]),
                  cc.v2fmult(g[h + 2].offset, w)
                )),
                t.push(
                  new cc.V2F_C4B_T2F_Triangle(
                    { vertices: k, colors: d, texCoords: cc.__t(cc.v2fzero()) },
                    { vertices: m, colors: d, texCoords: cc.__t(cc.v2fzero()) },
                    { vertices: n, colors: d, texCoords: cc.__t(cc.v2fzero()) },
                    u,
                    t.length * s
                  )
                );
            for (h = 0; h < p; h++) {
              ...
              var v = g[h].offset,
                x = g[w].offset,
                w = r
                  ? cc.v2fsub(k, cc.v2fmult(v, e))
                  : cc.v2fsub(k, cc.v2fmult(v, 0.5)),
                z = r
                  ? cc.v2fsub(m, cc.v2fmult(x, e))
                  : cc.v2fsub(m, cc.v2fmult(x, 0.5));
              k = r
                ? cc.v2fadd(k, cc.v2fmult(v, e))
                : cc.v2fadd(k, cc.v2fmult(v, 0.5));
              m = r
                ? cc.v2fadd(m, cc.v2fmult(x, e))
                : cc.v2fadd(m, cc.v2fmult(x, 0.5));
              r
                ? (t.push(
                    new cc.V2F_C4B_T2F_Triangle(
                      {
                      ...
                      { vertices: m, colors: f, texCoords: cc.__t(n) },
                      u,
                      t.length * s
                    )
                  ),
                ...
                : (t.push(
                    new cc.V2F_C4B_T2F_Triangle(
                      ...
                      { vertices: m, colors: d, texCoords: cc.__t(n) },
                      u,
                      t.length * s
                    )
                  ),
          ...
          if (!(0 >= d)) {
            ...
            for (h = 0; h < f; h++) {
              ...
              var t = g[h].n,
                w = g[h].offset,
                v = g[u].offset,
                u = cc.v2fsub(k, cc.v2fmult(w, d)),
                x = cc.v2fsub(m, cc.v2fmult(v, d));
              k = cc.v2fadd(k, cc.v2fmult(w, d));
              m = cc.v2fadd(m, cc.v2fmult(v, d));
              s.push(
                new cc.V2F_C4B_T2F_Triangle(
                  { vertices: u, colors: e, texCoords: cc.__t(cc.v2fneg(t)) },
                  { vertices: x, colors: e, texCoords: cc.__t(cc.v2fneg(t)) },
                  { vertices: m, colors: e, texCoords: cc.__t(t) },
                  r,
                  s.length * n
                )
              );
...
(function () {
  ...
  cc.extend(cc.DrawNode.CanvasRenderCmd.prototype, {
    rendering: function (c, d, e) {
      ...
      if (0 !== f) {
        c.setTransform(this._worldTransform, d, e);
        c.setGlobalAlpha(f);
        this._blendFunc &&
...
(function () {
  ...
  var c = (cc.ClippingNode.CanvasRenderCmd.prototype = Object.create(
    cc.Node.CanvasRenderCmd.prototype
  ));
  ...
  c.setStencil = function (c) {
    if (null != c)
      if (((this._node._stencil = c), c instanceof cc.DrawNode)) {
        if (c._buffer)
          for (var e = 0; e < c._buffer.length; e++)
            (c._buffer[e].isFill = !1), (c._buffer[e].isStroke = !1);
        c._renderCmd.rendering = function (e, g, h) {
          ...
          for (k = 0; k < c._buffer.length; k++) {
            var m = c._buffer[k].verts,
              n = m[0];
            e.moveTo(n.x * g, -n.y * h);
            for (n = m.length - 1; 0 < n; n--)
              e.lineTo(m[n].x * g, -m[n].y * h);
          }
        };
  ...
  c._saveCmdCallback = function (c, e, f) {
    ...
    this._clipElemType
      ? ((e = cc.ClippingNode.CanvasRenderCmd._getSharedCache()),
        ...
        (e.width = f.width),
        (e.height = f.height),
        e.getContext("2d").drawImage(f, 0, 0))
      : (g.save(),
        c.beginPath(),
        g.setTransform(this._worldTransform, e, f),
        this._node.inverted &&
          (c.rect(0, 0, c.canvas.width, -c.canvas.height), c.clip()));
  };
  c._setStencilCompositionOperation = function (c) {
    if (c) {
      var e = this._node;
      c._renderCmd &&
        c._renderCmd._blendFuncStr &&
        (c._renderCmd._blendFuncStr = e.inverted
          ? "destination-out"
          : "destination-in");
      if (c._children) {
        c = c._children;
        for (var e = 0, f = c.length; e < f; e++)
          this._setStencilCompositionOperation(c[e]);
      }
    }
  };
  ...
  c.transform = function (c, e) {
    ...
    var f = this._node;
    f._stencil &&
      f._stencil._renderCmd &&
      f._stencil._renderCmd.transform(this, e);
  };
  c._cangodhelpme = function (c) {
    if (!0 === c || !1 === c)
      cc.ClippingNode.CanvasRenderCmd.prototype._godhelpme = c;
  ...
  c.visit = function (c) {
    ...
    if (e._visible) {
      if ((c = c || this.getParentRenderCmd()))
        this._curLevel = c._curLevel + 1;
      this._clipElemType = !(
        !this._cangodhelpme() && e._stencil instanceof cc.DrawNode
      );
      if (e._stencil && e._stencil.visible) {
        ...
        if (this._clipElemType) e._stencil.visit(this);
        else {
          c = e._children;
          this._cangodhelpme(!0);
          var f = c.length;
          if (0 < f)
            for (e.sortAllChildren(), e = 0; e < f; e++)
              c[e]._renderCmd.visit(this);
...
(function () {
  ...
  var c = (cc.ClippingNode.WebGLRenderCmd.prototype = Object.create(
    cc.Node.WebGLRenderCmd.prototype
  ));
    ...
    if (e._visible)
      if (
        (e._parent &&
          ...
          (this._curLevel = e._parent._renderCmd._curLevel + 1),
        1 > cc.stencilBits)
      )
        this.originVisit(c);
      ...
      else e.inverted && this.originVisit(c);
  };
  c.setStencil = function (c) {
    var e = this._node;
...
cc.Follow = cc.Action.extend({
  ...
  ctor: function (c, d) {
    ...
    c && (d ? this.initWithTarget(c, d) : this.initWithTarget(c));
  },
  clone: function () {
    var c = new cc.Follow(),
      d = this._worldRect,
  ...
  initWithTarget: function (c, d) {
    ...
    this._boundarySet &&
      ((this.leftBoundary = -(d.x + d.width - this._fullScreenSize.x)),
      (this.rightBoundary = -d.x),
      (this.topBoundary = -d.y),
      (this.bottomBoundary = -(d.y + d.height - this._fullScreenSize.y)),
    ...
    this._boundarySet
      ? this._boundaryFullyCovered ||
        this.target.setPosition(
          cc.clampf(c, this.leftBoundary, this.rightBoundary),
          cc.clampf(d, this.bottomBoundary, this.topBoundary)
        )
...
cc.ActionInterval = cc.FiniteTimeAction.extend({
  ...
  _reverseEaseList: function (c) {
    if (this._easeList) {
      c._easeList = [];
      for (var d = 0; d < this._easeList.length; d++)
        c._easeList.push(this._easeList[d].reverse());
    }
  },
  clone: function () {
  ...
  easing: function (c) {
    ...
    for (var d = 0; d < arguments.length; d++)
      this._easeList.push(arguments[d]);
    return this;
  },
...
cc.Sequence = cc.ActionInterval.extend({
  ...
  ctor: function (c) {
    ...
    if (0 <= e) {
      for (var f = d[0], g = 1; g < e; g++)
        d[g] && (f = cc.Sequence._actionOneTwo(f, d[g]));
  ...
  update: function (c) {
    ...
    c < e
      ? ((c = 0 !== e ? c / e : 1),
        0 === d && 1 === g && (f[1].update(0), f[1].stop()))
      : ((d = 1),
        (c = 1 === e ? 1 : (c - e) / (1 - e)),
        -1 === g &&
          (f[0].startWithTarget(this.target), f[0].update(1), f[0].stop()),
        g || (f[0].update(1), f[0].stop()));
    f = f[d];
    (g === d && f.isDone()) ||
      (g !== d && f.startWithTarget(this.target),
      (c *= f._timesForRepeat),
      f.update(1 < c ? c % 1 : c),
      (this._last = d));
  },
  reverse: function () {
    var c = cc.Sequence._actionOneTwo(
...
cc.sequence = function (c) {
  ...
  for (var e, f, g, h; d && 0 < d.length; )
    for (
      f = Array.prototype.shift.call(d),
        h = f._timesForRepeat || 1,
        f._repeatMethod = !1,
        f._timesForRepeat = 1,
        g = 0,
        e || ((e = f), (g = 1)),
      ...
      e = cc.Sequence._actionOneTwo(e, f);
  return e;
};
...
cc.Repeat = cc.ActionInterval.extend({
  ...
  initWithAction: function (c, d) {
    return this.initWithDuration(c._duration * d)
      ? ((this._times = d),
        (this._innerAction = c),
        c instanceof cc.ActionInstant &&
  ...
  clone: function () {
    var c = new cc.Repeat();
    this._cloneDecoration(c);
    c.initWithAction(this._innerAction.clone(), this._times);
    return c;
  },
  startWithTarget: function (c) {
    this._total = 0;
...
cc.RepeatForever = cc.ActionInterval.extend({
  ...
  step: function (c) {
    ...
    d.step(c);
    d.isDone() &&
      (d.startWithTarget(this.target), d.step(d.getElapsed() - d._duration));
  },
  isDone: function () {
    return !1;
  },
...
cc.Spawn = cc.ActionInterval.extend({
  ...
  ctor: function (c) {
    ...
    if (0 <= e) {
      for (var f = d[0], g = 1; g < e; g++)
        d[g] && (f = cc.Spawn._actionOneTwo(f, d[g]));
      this.initWithTwoActions(f, d[e]);
    }
  },
  initWithTwoActions: function (c, d) {
    ...
    var e = !1,
      f = c._duration,
      g = d._duration;
    this.initWithDuration(Math.max(f, g)) &&
      ((this._one = c),
      (this._two = d),
      f > g
        ? (this._two = cc.Sequence._actionOneTwo(d, cc.delayTime(f - g)))
        : f < g &&
          (this._one = cc.Sequence._actionOneTwo(c, cc.delayTime(g - f))),
      (e = !0));
    return e;
  },
  clone: function () {
...
cc.spawn = function (c) {
  ...
  for (var e = d[0], f = 1; f < d.length; f++)
    null != d[f] && (e = cc.Spawn._actionOneTwo(e, d[f]));
  return e;
};
...
cc.RotateTo = cc.ActionInterval.extend({
  ...
  initWithDuration: function (c, d, e) {
    return cc.ActionInterval.prototype.initWithDuration.call(this, c)
      ? ((this._dstAngleX = d || 0),
        (this._dstAngleY = e || this._dstAngleX),
        !0)
      : !1;
  },
  clone: function () {
    ...
    this._cloneDecoration(c);
    c.initWithDuration(this._duration, this._dstAngleX, this._dstAngleY);
    return c;
  },
  startWithTarget: function (c) {
    cc.ActionInterval.prototype.startWithTarget.call(this, c);
  ...
  update: function (c) {
    c = this._computeEaseTime(c);
    this.target &&
      ((this.target.rotationX = this._startAngleX + this._diffAngleX * c),
      (this.target.rotationY = this._startAngleY + this._diffAngleY * c));
  },
});
...
cc.RotateBy = cc.ActionInterval.extend({
  ...
  initWithDuration: function (c, d, e) {
    return cc.ActionInterval.prototype.initWithDuration.call(this, c)
      ? ((this._angleX = d || 0), (this._angleY = e || this._angleX), !0)
      : !1;
  },
  clone: function () {
  ...
  update: function (c) {
    c = this._computeEaseTime(c);
    this.target &&
      ((this.target.rotationX = this._startAngleX + this._angleX * c),
      (this.target.rotationY = this._startAngleY + this._angleY * c));
  },
  reverse: function () {
...
cc.MoveBy = cc.ActionInterval.extend({
  ...
  initWithDuration: function (c, d, e) {
    return cc.ActionInterval.prototype.initWithDuration.call(this, c)
      ? (void 0 !== d.x && ((e = d.y), (d = d.x)),
        (this._positionDelta.x = d),
        (this._positionDelta.y = e),
        !0)
      : !1;
  },
  clone: function () {
...
cc.MoveTo = cc.MoveBy.extend({
  ...
  initWithDuration: function (c, d, e) {
    return cc.MoveBy.prototype.initWithDuration.call(this, c, d, e)
      ? (void 0 !== d.x && ((e = d.y), (d = d.x)),
        (this._endPosition.x = d),
        (this._endPosition.y = e),
        !0)
      : !1;
  },
  clone: function () {
  ...
  startWithTarget: function (c) {
    cc.MoveBy.prototype.startWithTarget.call(this, c);
...
cc.SkewTo = cc.ActionInterval.extend({
  ...
  initWithDuration: function (c, d, e) {
    var f = !1;
    cc.ActionInterval.prototype.initWithDuration.call(this, c) &&
      ((this._endSkewX = d), (this._endSkewY = e), (f = !0));
    return f;
  },
  clone: function () {
    var c = new cc.SkewTo();
  ...
  update: function (c) {
    ...
    this.target.skewY = this._startSkewY + this._deltaY * c;
  },
});
...
cc.SkewBy = cc.SkewTo.extend({
  ...
  initWithDuration: function (c, d, e) {
    var f = !1;
    cc.SkewTo.prototype.initWithDuration.call(this, c, d, e) &&
      ((this._skewX = d), (this._skewY = e), (f = !0));
    return f;
  },
  clone: function () {
    var c = new cc.SkewBy();
...
cc.JumpTo = cc.JumpBy.extend({
  ...
  initWithDuration: function (c, d, e, f, g) {
    return cc.JumpBy.prototype.initWithDuration.call(this, c, d, e, f, g)
      ? (void 0 === g && ((e = d.y), (d = d.x)),
        (this._endPosition.x = d),
        (this._endPosition.y = e),
        !0)
      : !1;
...
cc.bezierAt = function (c, d, e, f, g) {
  return (
    Math.pow(1 - g, 3) * c +
    3 * g * Math.pow(1 - g, 2) * d +
    3 * Math.pow(g, 2) * (1 - g) * e +
    Math.pow(g, 3) * f
  );
};
cc.BezierBy = cc.ActionInterval.extend({
  ...
  update: function (c) {
    ...
    if (this.target) {
      var d = this._config,
        ...
        f = d[1].y,
        g = d[2].y,
        d = cc.bezierAt(0, d[0].x, d[1].x, d[2].x, c);
  ...
  reverse: function () {
    var c = this._config,
      c = [
        cc.pAdd(c[1], cc.pNeg(c[2])),
        cc.pAdd(c[0], cc.pNeg(c[2])),
        cc.pNeg(c[2]),
      ],
      c = new cc.BezierBy(this._duration, c);
    this._cloneDecoration(c);
    this._reverseEaseList(c);
    return c;
  },
...
cc.ScaleTo = cc.ActionInterval.extend({
  ...
  initWithDuration: function (c, d, e) {
    return cc.ActionInterval.prototype.initWithDuration.call(this, c)
      ? ((this._endScaleX = d), (this._endScaleY = null != e ? e : d), !0)
      : !1;
  },
  clone: function () {
    var c = new cc.ScaleTo();
    this._cloneDecoration(c);
    c.initWithDuration(this._duration, this._endScaleX, this._endScaleY);
    return c;
  },
  startWithTarget: function (c) {
    cc.ActionInterval.prototype.startWithTarget.call(this, c);
  ...
  update: function (c) {
    c = this._computeEaseTime(c);
    this.target &&
      ((this.target.scaleX = this._startScaleX + this._deltaX * c),
      (this.target.scaleY = this._startScaleY + this._deltaY * c));
  },
});
...
cc.FadeTo = cc.ActionInterval.extend({
  ...
  update: function (c) {
    c = this._computeEaseTime(c);
    var d = void 0 !== this._fromOpacity ? this._fromOpacity : 255;
...
cc.TintBy = cc.ActionInterval.extend({
  ...
  initWithDuration: function (c, d, e, f) {
    return cc.ActionInterval.prototype.initWithDuration.call(this, c)
      ? ((this._deltaR = d), (this._deltaG = e), (this._deltaB = f), !0)
      : !1;
  },
  clone: function () {
    var c = new cc.TintBy();
  ...
  update: function (c) {
    ...
    this.target.color = cc.color(
      this._fromR + this._deltaR * c,
      this._fromG + this._deltaG * c,
      this._fromB + this._deltaB * c
    );
  },
  reverse: function () {
    var c = new cc.TintBy(
...
cc.ReverseTime = cc.ActionInterval.extend({
  ...
  initWithAction: function (c) {
    ...
    return cc.ActionInterval.prototype.initWithDuration.call(this, c._duration)
      ? ((this._other = c), !0)
      : !1;
  },
  clone: function () {
...
cc.Animate = cc.ActionInterval.extend({
  ...
  initWithAnimation: function (c) {
    ...
    if (this.initWithDuration(d * c.getLoops())) {
      ...
      var e = this._splitTimes,
        f = (e.length = 0),
        g = d / c.getTotalDelayUnits();
      c = c.getFrames();
      cc.arrayVerifyType(c, cc.AnimationFrame);
      for (var h = 0; h < c.length; h++) {
        var k = (f * g) / d,
          f = f + c[h].getDelayUnits();
        e.push(k);
      }
      return !0;
    }
  ...
  startWithTarget: function (c) {
    ...
    this._animation.getRestoreOriginalFrame() &&
      (this._origFrame = c.displayFrame());
    this._executedLoops = this._nextFrame = 0;
  },
  update: function (c) {
    c = this._computeEaseTime(c);
    1 > c &&
      ((c *= this._animation.getLoops()),
      (0 | c) > this._executedLoops &&
        ((this._nextFrame = 0), this._executedLoops++),
      (c %= 1));
    for (
      var d = this._animation.getFrames(),
        e = d.length,
        f = this._splitTimes,
        g = this._nextFrame;
      g < e;
      ...
      if (f[g] <= c)
        (_currFrameIndex = g),
          this.target.setSpriteFrame(d[_currFrameIndex].getSpriteFrame()),
          (this._nextFrame = g + 1);
      else break;
  },
  reverse: function () {
...
cc.TargetedAction = cc.ActionInterval.extend({
  ...
  initWithTarget: function (c, d) {
    return this.initWithDuration(d._duration)
      ? ((this._forcedTarget = c), (this._action = d), !0)
      : !1;
  },
  clone: function () {
...
cc.Place = cc.ActionInstant.extend({
  ...
  ctor: function (c, d) {
    ...
    this._y = this._x = 0;
    void 0 !== c &&
      (void 0 !== c.x && ((d = c.y), (c = c.x)), this.initWithPosition(c, d));
  },
...
cc.ActionEase = cc.ActionInterval.extend({
  ...
  initWithAction: function (c) {
    ...
    return this.initWithDuration(c.getDuration())
      ? ((this._inner = c), !0)
      : !1;
  },
  clone: function () {
...
cc.EaseRateAction = cc.ActionEase.extend({
  ...
  initWithAction: function (c, d) {
    return cc.ActionEase.prototype.initWithAction.call(this, c)
      ? ((this._rate = d), !0)
      : !1;
  },
  clone: function () {
...
cc.EaseInOut = cc.EaseRateAction.extend({
  update: function (c) {
    c *= 2;
    1 > c
      ? this._inner.update(0.5 * Math.pow(c, this._rate))
      : this._inner.update(1 - 0.5 * Math.pow(2 - c, this._rate));
  },
  clone: function () {
...
cc.easeInOut = function (c) {
  return {
    ...
    easing: function (c) {
      c *= 2;
      return 1 > c
        ? 0.5 * Math.pow(c, this._rate)
        : 1 - 0.5 * Math.pow(2 - c, this._rate);
    },
    reverse: function () {
  ...
  update: function (c) {
    ...
    0 === c || 1 === c
      ...
      : ((d = this._period / 4),
        ...
        (d =
          -Math.pow(2, 10 * c) *
          Math.sin(((c - d) * Math.PI * 2) / this._period)));
  ...
  return c && 0.3 !== c
    ? {
        ...
        easing: function (c) {
          ...
          return (
            -Math.pow(2, 10 * c) *
            Math.sin(((c - this._period / 4) * Math.PI * 2) / this._period)
          );
        },
        reverse: function () {
...
cc._easeElasticOutObj = {
  easing: function (c) {
    return 0 === c || 1 === c
      ? c
      : Math.pow(2, -10 * c) * Math.sin(((c - 0.075) * Math.PI * 2) / 0.3) + 1;
  },
  reverse: function () {
    ...
    ? {
        ...
        easing: function (c) {
          return 0 === c || 1 === c
            ...
            : Math.pow(2, -10 * c) *
                Math.sin(
                  ((c - this._period / 4) * Math.PI * 2) / this._period
                ) +
                1;
        },
        reverse: function () {
...
cc.EaseElasticInOut = cc.EaseElastic.extend({
  update: function (c) {
    ...
    if (0 === c || 1 === c) d = c;
      ...
      d =
        0 > c
          ? -0.5 * Math.pow(2, 10 * c) * Math.sin(((c - e) * Math.PI * 2) / d)
          : Math.pow(2, -10 * c) * Math.sin(((c - e) * Math.PI * 2) / d) * 0.5 +
            1;
    }
    this._inner.update(d);
  },
  ...
  return {
    ...
    easing: function (c) {
      ...
      if (0 === c || 1 === c) e = c;
        ...
        e =
          0 > c
            ? -0.5 * Math.pow(2, 10 * c) * Math.sin(((c - f) * Math.PI * 2) / e)
            : Math.pow(2, -10 * c) *
                Math.sin(((c - f) * Math.PI * 2) / e) *
                0.5 +
              1;
      }
      return e;
...
cc.EaseBounceInOut = cc.EaseBounce.extend({
  update: function (c) {
    var d = 0,
      d =
        0.5 > c
          ? 0.5 * (1 - this.bounceTime(1 - 2 * c))
          : 0.5 * this.bounceTime(2 * c - 1) + 0.5;
    this._inner.update(d);
  },
  clone: function () {
...
cc._easeBounceInOutObj = {
  easing: function (c) {
    return (c =
      0.5 > c
        ? 0.5 * (1 - cc._bounceTime(1 - 2 * c))
        : 0.5 * cc._bounceTime(2 * c - 1) + 0.5);
  },
  reverse: function () {
...
cc.EaseBackIn = cc.ActionEase.extend({
  update: function (c) {
    this._inner.update(
      0 === c || 1 === c ? c : c * c * (2.70158 * c - 1.70158)
    );
  },
  reverse: function () {
...
cc.EaseBackInOut = cc.ActionEase.extend({
  update: function (c) {
    c *= 2;
    1 > c
      ? this._inner.update((c * c * (3.5949095 * c - 2.5949095)) / 2)
      : ((c -= 2),
        this._inner.update((c * c * (3.5949095 * c + 2.5949095)) / 2 + 1));
  },
  clone: function () {
...
cc.cardinalSplineAt = function (c, d, e, f, g, h) {
  ...
  k = n * (m - k);
  return cc.p(
    c.x * g + d.x * p + e.x * h + f.x * k,
    c.y * g + d.y * p + e.y * h + f.y * k
  );
};
...
cc.CardinalSplineTo = cc.ActionInterval.extend({
  ...
  initWithDuration: function (c, d, e) {
    ...
    return cc.ActionInterval.prototype.initWithDuration.call(this, c)
      ? (this.setPoints(d), (this._tension = e), !0)
      : !1;
  },
  clone: function () {
  ...
  update: function (c) {
    ...
    d = cc.cardinalSplineAt(
      cc.getControlPointAt(e, d - 1),
      cc.getControlPointAt(e, d - 0),
      cc.getControlPointAt(e, d + 1),
      cc.getControlPointAt(e, d + 2),
      this._tension,
      c
    );
...
cc.CardinalSplineBy = cc.CardinalSplineTo.extend({
  ...
  reverse: function () {
    for (var c = this._points.slice(), d, e = c[0], f = 1; f < c.length; ++f)
      (d = c[f]), (c[f] = cc.pSub(d, e)), (e = d);
...
cc.ActionTween = cc.ActionInterval.extend({
  ...
  initWithDuration: function (c, d, e, f) {
    return cc.ActionInterval.prototype.initWithDuration.call(this, c)
      ? ((this.key = d), (this.to = f), (this.from = e), !0)
      : !1;
  },
  startWithTarget: function (c) {
    if (!c || !c.updateTweenAction)
      throw Error(
  ...
  activate: function () {
    if (this._enabled) {
      var c = this._target,
        d = this._callback;
      if (d)
        if (c && cc.isString(d)) c[d](this);
        else c && cc.isFunction(d) ? d.call(c, this) : d(this);
    }
  },
});
  ...
  ctor: function (c, d, e) {
    ...
    c && 0 < c.length
      ? ((this._fontName = cc._globalFontName),
        ...
        (f = new cc.LabelTTF(c, this._fontName, this._fontSize)))
...
cc.MenuItemSprite = cc.MenuItem.extend({
  ...
  ctor: function (c, d, e, f, g) {
    ...
    if (void 0 !== c) {
      ...
      void 0 !== g
        ? ((h = e), (m = f), (k = g))
        : void 0 !== f && cc.isFunction(f)
        ? ((h = e), (m = f))
        : void 0 !== f && cc.isFunction(e)
        ? ((k = f), (m = e), (h = null))
        : void 0 === e && (h = null);
  ...
  setNormalImage: function (c) {
    this._normalImage !== c &&
      (c &&
        (this.addChild(c, 0, cc.NORMAL_TAG), (c.anchorX = 0), (c.anchorY = 0)),
  ...
  setSelectedImage: function (c) {
    this._selectedImage !== c &&
      (c &&
        (this.addChild(c, 0, cc.SELECTED_TAG),
        (c.anchorX = 0),
        (c.anchorY = 0)),
  ...
  _updateImagesVisibility: function () {
    var c = this._normalImage,
      d = this._selectedImage,
      e = this._disabledImage;
    this._enabled
      ? (c && (c.visible = !0), d && (d.visible = !1), e && (e.visible = !1))
      : e
      ? (c && (c.visible = !1), d && (d.visible = !1), e && (e.visible = !0))
      : (c && (c.visible = !0), d && (d.visible = !1));
  },
});
    ...
    void 0 === c || null === c
      ...
      : ((h = new cc.Sprite(c)),
        ...
        void 0 === f
          ...
          : void 0 === g
          ? ((n = e), (p = f))
          : g && ((m = new cc.Sprite(e)), (n = f), (p = g)),
        cc.MenuItemSprite.prototype.ctor.call(this, h, k, m, n, p));
  },
...
cc.MenuItemToggle = cc.MenuItem.extend({
  ...
  setOpacity: function (c) {
    ...
    if (this.subItems && 0 < this.subItems.length)
      for (var d = 0; d < this.subItems.length; d++)
        this.subItems[d].opacity = c;
    this._color.a = c;
  },
  getColor: function () {
    var c = this._color;
  ...
  setColor: function (c) {
    ...
    d.b = c.b;
    if (this.subItems && 0 < this.subItems.length)
      for (d = 0; d < this.subItems.length; d++) this.subItems[d].setColor(c);
  ...
  initWithItems: function (c) {
    var d = c.length;
    cc.isFunction(c[c.length - 2])
      ? (this.initWithCallback(c[c.length - 2], c[c.length - 1]), (d -= 2))
      : cc.isFunction(c[c.length - 1])
      ? (this.initWithCallback(c[c.length - 1], null), (d -= 1))
      : this.initWithCallback(null, null);
    for (var e = this.subItems, f = (e.length = 0); f < d; f++)
      c[f] && e.push(c[f]);
...
cc.Menu = cc.Layer.extend({
  ...
  alignItemsInColumns: function () {
    ...
    if (p && 0 < p.length)
      for (d = 0, n = p.length; d < n; d++) {
        var t = p[d];
        0 === k && ((k = c[f]), (u = s = r.width / (1 + k)));
        m = t._getHeight();
        g = g >= m || isNaN(m) ? g : m;
        t.setPosition(u - r.width / 2, e - m / 2);
        u += s;
        ++h;
        h >= k && ((e -= g + 5), (g = k = h = 0), ++f);
      }
  ...
  alignItemsInRows: function () {
    ...
    var e = [],
      ...
      t = this._children;
    if (t && 0 < t.length)
      for (d = 0, s = t.length; d < s; d++)
        ((r = t[d]), k >= c.length || !(p = c[k])) ||
          ((u = r.width),
          (m = m >= u || isNaN(u) ? m : u),
          (h += r.height + 5),
          ++n,
          n >= p &&
            (e.push(m), f.push(h), (g += m + 10), (m = n = 0), (h = -5), ++k));
    ...
    if (t && 0 < t.length)
      for (d = 0, s = t.length; d < s; d++)
        (r = t[d]),
          ...
          (u = r._getWidth()),
          (m = m >= u || isNaN(u) ? m : u),
          r.setPosition(g + e[k] / 2, w - h.height / 2),
          (w -= r.height + 10),
          ++n,
          n >= p && ((g += m + 5), (m = p = n = 0), ++k);
  },
  removeChild: function (c, d) {
    null != c &&
      (c instanceof cc.MenuItem
        ? (this._selectedItem === c && (this._selectedItem = null),
          cc.Node.prototype.removeChild.call(this, c, d))
        : cc.log(
  ...
  _onTouchCancelled: function (c, d) {
    ...
    e._state !== cc.MENU_STATE_TRACKING_TOUCH
      ...
      : (e._selectedItem &&
          (e._selectedItem.unselected(), e._selectedItem.setNodeDirty()),
        (e._state = cc.MENU_STATE_WAITING));
  },
  _onTouchMoved: function (c, d) {
    var e = d.getCurrentTarget();
    if (e._state !== cc.MENU_STATE_TRACKING_TOUCH)
      ...
      f !== e._selectedItem &&
        ...
        (e._selectedItem = f),
        e._selectedItem &&
          (e._selectedItem.selected(), e._selectedItem.setNodeDirty()));
    }
  },
  onExit: function () {
  ...
  _itemForTouch: function (c) {
    ...
    if (d && 0 < d.length)
      for (var f = d.length - 1; 0 <= f; f--)
        if (((e = d[f]), e.isVisible() && e.isEnabled())) {
...
(function () {
  ...
  c.browserType === c.BROWSER_TYPE_FIREFOX &&
    ((d.DELAY_CREATE_CTX = !0), (d.USE_LOADER_EVENT = "canplay"));
  c.os === c.OS_ANDROID &&
    c.browserType === c.BROWSER_TYPE_UC &&
    (d.ONE_SOURCE = !0);
    ...
    if ("AUDIO" === this._AUDIO_TYPE) {
      for (
        var d = document.createElement("audio"),
          e = d.getElementsByTagName("source"),
          f = 0;
        f < e.length;
        f++
      )
...
cc.Audio.touchStart = function () {
  for (var c = cc.Audio.touchPlayList, d = null; (d = c.pop()); )
    (d.audio.loop = !!d.loop), d.audio.play(d.offset);
};
    ...
    if (0 === this.context.currentTime) {
      ...
      this._currextTimer = setTimeout(function () {
        0 === f.context.currentTime &&
          cc.Audio.touchPlayList.push({ offset: c, audio: f });
      }, 10);
    }
  },
  pause: function () {
...
(function (c) {
  ...
  (function () {
    ...
    if (c.canPlayType) {
      ...
      (d = c.canPlayType('audio/wav; codecs\x3d"1"')) &&
        "" !== d &&
        f.push(".wav");
  ...
  try {
    if (d) {
      var g = new (window.AudioContext ||
        window.webkitAudioContext ||
        window.mozAudioContext)();
      cc.Audio._context = g;
      c.DELAY_CREATE_CTX &&
        setTimeout(function () {
          g = new (window.AudioContext ||
            window.webkitAudioContext ||
            window.mozAudioContext)();
          cc.Audio._context = g;
        }, 0);
  ...
  var k = {
    ...
    loadAudioFromExtList: function (e, g, h, k) {
      ...
      if (d && this.useWebAudio)
        this.loadBuffer(e, function (c, d) {
          c && cc.log(c);
          d && h.setBuffer(d);
          k(null, h);
        });
        ...
        for (
          ...
          v.src = cc.path.changeExtname(e, g[w]);
          t.appendChild(v);
        }
        h.setElement(t);
        var x = setTimeout(function () {
          ...
          z = function () {
            t.removeEventListener("canplaythrough", z, !1);
            t.removeEventListener("error", y, !1);
            t.removeEventListener("emptied", z, !1);
            c.USE_LOADER_EVENT &&
              t.removeEventListener(c.USE_LOADER_EVENT, z, !1);
            clearTimeout(x);
            k(null, h);
          },
          y = function () {
        ...
        t.addEventListener("canplaythrough", z, !1);
        t.addEventListener("error", y, !1);
        c.USE_LOADER_EVENT && t.addEventListener(c.USE_LOADER_EVENT, z, !1);
      }
    },
  };
  ...
  cc.audioEngine = {
    ...
    _effectVolume: 1,
    playEffect: function (c, f) {
      if (e && this._currMusic && this._currMusic.getPlaying())
      ...
      !d &&
        h > this._maxAudioInstance &&
        ((h = g.shift()), h.stop(), g.push(h), (h = g.length - 1));
      var s;
      if (g[h])
        return (
          (s = g[h]), s.setVolume(this._effectVolume), s.play(0, f || !1), s
        );
      (s = cc.loader.getRes(c)) &&
        d &&
        "AUDIO" === s._AUDIO_TYPE &&
        (cc.loader.release(c), (s = null));
      if (s)
        if (d && "AUDIO" === s._AUDIO_TYPE)
          k.loadBuffer(c, function (c, d) {
            s.setBuffer(d);
    ...
    setEffectsVolume: function (c) {
      ...
      var d = this._audioPool,
        e;
      for (e in d) {
        var f = d[e];
        if (Array.isArray(f))
          for (var g = 0; g < f.length; g++) f[g].setVolume(c);
      }
    },
    ...
    pauseAllEffects: function () {
      var c = this._audioPool,
        d;
      for (d in c)
        for (var e = c[d], f = 0; f < c[d].length; f++)
          e[f].getPlaying() && e[f].pause();
    },
    ...
    resumeAllEffects: function () {
      var c = this._audioPool,
        d;
      for (d in c)
        for (var e = c[d], f = 0; f < c[d].length; f++) e[f].resume();
    },
    ...
    _pausePlaying: function () {
      ...
      for (d in c)
        for (var e = c[d], f = 0; f < c[d].length; f++)
          e[f].getPlaying() && (e[f].pause(), this._pauseCache.push(e[f]));
    },
...
var res = {
    ...
    hammer_png: "res/game/hammer.png",
    sign_png: "res/game/sign.png",
    diglett1_png: "res/game/diglett1.png",
    diglett2_png: "res/game/diglett2.png",
    pit1_png: "res/game/pit1.png",
    pit2_png: "res/game/pit2.png",
    cloud_png: "res/game/cloud.png",
    grass_png: "res/game/grass.png",
    df_png: "res/game/df.png",
    sj_png: "res/game/sj.png",
    share_png: "res/share.png",
  },
  music = {
    fail_mp3: "res/music/fail.mp3",
    fail_ogg: "res/music/fail.ogg",
    hit_mp3: "res/music/hit.mp3",
    hit_ogg: "res/music/hit.ogg",
  },
  comRes = {},
  g_resources = [],
  a;
...
var PopLayer = cc.Layer.extend({
  ...
  isTouchInside: function (c, d) {
    ...
    var e = d.getLocation(),
      e = c.getParent().convertToNodeSpace(e);
  ...
  hide: function () {
    ...
    this.getParent() &&
      (this.removeAllChildrenWithCleanup(!0), this.removeFromParent(!0));
  },
});
var UIManager = {
    downLayer: null,
...
UIName.EndLayerOther = "EndLayerOther";
UIName.LinkLayer = "LinkLayer";
UIName.AdLayer = "AdLayer";
UIName.overLayer = "overLayer";
UIName.EndTradLayer = "EndTradLayer";
var UIToolManager = {
  ...
  getLabelTTF2: function (c, d, e, f, g, h, k) {
    c = new cc.LabelTTF("" + c, "Arial", d);
    c.setAnchorPoint(e, f);
    c.setPosition(g, h);
    null != k && c.setFontFillColor(k);
    return c;
  },
  getAnimation: function (c, d, e, f, g) {
    for (var h = new cc.Animation(); d <= e; d++)
      h.addSpriteFrameWithFile(res[f + d + "_png"]);
    h.setDelayPerUnit(g);
    h.setRestoreOriginalFrame(!0);
    new cc.Animate(h);
    e = cc.animate(h);
    c.runAction(cc.repeatForever(e));
  },
  getSceneScaleNum: function () {
    var c = cc.director.getWinSize().height / 1280,
      d = 0,
      e = 0;
    0.76 <= c
      ? ((d = 1), (e = 0))
...
var HttpManager = cc.Class.extend({
  ...
  sendOne: function () {
    if (0 != this.cacheList.length) {
      ...
      var c = this.returnLanguage(),
        d = 1,
        e = document.URL,
        e = e.substring(e.lastIndexOf("/game/") + 1, e.length).split("/");
      2 <= e.length && (d = e[1]);
      c =
        "send\x3d" +
        JSON.stringify({
    ...
    if (
      ...
      if (this.req.responseText) {
        ...
        this.perform.target
          ...
          : this.perform.func(c);
      } else this.perform.func("zhongguo0"), MainManager.setData();
  },
  ...
  clearAll: function () {
    for (var c = this.cacheList.length, d = 0; d < c; d++) {
...
var LocalManager = {
  ...
  setSubmitLoad: function (c) {
    cc.sys.localStorage.setItem(1e3, c);
  },
  getSubmitLoad: function () {
    return cc.sys.localStorage.getItem(1e3);
  },
  clearData: function () {
  ...
  judgeSceneNum: function () {
    if (1 == this.getLocalStorage("dmo")) return 1;
    this.setLocalStorage("dmo", 1);
    return -1;
  },
...
var MainManager = {
    ...
    init: function () {
      ...
      cc.sys.language == cc.sys.LANGUAGE_CHINESE
        ? "zh-TW" == window.navigator.language
          ? (cc.log("\u7e41\u4f53"), (this.curType = 110))
          : (cc.log("\u7b80\u4f53"), (this.curType = 1))
        : cc.sys.language == cc.sys.LANGUAGE_ENGLISH
        ? (cc.log("\u82f1\u6587"), (this.curType = 2))
        : cc.sys.language == cc.sys.LANGUAGE_KOREAN
        ? (cc.log("\u97e9\u6587"), (this.curType = 101))
        : cc.sys.language == cc.sys.LANGUAGE_JAPANESE
        ? (cc.log("\u65e5\u6587"), (this.curType = 102))
        : "th" == cc.sys.language
        ? (cc.log("tanwen"), (this.curType = 109))
        : (cc.log("english"), (this.curType = 2), (this.otherEndBool = !0));
      this.getLinkGame();
    },
    getLinkGame: function () {
      HttpManager.instance.send("101", null, this.getLinkGameReturn, this);
    },
    getLinkGameReturn: function (c, d, e, f) {
      var g = !1;
      0 == c
        ? ((this.ranLinkData = d),
        ...
        : (cc.log("\u83b7\u53d6\u5931\u8d25"),
          (g = !0),
          cc.director.runScene(new LoadScene(1)));
      !1 == g &&
        (cc.log("OK\u83b7\u53d6"),
        this.setData(),
        cc.director.runScene(new LoadScene(1)));
    ...
    ranRecGameData: function () {
      if (null != this.recGameData && "" != this.recGameData) {
        this.returnBool = !1;
        var c = MainManager.randomInt(1, this.recGameData.length) - 1;
        cc.log("ranNNN", c);
        this.recGameUrl = this.recGameData[c].data_link;
        this.recGameDelPer = this.recGameData[c].delay_per;
        this.recGameDelPau = this.recGameData[c].delay_pau;
        this.recGameimg1 = this.recGameData[c].img_1;
        this.recGameimg2 = this.recGameData[c].img_2;
        this.recGamePos = this.recGameData[c].poistion;
      }
    },
    ranLinkUrl: function () {
      if (null != this.ranLinkData.gameList) {
        var c = this.randomInt(1, this.ranLinkData.gameList.length) - 1;
        cc.log("templ", c, this.ranLinkData.gameList);
        cc.log(
          "url",
    ...
    returnData: function () {},
    setData: function () {
      cc.log("setDate", this.InfoData);
      this.URL_moreGame = languageType.getTypeData(this.curType, 2);
      this.id_facebookShare = languageType.getTypeData(this.curType, 3);
      cc.log(
        "\u6b22\u8fce\u5149\u4e34\uff1a" +
          languageType.getTypeData(this.curType, 5)
      );
      cc.log("cc", cc.sys.language);
      cc.log("this.type111", this.curType);
      switch (cc.sys.language) {
        case languageType.getTypeData(1, 0):
          this.type =
            110 == this.curType ? 110 : languageType.getTypeData(1, 1);
          break;
        case languageType.getTypeData(this.curType, 0):
          this.type = languageType.getTypeData(this.curType, 1);
          break;
        default:
          this.type = languageType.getTypeData(2, 1);
      }
      this.txtShow = {};
      cc.log("this.type", this.type);
      this.txtShow.data = eval("(language_" + this.type + ")");
      cc.log("this.infoGameName", this.infoGameName);
      null != this.infoGameName && "" != this.infoGameName
        ? ((this.gameName = this.infoGameName),
          (this.gameName1 = "\u300c" + this.infoGameName + "\u300d"),
          (document.title = this.infoGameName))
        : ((this.gameName = this.getText1("game_name1")),
          (this.gameName1 = this.getText1("game_name")),
          (document.title = this.gameName));
      this.txtStart = this.txtShow.data.txtStart;
      this.txtMore = this.txtShow.data.txtMore;
      this.txtAgain = this.txtShow.data.txtAgain;
      null != this.moreGameText &&
        "" != this.moreGameText &&
        null != this.playAgainText &&
        "" != this.playAgainText &&
        ((this.txtMore = this.moreGameText),
        (this.txtAgain = this.playAgainText));
      this.txtShare1 = this.txtShow.data.txtShare1 + " ";
      this.txtShare2 = "," + this.txtShow.data.txtShare2;
      null != this.endShow1 &&
        "" != this.endShow1 &&
        null != this.endShow2 &&
        "" != this.endShow2 &&
        ((this.txtShare1 = this.endShow1 + " "),
        (this.txtShare2 = "," + this.endShow2));
      var c = this.returnIconNum();
      cc.log("icont", c);
      1 == c
        ? (this.gameText1 = this.txtShow.data.gameT11)
        : 2 == c
        ? (this.gameText1 = this.txtShow.data.gameT12)
        : 3 == c
        ? (this.gameText1 = this.txtShow.data.gameT13)
        : 4 == c && (this.gameText1 = this.txtShow.data.gameT1);
      this.gameText2 = this.txtShow.data.gameT2;
      this.gameText3 = this.txtShow.data.gameT3;
      this.txtGameL = this.txtShow.data.gameEndL;
      null != this.endShow0 &&
        "" != this.endShow0 &&
        (this.txtGameL = this.endShow0);
      this.gameU1 = this.txtShow.data.gameUrl1;
      this.gameU2 = this.txtShow.data.gameUrl2;
      cc.log(" this.txtStart", this.txtStart);
    },
    getGameEndShowReturn: function () {},
    gotoEndLayer: function () {
      resEndComplete = adEndComplete = !1;
      this.showGameEndLayer();
    },
    showGameEndLayer: function () {
      1 == this.type
        ? UIManager.show(UIName.EndLayer)
        : 2 == this.type
        ? !1 == this.otherEndBool
          ? UIManager.show(UIName.EndLayerEnglish)
          : UIManager.show(UIName.EndLayerOther)
        : 110 == this.type
        ? UIManager.show(UIName.EndTradLayer)
        : UIManager.show(UIName.EndLayerOther);
    },
    setLastShowAd: function () {
    ...
    getText: function (c) {
      cc.log("df", MainManager.showText);
      return null != MainManager.showText && "" != MainManager.showText
    ...
    getTxtStart: function () {
      return null != this.startText && "" != this.startText
        ? this.startText
        : "Start";
    },
    ...
    getShareTxt: function () {
      var c = MainManager.txtShare1 + GameManager.score + MainManager.txtShare2;
      null != endShowText && "" != endShowText && (c = endShowText.content);
      if (
        "" == this.playAgainText ||
        null == this.playAgainText ||
        "" == this.moreGameText ||
        ...
        c = MainManager.txtShare1 + GameManager.score + MainManager.txtShare2;
      score_share(c);
      return c;
    },
    gamePause: function () {
    ...
    getDist: function (c, d, e, f) {
      return cc.pDistance(cc.p(c, d), cc.p(e, f));
    },
    gotoCover: function (c) {
    ...
    startGame: function () {
      cc.log("startGame");
      cc.director.runScene(new GameScene(gameT));
    },
    returnIconNum: function () {
      var c = 0,
        c = navigator.userAgent.toLowerCase();
      return (c =
        0 < c.indexOf("micromessenger")
          ? 1
          : 0 < c.indexOf("kakaotalk")
          ? 2
          : 0 < c.indexOf("line")
          ? 3
          : 4);
  ...
  setO = 200,
  localUrl = getWebSiteUrl(),
  languageType = {
    type_1: [
      cc.sys.LANGUAGE_CHINESE,
      1,
      localUrl,
      569248776601425,
      "\u4e2d\u6587",
...
var StartLayer = cc.Layer.extend({
  ...
  init: function () {
    ...
    var d = MainManager.getText("game_info"),
      c = MainManager.getTxtStart(),
      d = new cc.LabelTTF(
        d,
        "Arial",
        46,
...
var EndLayer = PopLayer.extend({
  ...
  ctor: function (c) {
    this._super();
    this.setCascadeOpacityEnabled(!1);
    EndLayerSelf = this;
    this.scaleNum = UIToolManager.getSceneScaleNum();
    this.standardScore = GameManager.averageScore;
    this.gameName = MainManager.gameName1;
    null != endShowText
      ? cc.log("\u6e38\u620f\u7ed3\u675f\u4e86", endShowText.content)
      : cc.log("\u6e38\u620f\u7ed30");
    cc.log("\u6e38\u620f\u7ed3");
    c = "#3698C5";
    c = null == MainManager.endLayCol ? "#3698C5" : MainManager.endLayCol;
    c = new cc.LayerColor(cc.color(cc.color(c), setO));
    this.addChild(c);
  ...
  showScore: function (c) {
    this.scoreBG = null;
    var d = UIToolManager.getSprite(
      comRes.score_bg_png,
      0.5,
      0.5,
      CW / 2,
      CH - 175 * this.scaleNum
    );
    d.setScale(0.9 * this.scaleNum);
    this.addChild(d, 20);
    var e = 70,
      e =
        100 >= GameManager.score
          ? 63
          : 1e3 >= GameManager.score
          ? 54
          : 1e4 >= GameManager.score
          ? 45
          : 36;
    c = UIToolManager.getLabelTTF(
      c.toString(),
      e * this.scaleNum,
      0.5,
      0.5,
  ...
  initUI1: function () {
    if (
      ...
      score_share(endShowText.content);
      this.tipLabel0 = new cc.LabelTTF(
        endShowText.content,
        "Arial",
        42 * this.scaleNum,
        cc.TEXT_ALIGNMENT_LEFT
      );
      var c = Math.ceil(this.tipLabel0.width / (600 * this.scaleNum)) + 1;
      this.tipLabel = new cc.LabelTTF(
        ...
        cc.size(
          600 * this.scaleNum,
          42 * c * this.scaleNum + 57 * this.scaleNum
        ),
        cc.TEXT_ALIGNMENT_LEFT
      );
    } else
      (this.tipLabel0 = new cc.LabelTTF(
        this.getContentByScore(GameManager.score, this.gameName),
        "Arial",
        42 * this.scaleNum,
        cc.TEXT_ALIGNMENT_LEFT
      )),
        cc.log(
          "Dfffdffd",
          Math.ceil(this.tipLabel0.width / (600 * this.scaleNum))
        ),
        (c = Math.ceil(this.tipLabel0.width / (600 * this.scaleNum)) + 1),
        (this.tipLabel = new cc.LabelTTF(
          this.getContentByScore(GameManager.score, this.gameName),
          "Arial",
          42 * this.scaleNum,
    ...
    this.tipLabel.x = CW / 2;
    this.tipLabel.y =
      this.scoreBG.y -
      this.scoreBG.getBoundingBox().height / 2 -
      55 * this.scaleNum;
    this.addChild(this.tipLabel);
    c =
      this.scoreBG.y -
      this.scoreBG.getBoundingBox().height -
      55 * this.scaleNum -
      50 * c * this.scaleNum;
    this.btnAgain = this.getTxtButton(
      ...
      MainManager.txtAgain,
      CW / 3 - 40 * this.scaleNum,
      c - 160 * this.scaleNum,
      0.6 * this.scaleNum,
      0.9 * this.scaleNum,
      1
    );
    var d = this.returnFocusNum(),
      e = d[0],
      f = d[1],
      d = d[2],
      g = 0;
    ...
    this.btnGuanzhu = this.getTxtButton(
      this,
      comRes.button1_png,
      this.onFocusClick.bind(this, e, g),
      f,
      (CW / 3) * 2 + 30 * this.scaleNum,
      c - 160 * this.scaleNum,
      0.6 * this.scaleNum,
      0.9 * this.scaleNum,
      d
    ...
    c = "#f9e81e";
    c = null == MainManager.moreBtnBgCol ? "#f9e81e" : MainManager.moreBtnBgCol;
    this.btnMore.setColor(cc.color(c));
    this.btnMore1 = new cc.Sprite(comRes.btn_more3_png);
    this.btnMore1.x = this.btnMore.x;
    this.btnMore1.y = this.btnMore.y;
    this.btnMore1.setScale(this.scaleNum);
    this.addChild(this.btnMore1, 2);
    c = new cc.Menu(this.btnAgain, this.btnGuanzhu, this.btnMore);
    c.setPosition(0, 0);
    this.addChild(c);
  },
  returnFocusNum: function () {
    ...
    0 < d.indexOf("micromessenger")
      ? 1 == MainManager.randomInt(1, 2)
        ? ((d = 1), (e = MainManager.gameText1), (f = 5))
        : ((f = 1), (e = this.gameFocus()), (d = e[0]), (e = e[1]))
      : (0 < d.indexOf("kakaotalk") || d.indexOf("line"),
        (f = 1),
        (e = this.gameFocus()),
        (d = e[0]),
        (e = e[1]));
  ...
  gameFocus: function () {
    var c = [],
      d = MainManager.randomInt(5, 6),
      e = null,
      e = 5 == d ? MainManager.gameText2 : MainManager.gameText3;
    c.push(d);
    c.push(e);
    return c;
  },
  judgeIcon: function (c, d, e) {
    5 > c &&
      ((this.logoSpr = new cc.Sprite(comRes["icon" + c + "_png"])),
      (this.logoSpr.x = d + 100 * this.scaleNum),
      (this.logoSpr.y = e),
      this.logoSpr.setScale(0.6 * this.scaleNum),
      this.addChild(this.logoSpr, 10 * this.scaleNum));
  },
  getTxtButton: function (c, d, e, f, g, h, k, m, n) {
    c = new cc.MenuItemImage(d, d, e);
    c.setPosition(g, h);
    null != f &&
      ((e = d = 0),
      5 == n
        ? ((d = 38 * this.scaleNum), (e = 0))
        : 1 == n
        ? ((d = 38 * this.scaleNum), (e = 0))
        : 10 == n && ((d = 48 * this.scaleNum), (e = 0)),
      (f = UIToolManager.getLabelTTF2("" + f, d, 0.5, 0.5, g + e, h)),
      this.addChild(f, 3),
      10 == n &&
        ((n = "#4f373b"),
        (n =
        ...
        f.setColor(cc.color(n))),
      this._textArr.push(f));
    null != k && null != m && c.setScale(k, m);
    return c;
  },
  onAgainClick: function () {
    this.btnAgain.runAction(
      cc.sequence(
        cc.scaleTo(0.03, 0.51 * this.scaleNum, 0.76 * this.scaleNum),
        cc.scaleTo(0.03, 0.6 * this.scaleNum, 0.9 * this.scaleNum),
        cc.delayTime(0.03),
    ...
    this._textArr[0].runAction(
      cc.sequence(
        cc.scaleTo(0.03, 0.8 * this.scaleNum),
        cc.scaleTo(0.03, 1 * this.scaleNum)
      )
    );
  },
  ...
  onFocusClick: function (c, d) {
    this.btnGuanzhu.runAction(
      cc.sequence(
        cc.scaleTo(0.03, 0.51 * this.scaleNum, 0.76 * this.scaleNum),
        cc.scaleTo(0.03, 0.6 * this.scaleNum, 0.9 * this.scaleNum),
        cc.delayTime(0.03),
        cc.callFunc(this.goToFocus.bind(this, c, d))
      )
    );
    ...
    null != this.logoSpr &&
      this.logoSpr.runAction(
        cc.sequence(
          cc.scaleTo(0.03, 0.48 * this.scaleNum),
          cc.scaleTo(0.03, 0.6 * this.scaleNum)
        )
      );
  },
  goToFocus: function (c, d) {
    1 == c
      ? (window.location.href =
      ...
      : 4 != c &&
        (window.location.href =
          5 == c
            ...
            : 6 == c
            ? MainManager.gameU2
            : MainManager.ranLinkData.gameList[d].gameUrl);
  },
  getContentByScore: function (c, d) {
    // var e = "aaa" + d + "bbb",
    //   f = parseInt(0.3 * this.standardScore),
    //   g = parseInt(1.5 * this.standardScore),
    //   h = parseInt(2.5 * this.standardScore),
    //   k = parseInt(4 * this.standardScore);
    // 0 < c && c <= f
    //   ? (e = "ccc" + d + "ddd" + c + "eee!")
    //   : c > f && c <= this.standardScore
    //   ? (e =
    //       "\u6211\u5728" +
    //       d +
    //       "\u4e2d\u5f97\u4e86" +
    ...
    //       "\u5206\uff0c\u51fb\u8d25\u4e86\u5168\u7403" +
    //       (Math.floor(
    //         (12 * (c - this.standardScore)) / (g - this.standardScore)
    //       ) +
    //         80) +
    //       "%\u7684\u73a9\u5bb6\uff0c\u8fdb\u5165\u4e86\u4fe1\u624b\u62c8\u6765\u7684\u5883\u754c\uff01")
    //   : c > g && c <= h
    ...
    //   : c > k && c < game_max_score
    //   ? ((e = 20 - Math.ceil((17 * (c - k)) / (game_max_score - k))),
    //     (e =
    //       "\u6211\u5728" +
    //       d +
    //       "\u4e2d\u5f97\u4e86" +
  ...
  hide: function () {
    ...
    for (var c = 0; c < this._textArr.length; c++)
      this._textArr.splice(c, 1), c--;
    this._textArr = [];
  },
  onExit: function () {
    this._super();
...
var EndTradLayer = PopLayer.extend({
  standardScore: 0,
  minScore: 0,
  logoSpr: null,
  _textArr: [],
...
var EndLayerEnglish = PopLayer.extend({
  ...
  judgeIcon: function (c, d, e) {
    5 > c &&
      ((this.logoSpr = new cc.Sprite(comRes["icon" + c + "_png"])),
      (this.logoSpr.x = d + 105 * this.scaleNum),
      (this.logoSpr.y = e),
      this.logoSpr.setScale(0.6 * this.scaleNum),
      this.addChild(this.logoSpr, 10));
  },
  getTxtButton: function (c, d, e, f, g, h, k, m, n) {
    d = new cc.MenuItemImage(d, d, e);
    d.setPosition(g, h);
    if (null != f) {
      var p = (e = 0);
      5 == n
        ? ((e = 29 * this.scaleNum), (p = 0))
        : 1 == n
        ? ((e = 29 * this.scaleNum), (p = 0))
        : 10 == n && ((e = 45 * this.scaleNum), (p = 0));
      f = UIToolManager.getLabelTTF2("" + f, e, 0.5, 0.5, g + p, h);
      c.addChild(f, 3);
      10 == n &&
        ((c = "#4f373b"),
        (c =
          null == MainManager.moreBtnTextCol
            ? "#4f373b"
            : MainManager.moreBtnTextCol),
        f.setColor(cc.color(c)));
      this._textArr.push(f);
    }
    null != k && null != m && d.setScale(k, m);
    return d;
  },
  onAgainClick: function () {
    this.btnAgain.runAction(
  ...
  initStage: function (c) {
    ...
    c.setPosition(CW / 2, this.tipLabel.y + (CH - this.tipLabel.y) / 2);
    EndLayerSelf.addChild(c, 10);
  },
  getContentByScore: function (c, d) {
    var e =
        "I'm awesome\uff0cin" +
    ...
    c >= game_max_score
      ...
      : 0 < c && c <= f
      ? (e = "I got " + c + " points in the game, really great\uff01")
      : c > f && c <= this.standardScore
      ? (e = "I got " + c + " points in the game, really great\uff01")
      : c > this.standardScore && c <= g
      ? (e =
...
var EndLayerOther = PopLayer.extend({
  bestScore: 0,
  logoSpr: null,
  _textArr: [],
  ctor: function () {
  ...
  initUI: function () {
    ...
    this.tipLabel = new cc.LabelTTF(
      ...
      "Arial",
      42 * this.scaleNum,
      cc.size(600 * this.scaleNum, 42 * c * this.scaleNum + 57 * this.scaleNum),
      cc.TEXT_ALIGNMENT_LEFT
    );
    this.tipLabel.setAnchorPoint(0.5, 1);
    this.tipLabel.x = CW / 2;
    ...
    this.btnGuanzhu = this.getTxtButton(
      this,
      comRes.button1_png,
      this.onShareClick.bind(this, e, g),
      f,
    ...
    this.btnMore1.setScale(this.scaleNum);
    this.addChild(this.btnMore1, 2);
    c = new cc.Menu(this.btnGuanzhu, this.btnAgain, this.btnMore);
    c.x = 0;
    c.y = 0;
    this.addChild(c);
  },
  ...
  getTxtButton: function (c, d, e, f, g, h, k, m, n) {
    ...
    if (null != f) {
      var p = (e = 0);
      5 == n
        ? ((e = 30 * this.scaleNum), (p = 0))
        : 1 == n
        ? ((e = 30 * this.scaleNum), (p = 0))
        : 10 == n && ((e = 43 * this.scaleNum), (p = 0));
      f = UIToolManager.getLabelTTF2("" + f, e, 0.5, 0.5, g + p, h);
      c.addChild(f, 3);
      10 == n &&
        ((c = "#4f373b"),
...
var LinkLayer = cc.Layer.extend({
  ...
  ctor: function () {
    ...
    this.bg.drawRect(cc.p(0, 0), cc.p(CW, CH), cc.color(0, 0, 0, 0), -1);
  ...
  onTouchMoved: function (c, d) {},
  onTouchEnded: function (c, d) {
    c.getLocation().x > this.LW && this.layerOut();
  },
  initUI: function (c) {
    this.LW = 140;
    ...
    this.txt1 = UIToolManager.getLabelTTF(
      "  link_top_tip",
      30 * this.scaleNum,
      0,
      1,
    ...
    e = new cc.Menu();
    e.setPosition(0, 0);
    this.nodeContainer.addChild(e, 4);
    for (var f = 0; 4 > f; f++)
      this.loadUrlImage(
        c.gameList[f][2],
        70,
    ...
    for (var f = CH - 140 - 130 * f, g = 0; 4 > g; g++) {
      var d = d - 160 * this.scaleNum,
        f = CH - 215 - 166 * g,
        h = new cc.MenuItemImage(
          comRes.kuang_kuang_png,
          comRes.kuang_kuang_png,
          this.openLink.bind(this, c.gameList[g][1])
        );
      h.setPosition(70, f);
      h.setScaleX(0.8 * this.scaleNum);
      ...
      e.addChild(h, 5);
      this.addLine(70, f - 98);
    }
    d = new cc.Sprite(comRes.closeBg_btn_png);
    d.setAnchorPoint(0, 0.5);
    d.setScale(0.7, this.scaleNum);
    d.setColor(cc.color("#000000"));
    d.setOpacity(70);
    d.setPosition(this.LW + 0.6, CH - 25);
    this.nodeContainer.addChild(d, 2);
    d = new cc.MenuItemImage(
      comRes.close_btn_png,
      comRes.close_btn_png,
      this.layerOut.bind(this)
    );
    d.setAnchorPoint(0, 0.5);
    d.setScale(this.scaleNum);
    d.setPosition(this.LW + 6, CH - 28);
    e.addChild(d);
    d = CH - 70;
    this.addLine(70, d - 68);
    this.btnCenter = new cc.MenuItemImage(
      comRes.home_kuang_png,
      comRes.home_kuang_png,
      this.openLink.bind(this, c.gameCenter)
    );
    this.btnCenter.setPosition(70, d - 5);
    this.btnCenter.setScale(0.6);
  ...
  addLine: function (c, d) {
    ...
    e.y = d;
    e.setOpacity(180);
    this.nodeContainer.addChild(e, 6);
  },
  loadUrlImage: function (c, d, e, f) {
    null != c &&
      void 0 != c &&
      "" != c &&
      cc.loader.loadImg(c, { isCrossOrigin: !1 }, function (c, h) {
        if (c) cc.log(c);
        else {
          var k = new cc.Texture2D();
          k.initWithElement(h);
          ...
          k.setScale(f);
          k.setPosition(d, e);
          LinkLayerSelf.nodeContainer.addChild(k, 2);
        }
      });
  },
  openLink: function (c) {
  ...
  closeLayer: function () {
    GameManager.tempLinkBtn.setVisible(!0);
...
var GameManager = {
    ...
    gamePVLoadBool: !1,
    init: function () {
      this.averageScore = 15;
      this.adTimeInterval = 30;
    ...
    resetData: function () {
      this.playNum++;
      this.state = this.oldScore = this.score = this.touchNum = 0;
      this.canTouch = !0;
      this.curPhase = 1;
      this.vy = 2;
    },
    ...
    setPhase: function (c) {
      this.vy += 0.01;
      50 < c
        ? (GameManager.curPhase = 1)
        : 40 < c
        ? (GameManager.curPhase = 2)
        : 25 < c
        ? (GameManager.curPhase = 3)
        : 10 < c && (GameManager.curPhase = 4);
    },
    testFunc: function () {},
  },
  upload = !0;
var MainLayer = cc.Layer.extend({
  ...
  setData: function () {
    this.initUI();
    GameManager.showIdBool && downPic();
  },
  initUI: function () {
    this.play();
    MainManager.ranRecGameData();
    this.addLink = new linkGame();
    this.addChild(this.addLink, 250);
    this.bg1 = new cc.LayerColor(cc.color("#93e4ff"), CW, CH);
    this.addChild(this.bg1, 0);
    this.bg2 = new cc.LayerColor(cc.color("#44b748"), CW, 670);
    this.addChild(this.bg2, 0);
    for (var c = 0; 2 > c; c++) {
      var d =
          0 == c
            ? MainManager.randomInt(100, CW / 2 - 100)
            : MainManager.randomInt(CW / 2 + 100, CW - 100),
        e = MainManager.randomInt(770, CH),
        d = UIToolManager.getSprite(res.cloud_png, 0.5, 0.5, d, e);
      this.addChild(d, 0);
    }
    this.sign = UIToolManager.getSprite(
      res.sign_png,
      0.5,
      0,
      (CW / 3) * 2,
    ...
    for (c = 0; 4 > c; c++)
      (d = MainManager.randomInt(50, CW - 50)),
        (e = 670 - MainManager.randomInt(1, 10)),
        (d = UIToolManager.getSprite(res.grass_png, 0.5, 0, d, e)),
        this.addChild(d, 0);
    this.timeView = new TimeView(60);
    this.timeView.setPosition(this.sign.x, this.sign.y + 180);
    this.addChild(this.timeView, 1);
    this.df = UIToolManager.getSprite(
      res.df_png,
      0.5,
      0.5,
      this.sign.x - 40,
    ...
    this.addChild(this.df, 1);
    this.scoreView = new ScoreView1(
      1,
      0.5,
      this.sign.x + 80,
      this.sign.y + 115
    );
    this.addChild(this.scoreView, 1);
    this.initPit();
  },
  initPit: function () {
    this.pitList = [];
    ...
    this.pitList[0].setPosition(100, 560);
    this.pitList[1].setPosition(CW / 2, 560);
    this.pitList[2].setPosition(CW - 100, 560);
    this.pitList[3].setPosition(CW / 3, 330);
    this.pitList[4].setPosition((CW / 3) * 2, 330);
    this.pitList[5].setPosition(100, 100);
    this.pitList[6].setPosition(CW / 2, 100);
    this.pitList[7].setPosition(CW - 100, 100);
  },
  gameStart: function () {
    if (10 <= document.body.scrollTop)
      return (
    ...
    MainManager.gameResume();
    var c = MainManager.randomInt(1, 8) - 1;
    this.pitList[c].showStart();
    this.createListener();
  ...
  gameEnd: function () {
    ...
    this.runAction(
      cc.sequence(cc.delayTime(0), cc.callFunc(this.gameEnd1.bind(this)))
    );
  },
  gameEnd1: function () {
    this.removeListener();
    ...
    MainManager.canTouch = !1;
    this.scoreView.setScore();
    AudioManager.playMusic("res/music/fail");
    var c = new cc.LayerColor(cc.color(0, 0, 0, 170));
    this.addChild(c, 17);
    c.opacity = 0;
    c.runAction(cc.fadeTo(0.3, 170));
    MainManager.getLanguage();
    var d = "\u6e38\u620f\u7ed3\u675f",
      c = "\u70b9 \u51fb \u67e5 \u770b \u5206 \u6570";
    1 == MainManager.type
      ? ((d = "\u6e38\u620f\u7ed3\u675f"),
        (c = "\u70b9 \u51fb \u67e5 \u770b \u5206 \u6570"))
      : 110 == MainManager.type
      ? ((d = "\u904a\u6232\u7d50\u675f"),
        (c = "\u9ede \u64ca \u67e5 \u770b \u5206 \u6578"))
      : 101 == MainManager.type
      ? ((d = "\uac8c\uc784 \uc885\ub8cc"),
        (c = "\ud074\ub9ad \ud558\uc5ec \uc810\uc218 \ubcf4\uae30"))
      : ((d = "Game Over"), (c = "Click to view the score"));
    d = UIToolManager.getLabelTTF(
      d,
      70,
      0.5,
      1,
    ...
    d.runAction(
      cc.sequence(
        ...
        cc.delayTime(0.3),
        cc.callFunc(this.initEndLayer.bind(this))
      )
    );
    this.gameEndSpr = d;
    c = UIToolManager.getLabelTTF(
  ...
  initEndLayer: function () {
    // upPic();
    GameManager.showIdBool = !0;
    this.textEnd.runAction(
      cc.repeatForever(cc.sequence(cc.scaleTo(0.8, 1.1), cc.scaleTo(0.8, 1)))
    );
    this.addEndClickLayer();
  },
  addEndClickLayer: function () {
    console.log("clickbbbbbbb");
    var c = cc.director.getVisibleSize(),
      d = new cc.MenuItemImage(comRes.btn_again_png, "", this.onEndClick, this);
    d.x = c.width / 2;
    d.y = c.height / 2;
    d.scale = 100;
    d.opacity = 0;
  ...
  onEndClick: function () {
    cc.log("clickend");
    this.textEnd.stopAllActions();
    this.gameEndSpr.removeFromParent();
    this.textEnd.removeFromParent();
    this.initAddNewAd();
  ...
  onTouchBegan: function (c, d) {
    ...
    if (MainManager.canTouch) {
      this.addLink.touchFlower(c);
      if (!0 == MainManager.returnBool) return;
      this.checkHitPit(e) &&
        (AudioManager.playMusic("res/music/hit"), GameManager.addScore(1));
    }
    return !1;
  },
  checkHitPit: function (c) {
    for (var d = this.pitList.length, e = 0; e < d; e++) {
      var f = Math.abs(c.x - this.pitList[e].x),
        g = Math.abs(c.y - this.pitList[e].y);
      if (65 > f && 65 > g) {
        if (this.pitList[e].isCanHit) return this.pitList[e].playHitAct(), !0;
        break;
      }
    }
    return !1;
  ...
  update: function (c) {
    ...
    this.timeView.countTime();
    this.createShow();
    this.moveDs();
  },
  moveDs: function () {
    for (var c = this.pitList.length, d = 0; d < c; d++)
      this.pitList[d].showIng(GameManager.vy);
  },
  createShow: function () {
    for (var c = 0, d = this.pitList.length, e = 0; e < d; e++)
      2 == this.pitList[e].state && c++;
    d = 0;
    0 == c
      ? ((d = MainManager.randomInt(1, 8) - 1), this.pitList[d].showStart())
      : c < GameManager.curPhase &&
        ((d = MainManager.randomInt(1, 8) - 1),
        1 == this.pitList[d].state &&
          0.95 < Math.random() &&
          this.pitList[d].showStart());
  },
  hide: function () {
    mainSelf = this.scoreView = this.bg = this.lis1 = null;
    this.removeAllChildren(!0);
    this.removeFromParent(!0);
  },
  onExit: function () {
...
var ScoreView1 = cc.Node.extend({
    ...
    initUI: function (c, d, e, f) {
      this.scoreTxt = new cc.LabelAtlas("0", res.number_png, 28.4, 28, "0");
    ...
    setScore: function () {
      this.nowScore = GameManager.score;
      this.scoreTxt.string = GameManager.score.toString();
    },
    addScoreFunc: function () {
      GameManager.score > this.nowScore &&
        (this.speed++,
        this.speed == this.addV &&
          ((this.speed = 0),
          this.nowScore++,
          (this.scoreTxt.string = this.nowScore.toString())));
    },
  }),
  ScoreView2 = cc.Node.extend({
    ...
    initUI: function (c, d, e, f) {
      this.scoreTxt = new cc.LabelAtlas("0", res.number_png, 42, 45, "0");
      this.scoreTxt.setAnchorPoint(c, d);
      this.scoreTxt.setPosition(e, f);
      this.addChild(this.scoreTxt);
      this.setScore();
    ...
    addScoreFunc: function () {
      this.addCount += this.speed;
      this.addCount >= this.maxCount &&
        ((this.addCount = 0),
        GameManager.score++,
        (this.scoreTxt.string = GameManager.score.toString()));
    },
  });
var TimeView = cc.Node.extend({
    totalTime: null,
    nowTime: null,
    sanTime: 3,
    curO: 255,
    ...
    ctor: function (c) {
      this._super();
      this.setCascadeOpacityEnabled(!0);
      this.nowTime = this.totalTime = c;
      this.xt = 0;
      this.sj = UIToolManager.getSprite(res.sj_png, 1, 0.5, 0, 0);
      this.addChild(this.sj);
      this.txt1 = new cc.LabelAtlas("0", res.number_png, 28.4, 28, "0");
      this.txt1.setAnchorPoint(1, 0.5);
      this.txt1.setPosition(80, 0);
      this.addChild(this.txt1);
      this.showTime(this.nowTime);
    },
    showTime: function (c) {
      this.txt1.string = c.toString();
    },
    countTime: function () {
      this.xt++;
      60 <= this.xt &&
        ((this.xt = 0),
        this.nowTime--,
        GameManager.setPhase(this.nowTime),
        this.showTime(this.nowTime),
        0 >= this.nowTime && mainSelf.gameEnd1());
    },
    resetTime: function () {
    ...
    san: function () {
      1 == this.dir
        ? ((this.curO -= this.speedO),
          this.setOpacity(this.curO),
          120 >= this.curO && (this.dir = -1))
        : -1 == this.dir &&
          ((this.curO += this.speedO),
          this.setOpacity(this.curO),
          255 <= this.curO && (this.dir = 1));
    },
  }),
  Pit = cc.Node.extend({
    dir: 1,
    ...
    init: function () {
      this.pit1 = UIToolManager.getSprite(res.pit1_png, 0.5, 1, 0, 0);
      this.addChild(this.pit1, 1);
      this.pit2 = UIToolManager.getSprite(res.pit2_png, 0.5, 1, 17.28, -14.54);
      this.addChild(this.pit2, 2);
      this.diglett = UIToolManager.getSprite(
        res.diglett1_png,
        0.5,
        0,
        2.43,
      ...
      this.addChild(this.diglett, 1);
      this.showEnd();
    },
    showStart: function () {
      this.state = 2;
      this.isCanHit = this.isShow = !0;
      this.isHit = !1;
      this.diglett.setVisible(!0);
      this.dir = 1;
    },
    showIng: function (c) {
      this.isHit && (c *= 3);
      this.isShow &&
        (1 == this.dir
          ? ((this.diglett.y += c),
            -40 <= this.diglett.y && ((this.dir = -1), (this.diglett.y = -40)))
          : -1 == this.dir &&
            ((this.diglett.y -= c),
            -140 >= this.diglett.y &&
              ((this.dir = 1), (this.diglett.y = -140), this.showEnd())));
    },
    showEnd: function () {
      this.isShow = !1;
      this.resetDiglett();
    ...
    playHitAct: function () {
      this.isCanHit = this.isShow = !1;
      this.isHit = !0;
      this.dir = -1;
      this.diglett.setTexture(res.diglett2_png);
      this.diglett.runAction(
        cc.sequence(
          cc.scaleTo(0.1, 1, 0),
          cc.scaleTo(0.1, 1, 1),
          cc.rotateTo(0.05, 5),
          ...
          cc.rotateTo(0.05, -5),
          cc.rotateTo(0.05, 0),
          cc.callFunc(this.hitEnd.bind(this))
        )
      );
      var c = new Hammer();
      c.setPosition(143.92, 29.76);
      this.addChild(c, 2);
      c.setRotation(90);
      c.runAction(
        cc.sequence(
    ...
    resetDiglett: function () {
      this.diglett.setTexture(res.diglett1_png);
      this.diglett.setPosition(2.43, -140);
      this.isHit = this.isCanHit = this.isShow = !1;
      this.diglett.setVisible(!1);
      this.state = 1;
    },
    destroy: function () {
      this.stopAllActions();
  ...
  Hammer = cc.Sprite.extend({
    ...
    init: function () {
      this.setTexture(res.hammer_png);
  ...
  linkGame = cc.Layer.extend({
    ...
    loadUrlImage2: function (c) {
      null != c &&
        void 0 != c &&
        "" != c &&
        cc.loader.loadImg(c, { isCrossOrigin: !1 }, function (c, e) {
          if (c) cc.log(c);
          else {
            ...
            null != MainManager.recGamePos &&
              ...
              (1 == MainManager.recGamePos
                ? ((g = f.getBoundingBox().width / 2 + 8),
                  (h =
                    cc.director.getWinSize().height -
                    f.getBoundingBox().height / 2 -
                    8))
                : 2 == MainManager.recGamePos
                ? ((g = CW - f.getBoundingBox().width / 2 - 8),
                  (h =
                    cc.director.getWinSize().height -
                    f.getBoundingBox().height / 2 -
                    8))
                ...
                ? ((g = CW - f.getBoundingBox().width / 2 - 8),
                  (h = f.getBoundingBox().height / 2 + 8))
                : 4 == MainManager.recGamePos &&
                  ((g = f.getBoundingBox().width / 2 + 8),
                  (h = f.getBoundingBox().height / 2 + 8)));
            linkSelf._picXNum = g;
            linkSelf._picYNum = h;
            linkSelf._picWidth = f.getBoundingBox().width;
            linkSelf._picHeight = f.getBoundingBox().height;
            f.setPosition(g, h);
            linkSelf.addChild(f, 2);
            f.setVisible(!1);
            linkSelf._imageArr.push(f);
            linkSelf._numAdd++;
            2 <= linkSelf._numAdd &&
              (cc.log(
                "imageLength",
    ...
    showLinkPic: function () {
      this._touchLinkBool = !0;
      var c = 0,
        d = 0,
        c = null != MainManager.recGameDelPau ? MainManager.recGameDelPau : 6;
      cc.log("dMainManager.recGameDelPer", MainManager.recGameDelPer);
      d = null != MainManager.recGameDelPer ? MainManager.recGameDelPer : 0.7;
      cc.log("ddelayPerdelayPerdelayPerdelayPere", d, c);
      this._imageArr[0].setVisible(!0);
        ...
        cc.repeatForever(
          cc.sequence(
            ...
            cc.callFunc(function () {
              ...
              this._imageArr[0].setVisible(!1);
              this._imageArr[1].setVisible(!0);
            }, this),
            cc.delayTime(c),
            cc.callFunc(function () {
              this.flowerAction(this._imageArr[1], d);
            }, this),
            cc.delayTime(d),
            cc.callFunc(function () {
              this._imageArr[1].setVisible(!1);
              this._imageArr[0].setVisible(!0);
            }, this)
          )
        )
    ...
    touchFlower: function (c) {
      if (this._touchLinkBool) {
        var d = c.getLocation();
        c = Math.abs(d.x - linkSelf._picXNum);
        d = Math.abs(d.y - linkSelf._picYNum);
        if (
          c <= this._picWidth / 2 + 6 &&
          d <= this._picHeight / 2 + 6 &&
          null != MainManager.recGameUrl &&
          "" != MainManager.recGameUrl
        ) {
          cc.log("okTouch");
          MainManager.returnBool = !0;
          for (c = 0; c < this._imageArr.length; c++)
            linkSelf._imageArr[c].stopAllActions(),
              linkSelf._imageArr[c].setRotation(0),
              linkSelf._imageArr[c].runAction(
                cc.sequence(
...
var overLayer = cc.Layer.extend({
  ...
  init: function () {
    this._touchBool = !1;
    this.nextNum = 0;
    var c = new cc.LayerColor(cc.color("#363636"));
    this.addChild(c);
    if (10 <= document.body.scrollTop)
      return (
        (document.documentElement.scrollTop = document.body.scrollTop = 0), !1
      );
    c = MainManager.getLanguage();
    c = UIToolManager.getSprite(
      comRes["game_over" + c + "_png"],
      0.5,
      0.5,
      CW / 2,
      CH / 2 + 50
    ...
    this.addChild(c, 30);
    c.runAction(cc.sequence(cc.delayTime(0.5), cc.removeSelf(!0)));
    c = UIToolManager.getLabelTTF(
      MainManager.txtGameL,
      40,
      0.5,
      1,
      CW / 2,
...
var loadLayer = cc.Layer.extend({
    ...
    btnStartFunc: function (c) {
      cc.log("\u5f00\u59cb\u6e38\u620f");
      c = MainManager.adShowBefore;
      (c = null == c || void 0 == c ? !0 : MainManager.adShowBefore)
        ...
        function () {
          this.needShow
            ? (cc.log("pre", preloader),
              void 0 == preloader && MainManager.startGame(),
              (resCompleteFlag = !0),
              adCompleteFlag && resCompleteFlag && MainManager.startGame())
...
function checkShowAd() {
  1 == getLocalStorage("old_key_kantushiying11")
    ? ((gameT = 1), (this.needShow = !0), showMyAds())
...
var GameLayer = cc.Layer.extend({
    ...
    goToScene: function () {
      ...
      !1 == GameManager.gamePVLoadBool &&
        ((GameManager.gamePVLoadBool = !0), gamePV_load());
      LocalManager.setSubmitLoad(0);
...
cc.game.onStart = function () {
  ...
  var c = cc.sys;
  cc.log("xitong : " + c.os);
  if (c.os === c.OS_IOS || c.os === c.OS_OSX) IOS_FLAG = !0;
  cc.view.enableRetina(!0);
  cc.view.adjustViewPort(!0);
  c.os === c.OS_IOS ||
  c.os === c.OS_ANDROID ||
  c.os === c.OS_BLACKBERRY ||
  c.os === c.OS_WP8 ||
  c.os === c.OS_BADA
